<DiagramFigure
  ...
  labels={[
    { x: 21, y: 47, side: "right", label: "Multi-orbital fossil skull", note: "Cranial osteology and eye socket counts provide morphological matrices when DNA cannot be extracted." },
    { x: 71, y: 25, side: "left", label: "Bipedal skeletal frame", note: "Limb counts and spinal articulations trace deep branching points between tetrapods and hexapods." },
    { x: 47, y: 75, side: "right", label: "Empty sample vial", note: "Without molecular sequence data, phylogenetic reconstruction relies on strict cladistic character matrices." }
  ]}
  figNo="01"
...
<OutgroupPolarityBench
  caption="The compass, not the bones. Nominate a creature that branched off before the family and the two great novelties light up: carbon-threaded bone and the queue each mark something every other specimen shares. Nominate a member of the family instead and its own traits become the definition of 'ancestral' — the crest goes dark, because everyone already has it, and genuinely ancient anatomy is promoted to a novelty. Not one score changed. Only the direction did."
/>
...
<DiagramFigure
  ...
  labels={[
    { x: 14, y: 43, side: "right", label: "Na'vi carbon-fiber cortex", note: "Naturally woven carbon nanotube bone matrix shared across all Pandoran macrofauna." },
    { x: 40, y: 47, side: "right", label: "Terrestrial predator matrix", note: "Reinforced composite skeletal architecture bears immense terrestrial impact loads." },
    { x: 61, y: 45, side: "left", label: "Flyer wing spar lattice", note: "Hollow honeycomb composite spars withstand extreme dynamic flight stresses." },
    { x: 83, y: 52, side: "left", label: "Aquatic rib composite", note: "Identical bone chemistry across diverse biomes confirms a single common Pandoran ancestor." }
  ]}
  alt="A Na'vi, thanator, ikran, and tulkun anatomical comparison, each exposing woven carbon-composite bone and a neural connector ending in fine glowing tendrils"
  figNo="06"
  caption="Four exteriors, two inherited signatures. Land hunter, flyer, ocean giant, and Na'vi look radically unlike one another, yet each repeats the same grown carbon-composite skeleton and the same neural-queue construction. Those intricate shared novelties are not a vague resemblance; they are the family crest that gathers Pandora's bestiary into one clade."
  tier="canon"
/>
...
<DiagramFigure
  ...
  labels={[
    { x: 16, y: 42, side: "right", label: "Synapomorphy (Shared derived)", note: "Novel shared derived traits—like the neural queue—that unite true monophyletic clades." },
    { x: 48, y: 48, side: "right", label: "Symplesiomorphy (Ancestral)", note: "Retained primitive characters that are shared broadly and cannot resolve close sister lineages." },
    { x: 82, y: 52, side: "left", label: "Homoplasy (Convergent)", note: "Superficially identical aerodynamic and hydrodynamic profiles evolved independently in distinct clades." }
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 68, y: 14, side: "left", label: "Modern pelagic cetacean", note: "Streamlined aquatic body plan completely conceals terrestrial ungulate ancestry." },
    { x: 26, y: 55, side: "right", label: "Ambulocetus fossil skeleton", note: "Transitional walking whale with robust quadrupedal limb joints." },
    { x: 46, y: 40, side: "left", label: "Double-pulley astragalus (Fossil)", note: "Diagnostic trochlea grooved on both ends proves direct artiodactyl lineage." },
    { x: 70, y: 42, side: "right", label: "Artiodactyl astragalus match", note: "Identical ankle morphology found in modern hippos and even-toed ungulates." }
  ]}
  alt="A four-legged early whale fossil with its double-pulley ankle bone enlarged beside the matching ankle of a hippopotamus, while a modern whale silhouette swims above"
  figNo="07"
  caption="The small bone that overruled the whole body. Early whales still had legs, and one ankle bone carried the distinctive double-pulley construction of even-toed hoofed mammals. That inherited detail placed a fish-shaped ocean giant beside hippos more reliably than its streamlined exterior ever could — exactly the discipline the Pandoran bench requires."
  tier="real_science"
/>

And deepest of all, the rewrite of the whole base of the tree. When Carl Woese stopped sorting microbes by how they looked under a glass and started reading a shared molecule across all of them, an entire third great branch of life — the <GlossaryTerm slug="archaea">archaea</GlossaryTerm> — fell out, hiding in plain sight among things everyone had filed as ordinary bacteria. They look like bacteria. By the traits that actually track ancestry, they are closer kin to *us* than to the bacteria they resemble. Same lesson, one more time: overall resemblance is the liar, shared novelty is the witness.
...
<DiagramFigure
  ...
  labels={[
    { x: 23, y: 14, side: "right", label: "Phenetic illusion halo", note: "Grouping by superficial humanoid appearance mistakenly links Terran and Pandoran lineages." },
    { x: 23, y: 48, side: "left", label: "Convergent bipedalism", note: "Upright stance and forward-facing eyes are convergent masks over completely distinct biospheres." },
    { x: 68, y: 48, side: "right", label: "True Pandoran clade", note: "Carbon-fiber bone lattices and neural queues unite Na'vi, prolemuris, and direhorse into one genealogy." }
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  labels={[
    { x: 16, y: 72, side: "right", label: "Pandoran aerial lineage", note: "Rapid morphological specializations for high-speed flight create a long, isolated evolutionary branch." },
    { x: 84, y: 72, side: "left", label: "Terran pterosaur lineage", note: "Independent accumulation of wing-membrane adaptations builds a parallel long branch." },
    { x: 50, y: 88, side: "right", label: "Long-branch attraction artifact", note: "Parsimony algorithms falsely pull fast-evolving distant taxa together at false sister nodes." }
  ]}
  figNo="04"
...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 85, side: "right", label: "Subterranean root syncytium", note: "Shared subterranean neural-fungal networks facilitate horizontal ecological exchange." },
    { x: 50, y: 42, side: "left", label: "Horizontal anastomoses", note: "Cross-fusing branches convert a strictly bifurcating tree into a reticulate evolutionary meshwork." },
    { x: 24, y: 22, side: "right", label: "Reticulate canopy lineages", note: "Terminal species integrate structural and genetic cues across multiple interconnected ancestral lines." }
  ]}
  figNo="05"
