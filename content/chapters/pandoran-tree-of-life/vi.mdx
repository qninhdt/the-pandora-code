<DiagramFigure
  ...
  alt="Một bàn mẫu vật tối màu dưới ánh sáng xanh lơ lạnh, phủ đầy di cốt Pandora — một hộp sọ thanator, một chiếc vây ilu đơn độc, một đốt sống tulkun cong và một bộ xương Na'vi mảnh khảnh đứng giữa chúng — cùng một lọ thủy tinh đựng DNA trống rỗng nằm nghiêng ở tiền cảnh, nổi bật vì không được sử dụng"
  labels={[
...
<DiagramFigure
  ...
  labels={[
    { x: 16, y: 42, side: "right", label: "Đặc điểm dẫn xuất chung (Synapomorphy)", note: "Các tính trạng tiến hóa mới được chia sẻ—như tua thần kinh—gắn kết các nhánh đơn ngành thực sự." },
  ...
  figNo="02"
  caption="Ba kiểu giống nhau, chỉ một trong số đó là manh mối. Một đặc điểm tiến hóa mới chia sẻ như tua thần kinh (trên cùng) là một đặc điểm dẫn xuất chung — nó gắn kết một gia đình thực sự. Một đặc điểm quá cũ đến mức ai cũng mang nó (ở giữa) không dùng để phân nhóm ai. Và sự giống nhau đạt được một cách độc lập (dưới cùng) là sự hội tụ — một dáng vẻ giống nhau có thật nhưng lại nói dối về quan hệ họ hàng. Phương pháp ở đây là học cách nhận biết, chỉ trong nháy mắt, bạn đang nhìn vào hàng nào."
  tier="real_science"
/>
...
<Comparison
  ...
  right={{
    ...
    children: <p>Gom Na'vi dựa vào chính những đặc điểm dẫn xuất mà họ thực sự chia sẻ — xương carbon và tua thần kinh chung với toàn bộ muông thú, cộng thêm đôi mắt, số chi và sợi thần kinh tiêu biến chung với prolemuris. Người Na'vi được đặt sâu bên trong nội tộc Pandora. Sự giống người đó là tiến hóa hội tụ — có thật, và chẳng liên quan gì đến gốc gác máu mủ.</p>
  }}
/>
...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 68, y: 48, side: "right", label: "Nhánh tiến hóa Pandora thực sự", note: "Mạng lưới xương sợi carbon và tua thần kinh quy tụ người Na'vi, prolemuris và direhorse vào chung một phả hệ." }
  ]}
  figNo="03"
...
Mọi lập luận cho đến giờ đều nương tựa vào một bức tranh kinh điển: các dòng dõi phân nhánh và không bao giờ tái hợp, dòng máu họ hàng chảy xuôi từ trên xuống, và lịch sử sự sống do đó mang hình bóng của một cái cây — những cành con đâm ra từ cành lớn, cành lớn đâm ra từ thân chính, và chẳng bao giờ mọc quấn lại vào nhau. Chính cái giả định ấy mới cho phép một <GlossaryTerm slug="cladogram">sơ đồ phát sinh loài (cladogram)</GlossaryTerm> mang dáng dấp của một cái cây. Thế nhưng trên Pandora lại tồn tại một lý do để hoài nghi điều đó, một lý do dệt xuyên qua mọi sinh vật trên bàn mổ: tua thần kinh (queue), cùng mạng lưới trải rộng toàn hành tinh mà nó cắm vào.

Mạng lưới đó làm một việc mà không một hệ sinh thái Trái Đất nào làm được. Thông qua tua thần kinh, sinh vật trên toàn bộ hệ động vật — cùng hệ thực vật, và cả thảm nấm lót bên dưới mọi thứ — được kết nối vào một mạng lưới thông tin sống động, nơi các tín hiệu, ký ức, và biết đâu đấy còn nhiều hơn thế, truyền đi *theo chiều ngang*, giữa những sinh vật không phải là cha mẹ và con cái, vắt ngang những dòng dõi đã tách nhánh từ nhiều kỷ nguyên trước. Ở Trái Đất, ta cũng có một phiên bản mờ nhạt của hiện tượng này: gene thỉnh thoảng vẫn nhảy múa ngang qua giữa những vi khuẩn xa lạ, và mỗi khi điều đó xảy ra, cuống rễ cây gia phả của chính ta lại nhòe đi thành một mạng lưới đan xéo thay vì những ngã ba rành rọt. Hiện tượng đó mang tên — <GlossaryTerm slug="reticulate-evolution">tiến hóa dạng lưới (reticulate evolution)</GlossaryTerm>, bắt nguồn từ tiếng Latin có nghĩa là "tấm lưới" — và ở bất cứ nơi nào nó ngự trị, cái biểu đồ phân nhánh gọn gàng kia cũng chỉ là một sự giản lược hóa của một thực thể mang vóc dáng của một chiếc mạng lưới thực thụ.
...
Sự đan lưới làm cái cây trở nên phức tạp; nó không xóa bỏ cái cây. Xương carbon và tua thần kinh vẫn chỉ tiến hóa một lần, ở một tổ tiên duy nhất, và vẫn được di truyền xuống dưới thông qua quá trình kế thừa thông thường — câu chuyện phân nhánh là có thật và bàn mổ có thể đọc được nó. Những gì mạng lưới thêm vào là một loại kết nối thứ hai chạy *ngang* qua các nhánh, truyền tải thông tin chứ không phải quan hệ dòng dõi. Một nhà sinh học sẽ giữ cả hai bức tranh này cùng lúc: cây gia phả cho biết ai sinh ra ai, còn mạng lưới cho biết ai kết nối với ai. Đặc biệt ở Pandora, bạn không thể hiểu trọn vẹn sự sống ở đây mà không nắm giữ cả hai bức tranh đó.
</Callout>
