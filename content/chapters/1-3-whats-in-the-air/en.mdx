...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 48, side: "left", label: "Lower-density air", note: "Fewer particles per volume make motion and flight feel less resisted" },
    { x: 76, y: 47, side: "right", label: "Heavy xenon-rich mixture", note: "More mass in each breath gives a wing a firmer purchase" },
    { x: 51, y: 49, side: "right", label: "Pressure is not density", note: "The comparison separates total pressure from the mass packed into the air" }
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 24, y: 52, side: "right", label: "Dead oxygen false positive", note: "A dry world can retain oxygen-rich traces after its water is gone; oxygen alone is not proof of life." },
    { x: 79, y: 30, side: "left", label: "Reactive gases together", note: "The living-world clue is an atmosphere holding chemically incompatible streams at once." },
    { x: 78, y: 73, side: "left", label: "The stronger case", note: "Clouds, water, and a buffered biosphere make the planetary context matter more than one gas." },
  ]}
  figNo="07"
