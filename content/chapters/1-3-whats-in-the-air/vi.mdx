...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 48, side: "left", label: "Không khí mật độ thấp", note: "Ít hạt hơn trong cùng thể tích nên chuyển động và bay ít bị cản hơn" },
    { x: 76, y: 47, side: "right", label: "Hỗn hợp nặng giàu xenon", note: "Nhiều khối lượng hơn trong mỗi nhịp thở tạo điểm tựa chắc hơn cho cánh" },
    { x: 51, y: 49, side: "right", label: "Áp suất không phải mật độ", note: "Phép so sánh tách tổng áp suất khỏi lượng khối lượng được nén trong không khí" }
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 24, y: 52, side: "right", label: "Dương tính giả của oxy", note: "Thế giới khô có thể giữ dấu oxy sau khi nước biến mất; riêng oxy không chứng minh sự sống." },
    { x: 79, y: 30, side: "left", label: "Các khí phản ứng cùng tồn tại", note: "Dấu hiệu của thế giới sống là khí quyển giữ đồng thời các luồng khí hóa học không tương thích." },
    { x: 78, y: 73, side: "left", label: "Trường hợp thuyết phục hơn", note: "Mây, nước và sinh quyển đệm khiến bối cảnh hành tinh quan trọng hơn một loại khí." },
  ]}
  figNo="07"
