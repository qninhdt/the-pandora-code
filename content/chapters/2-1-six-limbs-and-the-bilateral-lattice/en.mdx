...
<DiagramFigure
  ...
  labels={[
    { x: 33, y: 39, side: "right", label: "Host eye toolkit", note: "The fly supplies the local developmental machinery that builds a compound eye." },
    { x: 51, y: 66, side: "right", label: "Ectopic eye", note: "Turning on the borrowed switch at a leg site makes a complete eye in the wrong place." },
    { x: 82, y: 68, side: "left", label: "Mouse Pax6", note: "The translucent embryo represents the foreign regulatory switch, not a transplanted mouse eye." },
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 24, y: 50, side: "right", label: "Python pelvic remnants", note: "Small spurs and internal bones remain where the ancestral limb programme was only partly suppressed." },
    { x: 80, y: 33, side: "left", label: "Activation switched off", note: "A more derived snake hides the same developmental history under a smooth body plan." },
    { x: 58, y: 82, side: "right", label: "Embryonic window", note: "Temporary limb buds reveal the toolkit before later regulation removes the visible appendage." },
  ]}
  figNo="07"
