...
<DiagramFigure
  ...
  labels={[
    { x: 62, y: 16, side: "right", label: "Màn bọt khí xâm thực (Cavitation)", note: "Áp suất cục bộ giảm sâu làm nước sôi lạnh tạo bọt khí" },
    { x: 52, y: 34, side: "left", label: "Bề mặt da bị rỗ rỉ sét", note: "Bọt khí sụp đổ phá hủy cấu trúc tế bào biểu mô" },
    { x: 32, y: 68, side: "left", label: "Mép trước nguyên vẹn", note: "Lớp biểu mô gia cường chống chịu áp lực ma sát lớn" },
    { x: 68, y: 68, side: "right", label: "Dòng chảy tầng nước sâu", note: "Dòng nước êm ả không sủi bọt ở tầng nước áp suất cao" }
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  labels={[
    { x: 42, y: 56, side: "right", label: "Sóng ánh sáng truyền ngang", note: "Chớp phát quang sinh học định hướng đánh lừa con mồi" },
    { x: 36, y: 68, side: "left", label: "Dàn mắt tầng nước tối", note: "Mắt siêu nhạy phát hiện ánh sáng yếu ớt nơi đáy biển" },
    { x: 76, y: 38, side: "right", label: "Đồng đội bơi kèm đồng bộ", note: "Phối hợp săn mồi theo nhóm bằng tín hiệu ánh sáng" },
    { x: 23, y: 32, side: "left", label: "Con mồi bị mất phương hướng", note: "Lóa mắt và bối rối trước ma trận ánh sáng nhấp nháy" }
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 16, y: 38, side: "left", label: "Ống khói thủy nhiệt ngầm", note: "Phun trào khoáng chất và nước nóng giàu lưu huỳnh" },
    { x: 32, y: 72, side: "left", label: "Ốc đảo hóa tổng hợp", note: "Vi khuẩn hóa tự dưỡng làm nền tảng nuôi sống cả quần xã" },
    { x: 75, y: 64, side: "right", label: "Đáy biển bùn trơ trụi", note: "Vùng đồng bằng đáy biển nghèo dinh dưỡng xung quanh" },
    { x: 78, y: 12, side: "left", label: "Kẻ săn mồi rình mồi", note: "Lượn lờ săn bắt sinh vật tụ tập quanh miệng phun nhiệt" }
  ]}
  figNo="07"
...
<DiagramFigure
  ...
  labels={[
    { x: 58, y: 13, side: "right", label: "Săn mồi rạn san hô ngập nắng", note: "Tấn công nhanh ở tầng mặt rồi lặn sâu trốn tránh" },
    { x: 48, y: 32, side: "left", label: "Hải trình tầng trung du", note: "Lướt qua vùng tranh tối tranh sáng an toàn" },
    { x: 54, y: 66, side: "right", label: "Lướt êm tầng biển sâu", note: "Tiết kiệm năng lượng trong làn nước lạnh giá" },
    { x: 24, y: 88, side: "left", label: "Trú ẩn miệng phun đáy biển", note: "Khai thác nguồn nhiệt và thức ăn ở đáy biển sâu" }
  ]}
  figNo="08"
...
<DiagramFigure
  ...
  labels={[
    { x: 29, y: 48, side: "left", label: "Hộp não được giữ ấm", note: "Duy trì tốc độ xử lý thần kinh cao trong làn nước băng giá" },
    { x: 58, y: 50, side: "right", label: "Lõi cơ đỏ bơi lội", note: "Cơ đỏ hiếu khí sinh nhiệt liên tục khi vận động" },
    { x: 52, y: 38, side: "right", label: "Mạng lưới Rete Mirabile", note: "Hệ thống trao đổi nhiệt ngược dòng giữ nhiệt lại lõi cơ thể" },
    { x: 75, y: 22, side: "right", label: "Màng áo ngoài lạnh", note: "Bề mặt cơ thể thích ứng với nhiệt độ môi trường xung quanh" }
  ]}
  figNo="09"
