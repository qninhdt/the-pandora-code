<DiagramFigure
  ...
  labels={[
    { x: 21, y: 52, side: "right", label: "Na'vi on the ridge", note: "Observer on the high escarpment overlooking unbroken rainforest." },
    { x: 58, y: 65, side: "left", label: "Rainforest, coast to coast", note: "Dense wet canopy stretches continuously without interior rain shadows or deserts." },
    { x: 75, y: 34, side: "left", label: "The Eastern Sea", note: "Massive oceanic water body feeding endless tropical convection and rainfall." },
    { x: 50, y: 23, side: "left", label: "Level equatorial cloud band", note: "Stable intertropical convergence zone blanketing the low latitudes." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 22, y: 28, side: "left", label: "Parallel starlight", note: "Incoming stellar rays arrive in uniform, parallel lines from the host star." },
    { x: 51, y: 30, side: "left", label: "Head-on rays (equator)", note: "Perpendicular incidence concentrates thermal flux onto a compact, glowing orange area." },
    { x: 60, y: 75, side: "left", label: "Glancing rays (pole)", note: "Shallow incidence spreads the same beam across an elongated, cooler surface swath." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 38, side: "left", label: "Equatorial updraft", note: "Convective storm column powered by intense tropical insolation and tidal warming." },
    { x: 26, y: 20, side: "left", label: "High-altitude poleward drift", note: "Dehumidified upper air diverges toward higher latitudes along the cell ceiling." },
    { x: 12, y: 76, side: "right", label: "Dry subtropical subsidence", note: "Descending dry air robs moisture from the ground, creating arid borderlands." },
    { x: 50, y: 78, side: "left", label: "Lush equatorial forest", note: "Persistent cloudbursts under the ascending convective limb sustain dense canopy." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 49, side: "left", label: "Fast spin: narrow wet belt", note: "Strong Coriolis deflection fractures circulation into narrow cells, constricting the tropics." },
    { x: 25, y: 28, side: "left", label: "Broad mid-latitude deserts", note: "Early subsidence locks vast temperate belts into arid, sandy expanses." },
    { x: 74, y: 50, side: "right", label: "Slow spin: super-Hadley belt", note: "Weak Coriolis force allows the moist tropical cell to expand almost to the poles." },
    { x: 74, y: 18, side: "right", label: "Polar-confined dry caps", note: "Descending dry branches are banished to high polar latitudes." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 26, y: 50, side: "left", label: "Thin air: scorched equator", note: "Sparse atmosphere cannot transport heat, causing extreme thermal extremes and a baked middle." },
    { x: 26, y: 22, side: "left", label: "Thin air: frozen poles", note: "Without advection, polar caps lose heat directly to space into perpetual ice." },
    { x: 74, y: 50, side: "right", label: "Thick air: thermal flywheel", note: "Dense atmosphere stores and distributes massive thermal energy globally." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 30, y: 30, side: "left", label: "Wind-driven offshore drift", note: "Surface currents dragged offshore by prevailing winds create a coastal void." },
    { x: 55, y: 62, side: "left", label: "Nutrient-rich upwelling plume", note: "Cold abyssal water rises along the continental slope, lifting dissolved minerals." },
    { x: 84, y: 26, side: "left", label: "Prolific shallow reefs", note: "Coastal biomes feast on continuous upward nutrient delivery under sunlight." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 20, side: "left", label: "High-altitude rainforest", note: "Dense air has a low lapse rate, allowing lush subtropical forests to thrive kilometers high." },
    { x: 31, y: 52, side: "left", label: "Perpetual waterfalls", note: "Atmospheric humidity condenses continually on elevated plateaus, recharging cascading streams." },
    { x: 82, y: 50, side: "right", label: "Dense buoyant atmosphere", note: "Higher air density provides aerodynamic lift and traps heat at high altitudes." }
  ]}
