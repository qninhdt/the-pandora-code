<DiagramFigure
  ...
  labels={[
    { x: 57, y: 41, side: "left", label: "The breathing fans", note: "Flared open along the flank, swallowing the wind" },
    { x: 68, y: 10, side: "right", label: "Not the nose", note: "The face-mounted nostrils are not where the air goes in" }
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    { x: 28, y: 50, side: "left", label: "High partial pressure", note: "Oxygen crowded, dense on one side" },
    { x: 76, y: 50, side: "right", label: "Low partial pressure", note: "Sparse on the other — the slope" },
    { x: 49, y: 50, side: "right", label: "Thin wet membrane", note: "Crossing faster the thinner it is" }
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 18, y: 32, side: "left", label: "Water flows one way", note: "Rich in oxygen as it enters" },
    { x: 84, y: 62, side: "left", label: "Blood flows the other", note: "Always meeting fresher water" },
    { x: 50, y: 50, side: "right", label: "The slope never closes", note: "Oxygen crosses the whole length" }
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  labels={[
    { x: 20, y: 47, side: "left", label: "Rear air sac", note: "Draws fresh air in" },
    { x: 80, y: 47, side: "right", label: "Front air sac", note: "Pushes stale air out" },
    { x: 50, y: 48, side: "right", label: "One-way flow", note: "Surface always meets fresh air" }
  ]}
  figNo="04"
...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 24, side: "right", label: "Bird air sacs", note: "The pigeon keeps fresh air moving through the exchange surface with a separate air-sac pump." },
    { x: 49, y: 55, side: "right", label: "Alligator lung", note: "Airway geometry can steer one-way flow even in a reptilian body built for a swamp." },
    { x: 48, y: 83, side: "right", label: "Monitor lung", note: "The same directional solution appears again in a hot-rock predator without bird-style air sacs." },
  ]}
  figNo="07"
...
<DiagramFigure
  ...
  labels={[
    { x: 12, y: 48, side: "left", label: "Tidal", note: "In and out the same door" },
    { x: 40, y: 48, side: "left", label: "Stale pocket", note: "Trapped air that never clears" },
    { x: 74, y: 48, side: "right", label: "One-way", note: "A single clean current, always fresh" }
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  labels={[
    { x: 22, y: 51, side: "left", label: "Ram intake", note: "Forward flank slot, fed by speed" },
    { x: 39, y: 52, side: "right", label: "Flow-through lung", note: "One-way, always fresh" },
    { x: 86, y: 54, side: "right", label: "Aft vent", note: "Spent air leaves the rear" }
  ]}
  figNo="06"
