...
<DiagramFigure
  ...
  figNo="01"
  labels={[
    { x: 49, y: 51, side: "right", label: "The ember core", note: "Volcanic nodule insulated inside porous pumice" },
    { x: 42, y: 35, side: "left", label: "Oxygen draft ports", note: "Feed regulated airflow to sustain smoldering combustion" },
    { x: 28, y: 24, side: "left", label: "Braided suspension", note: "Isolates thermal conduction from the mount's hide" },
    { x: 60, y: 28, side: "right", label: "Na'vi handler", note: "Monitors radiant heat without touching the core" }
  ]}
...
<DiagramFigure
  ...
  figNo="02"
  labels={[
    { x: 29, y: 30, side: "left", label: "Earth-air flame", note: "Tall, luminous flame fed by standard oxygen and low gas damping" },
    { x: 71, y: 56, side: "right", label: "Pandoran-air flame", note: "Low, compressed flame damped by dense CO2 and xenon" },
    { x: 29, y: 72, side: "left", label: "Standard fuel bundle", note: "Rapidly consumed under terrestrial convection" },
    { x: 71, y: 74, side: "right", label: "Identical fuel bundle", note: "Burns slowly with heavy char and reduced heat loss" }
  ]}
...
<DiagramFigure
  ...
  figNo="03"
  labels={[
    { x: 14, y: 45, side: "right", label: "The flame front", note: "Intense radiative and convective heat source" },
    { x: 72, y: 60, side: "left", label: "Radiative scorching", note: "Foliage desiccates and scorches without flame contact" },
    { x: 66, y: 35, side: "left", label: "Pre-ignition outgassing", note: "Thermal radiation drives off water vapor and volatiles" },
    { x: 45, y: 68, side: "right", label: "Dense thermal gap", note: "Thick air accelerates convective boundary heating" }
  ]}
...
<DiagramFigure
  ...
  figNo="04"
  labels={[
    { x: 74, y: 34, side: "left", label: "Carried firepot", note: "Used to ignite strategic backburns against advancing fronts" },
    { x: 69, y: 31, side: "left", label: "The rider", note: "Low-drag crouch minimizing turbulence and smoke inhalation" },
    { x: 63, y: 44, side: "right", label: "Tandem wing mount", note: "Four wings provide stable lift under heavy thermal turbulence" },
    { x: 15, y: 68, side: "right", label: "Wildfire plume", note: "Pyrocumulus updraft lofting embers into the upper air" }
  ]}
...
<DiagramFigure
  ...
  figNo="05"
  labels={[
    { x: 16, y: 56, side: "right", label: "Burning trailing edge", note: "Charred membrane margins losing lift and generating asymmetrical drag" },
    { x: 52, y: 53, side: "left", label: "Rider compensation", note: "Counter-banking body weight against the degraded wing" },
    { x: 74, y: 38, side: "left", label: "Intact right wing", note: "Maintains full aerodynamic lift and control authority" },
    { x: 73, y: 86, side: "left", label: "Tail rudder vane", note: "Deflecting to counteract induced yaw from wing damage" }
  ]}
...
<DiagramFigure
  ...
  figNo="06"
  labels={[
    { x: 28, y: 30, side: "right", label: "Conchoidal fracture origin", note: "Point of percussive strike initiating shock propagation" },
    { x: 62, y: 76, side: "left", label: "Single-molecule edge", note: "Amorphous glass edge sharper than crystalline steel blades" },
    { x: 48, y: 48, side: "right", label: "Compression ripples", note: "Shockwave undulations radiating across the obsidian face" },
    { x: 26, y: 78, side: "left", label: "Flake debitage", note: "High-silica volcanic glass remnants from blade knapping" }
  ]}
...
<DiagramFigure
  ...
  figNo="07"
  labels={[
    { x: 35, y: 30, side: "right", label: "Stone hammer maul", note: "Cold-working native metal through mechanical percussion" },
    { x: 40, y: 50, side: "left", label: "Work-hardened plate", note: "Repeated impacts alter crystal lattice without smelting" },
    { x: 83, y: 67, side: "left", label: "Annealing hearth", note: "Low-temperature charcoal bed to relieve internal crystal stress" },
    { x: 20, y: 18, side: "right", label: "Na'vi metalsmith", note: "Shaping native copper or iron through work-hardening" }
  ]}
...
<DiagramFigure
  ...
  figNo="08"
  labels={[
    { x: 24, y: 21, side: "right", label: "Serotinous cone", note: "Opens only after intense heat melts resin seals" },
    { x: 31, y: 44, side: "right", label: "Winged seeds", note: "Dropping directly into the mineral-rich ash bed" },
    { x: 60, y: 52, side: "left", label: "Alkaline ash layer", note: "Nutrient-dense seedbed cleared of competing understory" },
    { x: 45, y: 78, side: "right", label: "Subsurface biochar", note: "Pyrolyzed charcoal locking carbon into deep soil layers" }
  ]}
...
<DiagramFigure
  ...
  figNo="09"
  labels={[
    { x: 25, y: 70, side: "right", label: "Low-intensity mosaic burn", note: "Bioluminescent pioneer shoots resprouting within days" },
    { x: 20, y: 50, side: "right", label: "Surviving root systems", note: "Intact underground root mass powering immediate canopy recovery" },
    { x: 81, y: 28, side: "left", label: "High-intensity sterilizing burn", note: "Complete organic destruction leaving dead standing snags" },
    { x: 70, y: 62, side: "left", label: "Vitrified mineral ground", note: "Hydrophobic baked ash preventing natural seedling establishment" }
  ]}
