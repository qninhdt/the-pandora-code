...
<DiagramFigure
  ...
  labels={[
    { x: 18, y: 55, side: "right", label: "Planetary root network", note: "Submerged biological bus carrying immense collective neural bandwidth" },
    { x: 35, y: 38, side: "left", label: "Direct neural coupling", note: "Queue conducts signal density far beyond individual tolerance" },
    { x: 49, y: 22, side: "right", label: "Bioelectric over-voltage", note: "Synaptic overload manifests as generalized seizure and autonomic collapse" }
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 71, y: 35, side: "right", label: "Local field perturbation", note: "A faint bioelectric steering bias introduced at the water interface" },
