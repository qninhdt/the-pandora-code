...
If nutrients accumulate below the euphotic zone, the obvious repair is to lift the water that contains them. Oceans do this in several ways. Winter cooling can make surface water dense enough to overturn, which on Earth drives the basin-scale <GlossaryTerm slug="thermohaline-circulation">thermohaline circulation</GlossaryTerm>. Tides can break internal waves against slopes. Currents can be forced upward by seafloor topography. The cleanest mechanism to see begins with wind along a coast.
