...
<DiagramFigure
  ...
  alt="A histological cutaway of a folded biological respiratory membrane: dense luminescent dissolved gas particles in a chamber diffusing across an ultra-thin tissue barrier into an actively perfused capillary stream"
  labels={[
...
<DiagramFigure
  ...
  alt="An anatomical cross-section of a marine gill lamella: microvascular capillary blood flow moving in opposition to an external laminar water stream across folded respiratory epithelium"
  labels={[
...
<DiagramFigure
  ...
  alt="An anatomical dissection plate of avian-style respiratory anatomy: rigid central parabronchial lung core connected to anterior and posterior compliant air sac reservoirs"
  labels={[
...
<DiagramFigure
  ...
  alt="Comparative anatomy plate showing a mammalian blind-ended alveolar sac with residual air on the left beside an open continuous flow-through respiratory tube on the right"
  labels={[
...
<DiagramFigure
  ...
  alt="Anatomical cutaway profile of a flying banshee revealing thoracic operculum intake fans, rigid lung core, pneumatized wing bones, and posterior exhaust spiracles"
  labels={[
