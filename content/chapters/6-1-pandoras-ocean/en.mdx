<DiagramFigure
  ...
  labels={[
    { x: 82, y: 18, side: "left", label: "Sunlit lagoon & reef flat", note: "Warm, high-energy shallows sheltered behind the wave-beaten reef crest." },
    { x: 48, y: 44, side: "left", label: "Photic transition zone", note: "Solar irradiance attenuates rapidly with depth, shifting from autotrophy to heterotrophy." },
    { x: 68, y: 55, side: "right", label: "Vertical reef wall", note: "Submerged limestone cliff carries rich benthic biodiversity down into dim twilight." },
    { x: 18, y: 76, side: "right", label: "Aphotic deep reservoir", note: "Vast dark ocean volume storing dissolved nutrients below the euphotic zone." }
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 12, side: "right", label: "Euphotic energy layer", note: "Sunlight finances primary productivity by plankton in the upper sunlit waters." },
    { x: 52, y: 48, side: "left", label: "Sinking marine snow", note: "Continuous biological shower of aggregates, fecal pellets, and dead cells carries carbon down." },
    { x: 50, y: 88, side: "right", label: "Nutrient remineralization", note: "Microbial respiration in darkness breaks down organic fall, recharging the deep pool." }
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 12, y: 38, side: "right", label: "Incoming oceanic current", note: "Uniform open-ocean water mass approaches the steep island obstacle." },
    { x: 52, y: 54, side: "left", label: "Submerged reef barrier", note: "Steep topography deflects deep stratified water upward toward the photic zone." },
    { x: 78, y: 68, side: "left", label: "Productive island wake", note: "Lifted deep nutrients fuel a downstream bloom of plankton and pelagic grazers." }
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  labels={[
    { x: 49, y: 30, side: "right", label: "Calm surface expression", note: "Sea surface shows little disturbance despite massive internal water displacement." },
    { x: 27, y: 52, side: "right", label: "Displaced pycnocline", note: "Tidal flow forces dense internal layers to oscillate over underwater ridges." },
    { x: 58, y: 68, side: "left", label: "Submarine ridge crest", note: "Steep topography converts horizontal tidal kinetic energy into vertical internal waves." },
    { x: 78, y: 55, side: "left", label: "Breaking internal wave", note: "Internal solitons steepen and break, driving massive turbulent nutrient mixing." }
  ]}
  figNo="04"
...
<DiagramFigure
  ...
  labels={[
    { x: 22, y: 54, side: "right", label: "Oligotrophic blue water", note: "Crystal-clear open ocean allows deep light penetration but contains minimal biomass." },
    { x: 48, y: 46, side: "left", label: "Frontal water boundary", note: "Sharp convergence front separates nutrient-poor water from the upwelling plume." },
    { x: 78, y: 48, side: "left", label: "Green productive plume", note: "High chlorophyll density and plankton populations scatter green light and support fish schools." }
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  labels={[
    { x: 48, y: 30, side: "right", label: "Abyssal particle rain", note: "Sparse marine snow delivers a thin, steady subsidy from surface production." },
    { x: 23, y: 76, side: "right", label: "Tulkun carcass fall", note: "Massive organic fall creates a decades-long concentrated feast for benthic scavengers." },
    { x: 82, y: 68, side: "left", label: "Hydrothermal vent oasis", note: "Chemosynthetic bacteria harness mineral-rich thermal fluids to support local deep life." }
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 48, y: 17, side: "right", label: "Surface survey platform", note: "Stable deployment station anchoring deep hydrographic casts in moving ocean water." },
    { x: 49, y: 42, side: "left", label: "Conductive winch cable", note: "Transmits real-time sensor telemetry and commands to the descending instrument frame." },
    { x: 30, y: 48, side: "right", label: "Invisible pycnocline layer", note: "Rapid transition in salinity and temperature identified via continuous sensor profiling." },
    { x: 49, y: 78, side: "left", label: "CTD & Niskin rosette", note: "Sensors profile conductivity, temperature, and depth while bottles capture discrete water samples." }
  ]}
  figNo="07"
