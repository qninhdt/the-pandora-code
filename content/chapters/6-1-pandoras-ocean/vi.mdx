<DiagramFigure
  ...
  labels={[
    { x: 82, y: 18, side: "left", label: "Đầm phá & rạn san hô nông", note: "Tầng nước nông ngập tràn ánh sáng với năng suất sinh học cao" },
    { x: 48, y: 44, side: "left", label: "Vùng chuyển tiếp quang học", note: "Cường độ ánh sáng giảm nhanh theo độ sâu" },
    { x: 68, y: 55, side: "right", label: "Vách rạn san hô dốc đứng", note: "Thành đá vôi thẳng đứng nơi các loài lọc nước bám dày đặc" },
    { x: 18, y: 76, side: "right", label: "Bể chứa nước sâu thiếu sáng", note: "Tầng nước sâu lạnh giá tích tụ nguồn dinh dưỡng khoáng dồi dào" }
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 12, side: "right", label: "Tầng nước mặt quang dưỡng", note: "Thực vật phù du quang hợp chuyển đổi ánh sáng thành sinh khối" },
    { x: 52, y: 48, side: "left", label: "Tuyết biển chìm lắng", note: "Mưa vật chất hữu cơ rơi xuống đáy đại dương mang theo carbon" },
    { x: 50, y: 88, side: "right", label: "Tái khoáng hóa dinh dưỡng", note: "Vi khuẩn phân hủy chất hữu cơ giải phóng nitrate và phosphate" }
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 12, y: 38, side: "right", label: "Dòng hải lưu đại dương", note: "Khối nước lớn di chuyển qua vùng biển mở" },
    { x: 52, y: 54, side: "left", label: "Rạn ngầm cản dòng", note: "Địa hình đáy biển nông cản trở dòng chảy và tạo dòng xoáy" },
    { x: 78, y: 68, side: "left", label: "Vệt nước màu mỡ sau đảo (IME)", note: "Hiện tượng khối đảo khuấy động dòng dinh dưỡng nuôi sống cả vùng biển" }
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  labels={[
    { x: 49, y: 30, side: "right", label: "Mặt biển phẳng lặng", note: "Mặt nước êm ả không phản ánh những biến động dữ dội bên dưới" },
    { x: 27, y: 52, side: "right", label: "Mặt phân cách pycnocline biến dạng", note: "Ranh giới giữa tầng nước ấm mặt và nước lạnh sâu bị uốn cong" },
    { x: 58, y: 68, side: "left", label: "Sống ngầm dưới biển", note: "Đỉnh núi ngầm kích hoạt sự hình thành sóng nội bộ" },
    { x: 78, y: 55, side: "left", label: "Sóng ngầm đổ vỡ", note: "Sóng ngầm vỡ tung khuấy đảo chất dinh dưỡng lên tầng mặt" }
  ]}
  figNo="04"
...
<DiagramFigure
  ...
  labels={[
    { x: 22, y: 54, side: "right", label: "Vùng biển xanh nghèo dinh dưỡng", note: "Vùng nước biển mở trong vắt với mật độ sinh vật phù du thấp" },
    { x: 48, y: 46, side: "left", label: "Ranh giới mặt sóng hội tụ", note: "Đường giao nhau giữa hai khối nước tạo bẫy tích tụ sinh vật" },
    { x: 78, y: 48, side: "left", label: "Vệt nước xanh trù phú", note: "Khối nước giàu dinh dưỡng bùng nổ thực vật phù du" }
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  labels={[
    { x: 48, y: 30, side: "right", label: "Mưa mạt vụn đáy biển", note: "Nguồn thức ăn duy nhất cho phần lớn đáy biển sâu tăm tối" },
    { x: 23, y: 76, side: "right", label: "Xác cá voi Tulkun chìm đáy", note: "Khối sinh khối khổng lồ nuôi dưỡng ốc đảo đáy biển suốt nhiều thập kỷ" },
    { x: 82, y: 68, side: "left", label: "Ốc đảo miệng phun thủy nhiệt", note: "Hệ sinh thái hóa tổng hợp độc lập hoàn toàn với ánh sáng mặt trời" }
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 48, y: 17, side: "right", label: "Bệ khảo sát mặt biển", note: "Tàu nghiên cứu triển khai các thiết bị đo đạc hải dương học" },
    { x: 49, y: 42, side: "left", label: "Cáp tời dẫn điện", note: "Cáp chịu lực truyền dữ liệu cảm biến thời gian thực lên tàu" },
    { x: 30, y: 48, side: "right", label: "Lớp biến nhiệt pycnocline vô hình", note: "Ranh giới mật độ nước được phát hiện qua đo đạc độ dẫn nhiệt" },
    { x: 49, y: 78, side: "left", label: "Bộ khung chai Niskin & cảm biến CTD", note: "Hệ thống lấy mẫu nước ở các tầng sâu chính xác" }
  ]}
  figNo="07"
