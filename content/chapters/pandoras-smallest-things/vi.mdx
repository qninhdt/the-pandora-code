<DiagramFigure
  ...
  labels={[
    { x: 23, y: 48, side: "right", label: "Lớp cutin lá nguyên vẹn", note: "Lớp sáp giữ carbon và khoáng chất trong mô sống" },
    { x: 48, y: 48, side: "left", label: "Ranh giới hóa xương lá", note: "Động vật chân khớp cực nhỏ và vi khuẩn ăn mô mềm giữa các gân lá" },
    { x: 78, y: 45, side: "left", label: "Mạng sợi nấm phân giải", note: "Sợi nấm tiết enzyme phân giải polyphenol phức tạp và tàn dư lignin cấu trúc" },
    { x: 88, y: 74, side: "left", label: "Rễ hấp thu dinh dưỡng", note: "Đầu rễ cộng sinh nấm thu giữ các ion được giải phóng để tái chế trong tán" }
  ]}
  figNo="01"
...
Nhặt lên một vụn đất khỏe mạnh, có thể chứa hàng tỷ tế bào. Con số chính xác ấy lại chẳng mấy quan trọng bằng một ảo giác mà đôi mắt ta mắc phải: ta chỉ thấy một hạt vật chất đồng nhất, ở chính nơi mà các vi sinh vật đang trải nghiệm cả một vùng địa cảnh bao la. Cát, phù sa và đất sét được kết dính cùng nhau nhờ dịch tiết rễ cây, những sợi khuẩn ty nấm, chất kết dính gốc polyme vi sinh và các mảnh vụn hữu cơ, kiến tạo nên một <GlossaryTerm slug="soil-aggregate">hạt kết tụ đất</GlossaryTerm>. Xuyên suốt và bao quanh khối hạt ấy là một mạng lưới chằng chịt, từ những đường hầm rộng thênh thang cho giun đất qua lại, đến những vi kẽ rỗng còn hẹp hơn cả một tế bào.
...
<DiagramFigure
  ...
  labels={[
    { x: 24, y: 25, side: "right", label: "Khoang rỗng lớn chứa khí", note: "Kênh thoáng khí sau khi thoát nước cho phép oxy khuếch tán qua nền đất." },
    { x: 41, y: 46, side: "right", label: "Màng nước mao dẫn", note: "Màng nước trên bề mặt ẩm tạo đường đi cho vi khuẩn và chất tan." },
    { x: 58, y: 24, side: "left", label: "Vi đoàn lạp liên kết khoáng", note: "Chất nhầy polysaccharide và sợi nấm gắn các hạt khoáng với nhau." },
    { x: 68, y: 65, side: "left", label: "Lõi vi mô kỵ khí", note: "Oxy cạn trong các vi khoang bão hòa nước tạo ra các hốc kỵ khí." }
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 26, y: 48, side: "right", label: "Bể ối nhân tạo vô trùng", note: "Avatar phát triển trong dịch nuôi tổng hợp vô trùng với đường ruột trống chưa bị định cư." },
    { x: 48, y: 33, side: "left", label: "Rào cản thai kỳ", note: "Môi trường phòng thí nghiệm được kiểm soát cách ly cơ thể đang phát triển khỏi mọi sinh quyển." },
    { x: 74, y: 38, side: "left", label: "Cấy vi sinh môi trường", note: "Những nhịp thở đầu tiên và tiếp xúc với không khí, thực vật Pandora khởi đầu quá trình định cư dày đặc." },
    { x: 74, y: 41, side: "right", label: "Hình thành hệ vi sinh vật mới", note: "Hệ sinh thái đường tiêu hóa phải thiết lập các sinh vật cộng sinh khả dụng để tiêu hóa dưỡng chất." }
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  labels={[
    { x: 15, y: 30, side: "right", label: "Vi sinh vật ngoại lai đến nơi", note: "Vi sinh vật ngoại lai gặp da vật chủ mà không có lịch sử tiến hóa chung." },
    { x: 44, y: 46, side: "left", label: "Thử nghiệm tương thích thụ thể", note: "Lây bệnh đòi hỏi sự gắn kết phân tử chính xác trên bề mặt tế bào vật chủ." },
    { x: 75, y: 25, side: "left", label: "Lá chắn hệ vi sinh vật cộng sinh", note: "Hệ vi sinh vật dày đặc trên biểu mô bản địa ngăn vi sinh vật ngoại lai định cư." },
    { x: 75, y: 75, side: "left", label: "Đáp ứng miễn dịch bẩm sinh", note: "Các tế bào thực bào và peptide kháng khuẩn không đặc hiệu vô hiệu hóa kẻ xâm nhập chưa biết." }
  ]}
  figNo="04"
...
<DiagramFigure
  ...
  labels={[
    { x: 14, y: 45, side: "right", label: "Tiền đồn con người", note: "Lọc không khí kiểm soát khí quyển nhưng không thể loại bỏ chất nhiễm bám trên bề mặt." },
    { x: 44, y: 48, side: "right", label: "Khu chuyển tiếp đồ bảo hộ", note: "Nhân viên thực địa mang cặn bám bên ngoài qua ranh giới khoang điều áp." },
    { x: 78, y: 55, side: "left", label: "Vận chuyển vật chất bám bề mặt hai chiều", note: "Xe đẩy, khớp máy và đế giày vượt qua khoang điều áp để vận chuyển vật chất sinh học." },
    { x: 37, y: 83, side: "right", label: "Chuyển giao do tiếp xúc đế giày", note: "Bề mặt ma sát cao trao đổi cơ học vi sinh vật Trái Đất và bản địa." }
  ]}
...
Nếu một kiểu gen vật chủ kháng lại được lây nhiễm, những cá thể mang gen đó sẽ để lại nhiều hậu duệ hơn. Sự đề kháng lan rộng. Quần thể vật chủ phổ biến mới đó giờ đây trở thành môi trường để các biến thể mầm bệnh cạnh tranh, do vậy bất kỳ biến thể nào lách qua được hàng rào phòng ngự sẽ giành lợi thế. Vật chủ và mầm bệnh trở thành những áp lực chọn lọc tác động qua lại lẫn nhau: sự <GlossaryTerm slug="coevolution">đồng tiến hóa</GlossaryTerm> ở hình thái mật thiết nhất.
...
Còn Pandora? Sinh sản hữu tính rõ ràng ở người Na'vi và nhiều loài quan sát được. Ký sinh trùng và bệnh truyền nhiễm lại được ghi chép rất ít, nhất là trong chính sử điện ảnh. Chưa đủ để kết luận Nữ hoàng Đỏ duy trì sinh sản hữu tính ở Pandora; nhưng đủ để hỏi đúng: mầm bệnh có lây tốt hơn ở kiểu gen phổ biến so với kiểu gen hiếm không, và lợi thế ấy có đảo chiều theo thời gian? Cho đến khi có mẫu thực địa, Nữ hoàng vẫn là vị khách có thể có, chưa phải cư dân chính sử.

<Callout variant="warning" title="Ranh giới mà chương này sẽ không vượt qua">
Đa dạng Pandora không chứng minh chọn lọc do mầm bệnh. Sinh sản hữu tính không chứng minh Nữ hoàng Đỏ. Truyện bệnh được cấp phép không lập nên hệ vi sinh vật chính sử. Cơ chế ở đây là khoa học Trái Đất đã đo lường; áp dụng nó lên Pandora là suy đoán có thể kiểm chứng, vì chưa có dữ liệu kiểu gen vật chủ, tính đặc hiệu mầm bệnh hay lây nhiễm theo thời gian.
</Callout>
