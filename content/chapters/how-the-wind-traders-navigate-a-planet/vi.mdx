...
Chữ "gần như" mang ý nghĩa quyết định, và có một cách chặt chẽ để biết khi nào ta có thể tin tưởng nó: So sánh xem lực quán tính của chính dòng chảy đẩy nó đi mạnh đến mức nào so với lực tự quay của hành tinh, và tỷ số giữa hai đại lượng này là một con số không thứ nguyên duy nhất — <GlossaryTerm slug="rossby-number">số Rossby</GlossaryTerm> (Ro). Nó bằng vận tốc gió chia cho tích của quy mô không gian và cường độ lực Coriolis cục bộ. Khi con số đó nhỏ hơn 1 rất nhiều, sự tự quay của hành tinh nắm quyền kiểm soát tuyệt đối và gió sẽ chảy ngoan ngoãn dọc theo các đường đẳng áp. Khi nó xấp xỉ 1 hoặc lớn hơn, chuyển động quay chỉ đóng vai phụ và dòng chảy sẽ biến thành những hình thái hỗn loạn khó lường.
