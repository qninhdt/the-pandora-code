<DiagramFigure
  ...
  labels={[
    { x: 45, y: 35, side: "right", label: "Khối đá lơ lửng", note: "Khối núi đá karst khổng lồ hàng kilomet treo mình giữa không trung trên biển mây." },
    { x: 22, y: 55, side: "left", label: "Kỵ sĩ Ikran", note: "Kỵ sĩ Na'vi lướt qua những khoảng không thăm thẳm giữa các đỉnh núi bay." },
    { x: 65, y: 70, side: "right", label: "Dây leo bám rễ", note: "Thảm thực vật biểu sinh và dây leo khổng lồ nối liền các khối đá lơ lửng." }
  ]}
  alt="Một kỵ sĩ cưỡi banshee bay lượn giữa những khối đá karst khổng lồ của Dãy núi Hallelujah lơ lửng trên biển mây lúc bình minh"
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    { x: 48, y: 65, side: "left", label: "Mạch quặng unobtanium", note: "Lõi khoáng chất siêu dẫn nhiệt độ phòng nằm sâu trong phần thân dưới của ngọn núi." },
    { x: 70, y: 45, side: "right", label: "Các nhánh quặng phân tỏa", note: "Các nhánh khoáng siêu dẫn đâm xuyên qua nền đá silicat xung quanh." },
    { x: 30, y: 30, side: "left", label: "Khối đá làm trọng tâm", note: "Khối đá tự nhiên không từ tính đóng vai trò làm đối trọng trọng lực giữ thăng bằng." }
  ]}
...
Sức hút gián tiếp thông qua mạng tinh thể ấy là vừa đủ — chót lọt vừa đủ — để vượt qua lực đẩy của chúng và trói buộc hai electron thành một <GlossaryTerm slug="cooper-pair">cặp Cooper</GlossaryTerm>. Và sự ghép cặp này làm thay đổi mọi thứ, nhờ vào một quy luật sâu xa về cách tự nhiên phân loại các hạt.
...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 30, side: "right", label: "Đỉnh thế năng bất ổn định", note: "Phương trình Laplace quy định trường tĩnh không thể tồn tại cực tiểu thế năng trong không gian 3D." },
    { x: 30, y: 65, side: "left", label: "Vectơ trượt ngang", note: "Bất kỳ nhiễu loạn nhỏ nào theo phương ngang cũng khiến vật thể trượt văng khỏi đỉnh từ trường." },
    { x: 70, y: 65, side: "right", label: "Giới hạn định lý Earnshaw", note: "Từ trường tĩnh đơn thuần không thể duy trì trạng thái lơ lửng ổn định thụ động." }
  ]}
  alt="Một khối hình học tối màu nằm thăng bằng chông chênh trên đỉnh vòm thế năng phát sáng, cùng các vị trí trượt mờ ảo minh họa trạng thái cân bằng bất ổn định"
  figNo="07"
