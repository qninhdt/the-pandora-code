...
We have spent the four previous chapters of this part taking that system apart. We found the wiring first — that the forest is laced together not by root touching root but by an ancient fungal web threading between them, a real architecture with a real Earth analogue. We asked whether all that connection adds up to a mind, and found distributed cognition: intelligence with no central self, competence with nobody home. We measured what such a network could actually carry, and ran the bandwidth against the hard limits that govern any channel. And we asked why burning a piece of it never seems to kill it, and found the cold mathematics of redundancy and percolation — why a richly cross-linked network shrugs off damage that would sever a tidy one.
