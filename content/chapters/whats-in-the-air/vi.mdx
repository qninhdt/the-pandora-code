...
<DataComparison
  stats={[
    ...
    { label: "Carbon dioxide (CO₂) — Pandora so với Trái Đất", value: "16–18%", vs: "0.04%", tone: "amber" },
    { label: "Xenon — Pandora so với Trái Đất", value: "~5%", vs: "~0%", tone: "cyan" },
    { label: "Hydrogen sulfide (H₂S) — Pandora", value: "dưới 1% rất nhiều", vs: "vi lượng", tone: "magenta" }
  ]}
/>
...
Không khí là một đám đông các phân tử chuyển động không ngừng, liên tục đập vào mọi bề mặt cản đường chúng, và sự "đập" đó chính là áp suất. Trong một hỗn hợp, mỗi loại khí sẽ đóng góp một phần nhịp đập riêng vào tổng thể, tỷ lệ thuận với số lượng hiện diện của nó — đó gọi là <GlossaryTerm slug="partial-pressure">áp suất riêng phần</GlossaryTerm> (partial pressure). Đây chỉ là phép tính sổ sách cơ bản, được John Dalton đúc kết từ hai thế kỷ trước: tổng áp suất của không khí bằng tổng các áp suất riêng phần của những loại khí cấu thành, và phần của mỗi loại khí sẽ bằng tỷ lệ phần trăm của nó nhân với tổng áp suất. Lấy 1/5 oxy trong môi trường có tổng áp lực là 1 atmosphere (atm), bạn sẽ có áp suất oxy là 1/5 atm. Cùng là 1/5 đó, nhưng đặt vào một bầu không khí chỉ có lực ép bằng một nửa, bạn sẽ chỉ nhận được áp suất oxy bằng *1/10* atm — cùng tỷ lệ phần trăm, nhưng lực ép chỉ còn một nửa.
...
Bây giờ, hãy bơm đầy bầu không khí bên ngoài ấy bằng 17% CO₂. Độ dốc áp suất không chỉ suy yếu đi. Nó bị *đảo ngược* hoàn toàn. Lúc này, không khí trong phổi bạn đang tạo ra sức ép CO₂ lớn hơn hẳn so với trong máu. Hệ quả là CO₂ làm một chuyện không tưởng: nó thẩm thấu ngược chiều, chảy tràn *vào* cơ thể bạn, với tốc độ điên rồ chưa từng có mà cơ thể phải hứng chịu. Trạng thái này gọi là <GlossaryTerm slug="hypercapnia">tăng CO₂ huyết</GlossaryTerm> (hypercapnia) — sự quá tải carbon dioxide, và chuỗi hậu quả tàn khốc của nó sẽ ập đến chỉ trong một hoặc hai nhịp thở.
...
<DiagramFigure
  ...
  alt="Hình vẽ cắt ngang túi phổi với các mũi tên hiển thị phân tử CO₂ ồ ạt tràn vào máu thay vì thoát ra, dòng máu chuyển sang màu đỏ cam báo hiệu tính axit"
  figNo="04"
  caption="Sự chênh lệch áp suất quay xe. Với không khí bên ngoài chứa 17% CO₂, thứ khí cơ thể bạn dành cả đời để tống khứ giờ đây lại tràn ngược qua màng phổi — và biến máu thành axit."
  tier="real_science"
/>
...
<Comparison
  left={{
    title: "Carbon dioxide (CO₂) — Trận đại hồng thủy",
  ...
  right={{
    title: "Hydrogen sulfide (H₂S) — Nút thắt nghẹt thở",
