<DiagramFigure
  ...
  labels={[
    { x: 26, y: 22, side: "left", label: "Cặp cánh trước, giữa nhịp đập xuống", note: "Đôi cánh trước vĩ đại — bề mặt tạo ra phần lớn lực nâng." },
    { x: 46, y: 15, side: "right", label: "Cặp cánh sau, chuyển động ngược chiều", note: "Đôi cánh phát triển hoàn chỉnh trên nhịp đập lên độc lập, không phải vây đuôi. Bốn bề mặt dẫn động, hai nhịp đập riêng biệt." },
    { x: 61, y: 49, side: "right", label: "Kỵ sĩ", note: "Varang, nép mình sát lưng thú. Cô là thước đo quy mô trực quan cho ánh nhìn." },
    { x: 42, y: 78, side: "left", label: "Ánh than hồng hắt từ bên dưới", note: "Dung nham phun trào dưới cột khói tro — không phận mà loài sinh vật này được tôi luyện để thống trị." },
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    { x: 8, y: 26, side: "right", label: "Không khí tới nằm ngang", note: "Luồng khí chưa bị xáo trộn, đi thẳng vào cánh trước." },
    { x: 24, y: 37, side: "left", label: "Cánh trước", note: "Tạo lực nâng bằng cách bẻ luồng khí này chúc xuống dưới. Đó là toàn bộ cơ chế." },
    { x: 50, y: 50, side: "right", label: "Luồng khí bị bẻ cong xuống", note: "Không phải hiệu ứng phụ — nó là khí thải của quá trình tạo lực nâng, không thể tắt đi." },
    { x: 68, y: 65, side: "right", label: "Cánh sau, trong luồng khí đã qua sử dụng", note: "Cùng biên dạng cánh, cùng tư thế, nhưng gió ở đây đã sụt lún: ít lực nâng hơn, nhiều lực cản hơn." },
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 10, y: 45, side: "right", label: "Trượt xa về phía sau", note: "Khoảng cách rất lớn dọc theo thân — nhưng hầu như không mang lại lợi ích gì." },
    { x: 34, y: 56, side: "right", label: "Vẫn nằm trong luồng khí sụt lún", note: "Cánh sau đã lùi rất xa nhưng không thu được gì vì chưa từng thoát khỏi vệt khí thải." },
    { x: 20, y: 74, side: "right", label: "Nơi lực cản bùng phát", note: "Dòng khí vỡ vụn phía sau một bề mặt bị phá hoại khí động." },
    { x: 63, y: 34, side: "left", label: "Nâng cao lên trên", note: "Hầu như không dãn cách trước sau, nhưng có khoảng trống thẳng đứng rộng rãi." },
    { x: 68, y: 66, side: "left", label: "Luồng khí sạch", note: "Cả hai bề mặt lúc này đều đón không khí nguyên vẹn chưa bị xáo trộn. Đây mới là nước đi mang lại lợi nhuận." },
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  labels={[
    { x: 52, y: 13, side: "left", label: "Đập cùng nhịp", note: "Cả hai cặp cùng chung một hành trình: cú đẩy đơn lẻ mạnh nhất, và hóa đơn năng lượng đắt nhất." },
    { x: 55, y: 56, side: "left", label: "Trễ một phần tư nhịp", note: "Cặp cánh sau lướt xuyên qua luồng xoáy mà cánh trước vừa giải phóng." },
    { x: 57, y: 57, side: "right", label: "Năng lượng lưu lại trong không khí", note: "Những vòng xoáy không khí mà cánh trước đã bỏ công tạo ra. Băng qua chúng đúng thời điểm và bạn thu hồi lại được một phần năng lượng đó." },
    { x: 50, y: 88, side: "left", label: "Đập đối nghịch", note: "Các lực đẩy triệt tiêu lẫn nhau, cơ thể ngừng rung lắc, và con vật biến thành một bệ ngắm vững như bàn thạch." },
  ]}
  figNo="04"
...
Nightwraith không phải một con chuồn chuồn phóng to, và bất kỳ phân tích nào coi nó như vậy đều sai lầm về mặt vật lý. Thủ thuật *điều khiển pha* — chọn thời điểm cặp cánh sau vỗ đập — có thể áp dụng được ở mọi quy mô kích thước vì nó dựa trên hình học và thời gian chứ không dựa vào độ nhớt giữ xoáy. Nhưng thủ thuật xoáy mép trước thì không. Bất kể sinh vật bốn cánh sải 16 mét này dùng cách nào để kiểm soát dòng khí ở góc đón lớn, nó phải dựa vào cơ chế khác: uốn cong độ khum cánh (camber), xả khí dọc sải, hoặc góc quét cánh. Canon không đề cập, và chúng ta cũng không nên võ đoán.
</Callout>
...
<DiagramFigure
  ...
  labels={[
    { x: 30, y: 29, side: "right", label: "Trọng tâm nằm phía trước", note: "Trọng tâm khối lượng nằm trước điểm đặt lực của cơn gió bất ngờ." },
    { x: 43, y: 29, side: "right", label: "Điểm cơn gió tác động", note: "Điểm trung hòa khí động. Khoảng cách giữa hai điểm này quyết định toàn bộ câu chuyện." },
    { x: 10, y: 17, side: "right", label: "Mũi bị đẩy chúc xuống", note: "Tự cân bằng — an toàn, êm ái, nhưng chống lại mọi cú ngoặt mà con vật muốn thực hiện." },
    { x: 48, y: 73, side: "left", label: "Trọng tâm lùi ra sau", note: "Trượt lùi qua khỏi điểm cân bằng." },
    { x: 9, y: 62, side: "right", label: "Mũi tiếp tục ngóc lên", note: "Sự nhiễu loạn tăng dần thay vì tự tắt. Đổi hướng nhanh hơn nhiều lần — nhưng không bao giờ cho phép bạn lơ là." },
  ]}
  figNo="05"
  labels={[
    { x: 30, y: 29, side: "right", label: "Trọng tâm nằm phía trước", note: "Trọng tâm khối lượng nằm trước điểm đặt lực của cơn gió bất ngờ." },
...
Quán tính cản lăn tỷ lệ thuận với bình phương của sải cánh ($I \propto b^2$). Đôi cánh dài 3,5 mét của chim hải âu albatross đạt hiệu suất khí động tuyệt mỹ nhưng gần như không thể lật nghiêng nhanh; cùng khối lượng cánh đó nếu nén vào hai cặp cánh ngắn sẽ lăn nghiêng nhanh hơn gấp nhiều lần với cùng một lực cơ bắp. Đây là hiệu ứng vật lý bất di bất dịch — đó là lý do không một loài sinh vật bay lượn sải cánh dài nào, trên bất kỳ hành tinh nào, có thể đồng thời là một đấu thủ không chiến linh hoạt trong không gian hẹp. Bạn chỉ có thể chọn: hoặc là đôi cánh tiết kiệm năng lượng, hoặc là đôi cánh chớp nhoáng.
</Callout>
...
<DiagramFigure
  ...
  labels={[
    { x: 66, y: 45, side: "left", label: "Kẻ đuổi theo, bị văng rộng", note: "Nhanh hơn, nặng hơn, và bị khóa vào một vòng lượn không thể thu hẹp." },
    { x: 35, y: 53, side: "right", label: "Cắt vào góc trong", note: "Chậm hơn — nhưng đang lượn trên một bán kính nhỏ hơn rất nhiều, con số duy nhất có ý nghĩa ở đây." },
    { x: 22, y: 30, side: "right", label: "Vòng cung rộng", note: "Nơi vận tốc biến thành gánh nặng: bay càng nhanh thì vòng lượn càng lớn." },
    { x: 12, y: 84, side: "right", label: "Địa hình bên dưới", note: "Vách đá bazan nứt nẻ và cột khói nóng. Không có chỗ cho sự rộng rãi trong một khúc cua." },
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 12, y: 48, side: "right", label: "Dài và hẹp", note: "Kẻ lượn đại dương. Tỷ số lực nâng trên lực cản siêu việt, nhưng thực tế gần như không thể ngoặt gấp." },
    { x: 37, y: 52, side: "right", label: "Ngắn và rộng", note: "Kẻ săn mồi trong rừng rậm. Bay chậm, lượn hẹp, sinh ra để luồn lách qua các thân cây." },
    { x: 62, y: 52, side: "left", label: "Quét xuôi và nhọn", note: "Chuyên gia bổ nhào. Tốc độ rơi tự do kinh hoàng, kết cấu chịu lực cực tốt khi kéo ngóc đầu." },
    { x: 86, y: 55, side: "left", label: "Hai cặp cánh, nửa sải", note: "Từ bỏ hiệu suất tiết kiệm của cả ba để mua lấy thứ không ai có: quyền kiểm soát hướng tức thì." },
  ]}
  figNo="07"
...
Chương 2.7 đã xác lập nguyên lý này một cách sáng tỏ: kẻ đi săn và con mồi thúc đẩy lẫn nhau tiến tới những giới hạn cực đoan xuyên suốt chiều dài thời gian tiến hóa, mỗi sự thích nghi ở bên này sẽ chọn lọc ra một đòn phản kích ở bên kia, và *không bên nào từng giành chiến thắng tuyệt đối — đó mới là điểm mấu chốt; cuộc chạy đua chính là trạng thái cân bằng động*. Những gì chương 2.7 phác họa trên diện rộng, chương này sẽ chứng minh cụ thể, bởi chuyển động bay là nơi cuộc chạy đua vũ trang để lại những hóa đơn thanh toán rõ ràng nhất.
...
<DiagramFigure
  ...
  labels={[
    { x: 33, y: 33, side: "right", label: "Kẻ săn mồi phát sóng", note: "Sóng siêu âm phóng về phía trước màn đêm để định vị những gì mắt không thấy." },
    { x: 62, y: 32, side: "left", label: "Sóng âm lan tỏa", note: "Nó đến trước khi kẻ săn mồi tới nơi — chính là sơ hở mà con mồi khai thác." },
    { x: 70, y: 79, side: "left", label: "Đã rơi tự do", note: "Đôi tai bắt đúng tần số đó, cánh khép lại, rơi thẳng khỏi bầu trời trước khi bị chạm tới." },
    { x: 55, y: 56, side: "left", label: "Khoảng cách định đoạt", note: "Mỗi hiệp đấu đều có thể đo đạc định lượng. Không có hiệp nào là hồi kết." },
  ]}
  figNo="08"
...
<ClaimAudit
  rungs={[
    ...
    },
    {
      ...
      verdict: "well-supported",
      evidence: "Sự đánh đổi này là chuẩn mực trong cơ học bay và khớp hoàn hảo với canon: sinh vật săn mồi trong cột tro và không gian chật hẹp, tránh bay lượn tầng cao, và chiến thắng trong các cuộc cận chiến.",
      caution: "Đây là cách chúng ta đọc giải phẫu của sinh vật, không phải tuyên bố chính thức từ canon. Chưa có tài liệu chính thức nào phân tích Nightwraith dưới góc độ khí động học.",
    },
    {
      ...
      caution: "Canon chưa từng xác nhận mối quan hệ lệch pha của cánh, và các cơ chế xoáy quy mô côn trùng không thể tồn tại khi phóng tỷ lệ lên sải cánh 16 mét. Lập luận về thời gian có thể đúng; lập luận về luồng xoáy thì không.",
    },
    {
...
Đó là một thiết kế sinh học thực thụ, và lý do nó xứng đáng được ngưỡng mộ không phải vì nó quyền năng. Mà vì nó *chuyên biệt*. Ở một thời khắc nào đó trong dòng thời gian sâu thẳm của nhánh tiến hóa ấy, bay nhanh là chưa đủ, bay tiết kiệm là chưa đủ, và thứ mang lại sự sống là khả năng thay đổi ý định giữa không trung nhanh hơn đối phương có thể kịp phản ứng. Sinh vật này là cuốn nhật ký ghi lại cuộc tranh luận tiến hóa đó. Giống như con bướm đêm cụp cánh rơi tự do khi nghe thấy tiếng dơi, và giống như con dơi đã học cách thì thầm trong bóng tối.
