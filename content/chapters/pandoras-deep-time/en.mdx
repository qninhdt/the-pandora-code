...
<DiagramFigure
  ...
  alt="A relatively small moon hanging close beside the enormous banded bulk of a gas giant, the moon visibly stretched into a faint egg shape with its long axis pointing toward the planet, glowing orange molten fractures threading its interior and crust"
  labels={[
    { x: 28, y: 55, side: "left", label: "Tidally kneaded moon", note: "Continuous gravitational distortion generates internal frictional heat." },
    { x: 42, y: 72, side: "right", label: "Molten tidal fractures", note: "Superheated magma veins powered by ongoing tidal dissipation." },
    { x: 75, y: 40, side: "left", label: "Polyphemus gravitational well", note: "Massive gas giant whose proximity provides the tidal energy budget." }
  ]}
  figNo="05"
  caption="The engine that keeps a small moon molten. By its size and age Pandora should be a cold, geologically dead stone. Hugging Polyphemus, it is flexed and kneaded by tidal forces — a continuous gravitational squeeze that melts its interior and powers volcanoes across billions of years."
  tier="inference"
/>
