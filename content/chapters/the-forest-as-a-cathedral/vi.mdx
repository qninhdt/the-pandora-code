...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 52, side: "left", label: "Khí khổng Trái Đất mở rộng", note: "Lỗ khí mở rộng để đón CO₂ khan hiếm, chấp nhận mất nhiều nước" },
    { x: 74, y: 52, side: "right", label: "Khí khổng Pandora co hẹp", note: "Lỗ khí thu hẹp vẫn thu nạp dồi dào CO₂ mà thất thoát rất ít nước" },
    { x: 24, y: 20, side: "left", label: "Thất thoát hơi nước ồ ạt", note: "Cột hơi nước thoát ra dữ dội trong không khí khô của Trái Đất" },
    { x: 74, y: 65, side: "right", label: "Dòng carbon đậm đặc", note: "Nồng độ CO₂ cao tràn nhanh vào khoang dưới khí khổng" }
  ]}
  figNo="08"
...
<DiagramFigure
  ...
  labels={[
    { x: 22, y: 50, side: "left", label: "Cây củ tùng (~116 m)", note: "Cây cao nhất còn sống trên Trái Đất, áp sát trần thủy lực ~130 m" },
...
<RelatedChapters
  slugs={["hometree-as-keystone", "convergent-but-not-quite", "why-banshees-get-to-be-big", "the-wood-wide-web", "floating-mountains-and-the-superconductor"]}
  locale="vi"
/>
