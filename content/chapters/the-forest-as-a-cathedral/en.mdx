...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 52, side: "left", label: "Wide Earth stoma", note: "Pore opens wide to capture scarce CO₂, losing copious water" },
    { x: 74, y: 52, side: "right", label: "Narrow Pandoran stoma", note: "Constricted pore admits abundant CO₂ with minimal water loss" },
    { x: 24, y: 20, side: "left", label: "Heavy water vapor loss", note: "Extensive transpiration plume in Earth's dry air" },
    { x: 74, y: 65, side: "right", label: "Dense carbon stream", note: "High CO₂ concentration rapidly enters substomatal cavity" }
  ]}
  figNo="08"
...
<DiagramFigure
  ...
  labels={[
    { x: 22, y: 50, side: "left", label: "Coast redwood (~116 m)", note: "Earth's tallest tree standing, close under the ~130 m hydraulic ceiling" },
