...
<DiagramFigure
  ...
  figNo="01"
  labels={[
    { x: 38, y: 56, side: "right", label: "Ash, not soil", note: "Coarse grey tephra — no dark crumb of humus, no thread of root" },
    { x: 57, y: 25, side: "left", label: "A calcined giant", note: "Megaflora skeleton cooked to charcoal and mineralized stone" },
    { x: 84, y: 64, side: "left", label: "The mountain still breathes", note: "Active fumarole venting volcanic gases and thermal heat through the crust" }
  ]}
...
The Omatikaya burn was <GlossaryTerm slug="secondary-succession">secondary succession</GlossaryTerm>, and it is why the sequels can show green returning: the template held. The Ashlands are <GlossaryTerm slug="primary-succession">primary succession</GlossaryTerm>, and that single reclassification is most of the answer to the question you are holding in your hand. The eruption did not merely kill the forest. It deleted the ground the next forest would have needed, and reset the clock all the way to zero — to bare rock, the way the very first land on any world begins.
...
<DiagramFigure
  ...
  figNo="02"
  labels={[
    { x: 22, y: 76, side: "right", label: "Surviving subterranean legacy", note: "Seed bank, mycorrhizae, and root crowns survive intact beneath the char" },
    { x: 21, y: 28, side: "right", label: "Secondary succession (fast)", note: "Rapid resprouting from biological templates — recovery in decades" },
    { x: 71, y: 35, side: "left", label: "Primary succession (slow)", note: "Calcined snag on sterile substrate with zero surviving biological templates" },
    { x: 76, y: 70, side: "left", label: "Total burial deletion", note: "Deep volcanic tephra cooks the ground to sterile rock — recovery in centuries" }
  ]}
...
<DiagramFigure
  ...
  figNo="03"
  labels={[
    { x: 24, y: 64, side: "right", label: "Surviving root crown", note: "Shielded beneath the thermal pulse, retaining metabolic vitality" },
    { x: 51, y: 62, side: "right", label: "Sealed seed cache", note: "Dormant embryonic pod insulated deep enough to survive the burial" },
    { x: 70, y: 72, side: "left", label: "Subterranean burrow survivor", note: "Fossorial animal sheltering underground when the blast fell" },
    { x: 35, y: 26, side: "left", label: "Island of recovery", note: "Buried survivor breaches the ash crust to seed surrounding sterile plain" }
  ]}
...
<DiagramFigure
  ...
  figNo="04"
  labels={[
    { x: 34, y: 55, side: "right", label: "Pioneer prairie lupine", note: "Biological pioneer establishing on sterile Mount St. Helens pumice" },
    { x: 38, y: 76, side: "right", label: "Nitrogen-fixing root nodules", note: "Symbiotic Rhizobium bacteria synthesize bioavailable nitrogen directly from air" },
    { x: 50, y: 78, side: "left", label: "Trapped organic island", note: "Dense foliage catches windblown detritus, manufacturing the first fertile soil" }
  ]}
...
<DiagramFigure
  ...
  figNo="05"
  labels={[
    { x: 33, y: 44, side: "right", label: "Fossorial ecosystem engineer", note: "Pocket gopher surviving the blast underground, digging upward through tephra" },
    { x: 50, y: 72, side: "right", label: "Excavated living soil", note: "Pre-eruption organic soil and nutrients hauled up to mix with sterile ash" },
    { x: 67, y: 68, side: "left", label: "Mycorrhizal spore dispersal", note: "Spreading vital fungal inoculants across the surface to enable plant re-establishment" }
  ]}
...
<DiagramFigure
  ...
  figNo="06"
  labels={[
    { x: 31, y: 52, side: "right", label: "Failed penetration (crust barrier)", note: "Radicle fails to pierce the cement-hard rain-packed tephra crust" },
    { x: 28, y: 83, side: "right", label: "Hydrophobic water beading", note: "Water beads and evaporates or runs off rather than infiltrating into root zone" },
    { x: 80, y: 55, side: "left", label: "Erosional rill incising slope", note: "Surface runoff channels into gullies, stripping away emerging germinants" }
  ]}
...
<DiagramFigure
  ...
  figNo="07"
  labels={[
    { x: 22, y: 46, side: "right", label: "Pyrolyzed dead root matrix", note: "Subsurface heat cooked root channels to black carbon inside the blast zone" },
    { x: 74, y: 44, side: "left", label: "Living mycelial mesh", note: "Intact bioluminescent root network carrying Eywa's neural connectivity" },
    { x: 51, y: 55, side: "left", label: "Severed ecotone boundary", note: "Neural and nutrient transmission terminated sharply at the edge of the volcanic burial" }
  ]}
...
<DiagramFigure
  ...
  figNo="08"
  labels={[
    { x: 38, y: 50, side: "right", label: "Hollowed mega-root cavern", note: "Collapsed calcined Hometree roots repurposed as permanent clan shelter" },
    { x: 44, y: 68, side: "right", label: "Bone, hide, and scavenged scrap", note: "Material culture adapted to salvage from dead fauna and abandoned RDA machinery" },
    { x: 70, y: 18, side: "left", label: "Barded raiding banshee", note: "Predatory mount adapted for raiding adjacent biomes to import calories" },
    { x: 88, y: 55, side: "left", label: "Barren volcanic badlands", note: "Sterile ash plain and venting fumaroles yielding virtually zero harvestable biomass" }
  ]}
