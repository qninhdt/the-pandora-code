<DiagramFigure
  ...
  labels={[
    { x: 28, y: 62, side: "right", label: "Hollow core chimney", note: "Braided trunk cavity draws combustion updrafts like a furnace flue." },
    { x: 68, y: 28, side: "left", label: "Structural collapse", note: "Accumulated architecture of two hundred centuries topples in hours." },
    { x: 50, y: 80, side: "right", label: "Canopy crush zone", note: "Falling emergent crown flattens hectares of mature understory and sub-canopy." },
    { x: 18, y: 25, side: "right", label: "Displaced canopy fauna", note: "Obligate nesters and roosting fliers scatter into the ash column." }
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    { x: 24, y: 65, side: "left", label: "Diverse control community", note: "Predation maintains a rich mosaic of anemones, barnacles, limpets, and algae." },
    { x: 71, y: 31, side: "left", label: "Keystone removal experiment", note: "Paine manually pried ochre stars from experimental plots to test top-down control." },
    { x: 77, y: 65, side: "right", label: "Mussel competitive monopoly", note: "Without predator control, Mytilus californianus monopolized nearly 100% of primary space." }
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 29, side: "right", label: "The keystone wedge", note: "Paine's classic keystone: a low-biomass regulator holding the arch together through trophic links." },
    { x: 9, y: 78, side: "right", label: "Trophic regulator (Pisaster)", note: "Predator regulates dominant competitors to maintain community diversity." },
    { x: 74, y: 30, side: "left", label: "Foundation physical bulk", note: "Foundation species create habitat through massive structural presence and biomass." },
    { x: 76, y: 62, side: "left", label: "Multi-tier tenant web", note: "Every branch, hollow, and root serves as obligate habitat for dependent species." }
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  labels={[
    { x: 13, y: 58, side: "left", label: "Solid sapwood/heartwood", note: "Intact young tree lacks internal voids or decay pockets." },
    { x: 33, y: 40, side: "left", label: "Branch failure infection court", note: "Broken limb exposes inner heartwood to fungal spores and moisture." },
    { x: 55, y: 55, side: "right", label: "Heart-rot fungal excavation", note: "Internal decomposition hollowing proceeds without killing the outer living sapwood." },
    { x: 82, y: 60, side: "right", label: "Mature vertebrate den", note: "Centuries later, the structural void shelters nesting birds and mammals." }
  ]}
  figNo="07"
...
<DiagramFigure
  ...
  labels={[
    { x: 40, y: 24, side: "right", label: "Decentury hollow cavities", note: "Large structural cavities require centuries of fungal decay and animal excavation to mature." },
    { x: 65, y: 50, side: "left", label: "Suspended soil terrace", note: "Massive horizontal boughs accumulate deep organic soil mats high above the ground." },
    { x: 26, y: 68, side: "right", label: "Epiphytic bark matrix", note: "Deeply fissured bark supports multi-layered gardens of mosses, lichens, and ferns." },
    { x: 50, y: 88, side: "left", label: "Buttress root landscape", note: "Flanged root architecture stabilizes the titan while shaping hundred-meter hydrology." }
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 12, y: 38, side: "right", label: "Historic chestnut canopy", note: "American chestnut comprised up to 40% of eastern deciduous forest canopy before blight." },
    { x: 24, y: 88, side: "right", label: "Predictable mast crop", note: "Abundant annual nutfall supported complex food webs and wildlife populations." },
    { x: 74, y: 72, side: "left", label: "Functional extinction", note: "Blighted root sprouts repeatedly die back, leaving the species functionally absent." },
    { x: 80, y: 26, side: "left", label: "Simplified replacement forest", note: "Secondary oak-maple stands offer reduced height and erratic mast cycles." }
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  labels={[
    { x: 22, y: 35, side: "left", label: "Hemlock thermal buffer", note: "Dense evergreen needles create a dark, cool, humid forest understory." },
    { x: 68, y: 42, side: "left", label: "Girdled hemlock stand", note: "Simulated adelgid death opens canopy, flooding forest floor with solar radiation." },
    { x: 84, y: 42, side: "right", label: "Deciduous edge community", note: "Black birch and generalist birds colonize the warm, variable microclimate." },
    { x: 28, y: 88, side: "left", label: "Cold-water stream habitat", note: "Hemlock shade protects cold-adapted aquatic insects and brook trout." }
  ]}
  figNo="08"
...
<DiagramFigure
  ...
  labels={[
    { x: 24, y: 42, side: "left", label: "Immediate survivors", note: "Adult specialists linger immediately after habitat destruction, masking extinction." },
    { x: 51, y: 52, side: "right", label: "Reproductive failure", note: "Loss of specific nest structures prevents recruitment of the next generation." },
    { x: 82, y: 50, side: "right", label: "Extinction debt realized", note: "Lineage vanishes from the regenerating forest once the aging cohort dies." }
  ]}
  figNo="09"
...
<DiagramFigure
  ...
  labels={[
    { x: 38, y: 26, side: "left", label: "Elevated seedling cohort", note: "Conifer saplings germinate along the log, elevated above competitive leaf litter." },
    { x: 31, y: 55, side: "left", label: "Decaying nurse log", note: "Rotting bole acts as a moisture sponge and slow-release nutrient reservoir." },
    { x: 46, y: 60, side: "right", label: "Fungal decomposition front", note: "Wood-decay fungi and mycorrhizal hyphae recycle lignin and cellulose." },
    { x: 82, y: 38, side: "right", label: "Stilted root colonnade", note: "Mature trees stand on arching root columns long after the log has decomposed." }
  ]}
  figNo="10"
...
<DiagramFigure
  ...
  labels={[
    { x: 9, y: 64, side: "right", label: "Year zero devastation", note: "Shattered stump and scorched soil eliminate microclimate buffering." },
    { x: 34, y: 62, side: "right", label: "Pioneer biomass surge", note: "Fast-growing pioneer vegetation quickly restores green ground cover." },
    { x: 62, y: 55, side: "left", label: "Secondary closed canopy", note: "Closed crown looks mature but lacks deep bark, large hollows, or aerial soils." },
    { x: 88, y: 30, side: "left", label: "Old-growth architectural return", note: "Centuries to millennia are required to rebuild true foundation architecture." }
  ]}
  figNo="04"
