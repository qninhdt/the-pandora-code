...
Mọi khẳng định định lượng mà tôi sắp đưa ra về những gì đã chết cùng với Hometree đều là một suy luận từ các loài cây tầng vượt tán của Trái Đất, chứ không phải là một sự thật về Pandora. Nguyên tác không cho chúng ta biết có bao nhiêu loài đã sống trên cái cây đó, vì vậy không ai có thể nói cho bạn biết có bao nhiêu loài đã chết cùng với nó — kể cả tôi.
...
Đó là một kỳ vọng có cơ sở vững chắc. Nó không phải là một sự thật trong nguyên tác, và tôi sẽ giữ cho hai điều này tách biệt. Quan điểm trung thực là danh sách khách trọ của cái cây chính là mảnh thông tin quý giá nhất còn thiếu về toàn bộ sự kiện.
</Callout>
