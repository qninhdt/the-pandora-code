<DiagramFigure
  ...
  labels={[
    ...
    { x: 68, y: 28, side: "left", label: "Sụp đổ cấu trúc", note: "Kiến trúc tích lũy hai trăm thế kỷ sụp đổ trong vài giờ" },
...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 77, y: 65, side: "right", label: "Độc quyền cạnh tranh của vẹm", note: "Không có sự kiểm soát của kẻ săn mồi, vẹm Mytilus californianus chiếm gần 100% không gian nền ban đầu" }
  ]}
  figNo="06"
...
Rồi còn có đất. Không phải đất dưới mặt đất — mà là đất ở trên không. Nơi các loài <GlossaryTerm slug="epiphyte">thực vật phụ sinh</GlossaryTerm> chồng đống trên những cành ngang lớn của một cái cây già, phần mô chết của chúng cùng những mảnh vụn chúng giữ lại không rơi xuống; chúng tích tụ ngay tại chỗ, thập kỷ này qua thập kỷ khác, cho đến khi cái cành đang gánh một thảm đất thực thụ. Công trình nghiên cứu tầng tán của Nalini Nadkarni đã xác lập cả hai nửa của bức tranh: một cây nhiệt đới vượt tán duy nhất có thể mang hơn một trăm loài thực vật phụ sinh có mạch cùng hàng tấn sinh khối thực vật không mạch, và lớp <GlossaryTerm slug="canopy-soil">đất trên tán</GlossaryTerm> bên dưới chúng có thể dày tới cỡ ba mươi centimet. Ba mươi centimet đất, ở độ cao một trăm mét trên không, với những con giun tròn riêng của nó, những con nhện nhỏ riêng của nó, quần xã động vật không xương sống riêng của nó, và ở một số khu rừng còn có cả những con kỳ giông riêng của nó — những sinh vật sống trọn cả một cuộc đời trong lớp đất chưa bao giờ chạm tới mặt đất. Cái cây chủ đôi khi còn mọc rễ ra từ chính cành của mình để uống nước từ khu vườn đang mọc trên người nó.
...
Trồng một nghìn cây non bên cạnh một cái cây năm trăm tuổi vừa bị đốn hạ và bạn đã thay thế được, ngay trong ngày đầu tiên, chính xác là không một chức năng nào của nó. Không phải là một lượng giảm bớt. Mà là không có gì cả. Không có hốc rỗng nào trong một cái cây non, không có vỏ cây nứt nẻ, không có đất trên tán, không có cành nào đủ dày để giữ một thảm thực vật phụ sinh, không có bóng râm nào đủ sâu để tạo ra một vi khí hậu.
...
<DiagramFigure
  ...
  alt="Một bức tranh cắt lớp của nhà tự nhiên học về một Hometree Pandora khổng lồ duy nhất được vẽ từ gốc đến ngọn trên nền tối, phần thân cây gồm nhiều cột bện lại được mở ra để lộ phần lõi rỗng, với các vùng rõ rệt được chú thích bằng sự sống mà chúng nắm giữ: vỏ cây nứt nẻ sâu và dày đặc rêu cùng các loài dương xỉ phụ sinh, một cành bên khổng lồ mang theo một thảm đất tán lơ lửng có thể nhìn thấy được, các hốc rỗng ở phần thân trên với các sinh vật có cánh đang đậu, những con vật nhỏ có sáu chi sống trên cây trong mạng lưới cành ở giữa tán, và phần gốc rễ chống bành ra rộng rãi."
  labels={[
    { x: 40, y: 24, side: "right", label: "Hốc rỗng quy mô thế kỷ", note: "Các khoang rỗng lớn cần hàng thế kỷ mục ruỗng do nấm và động vật đào đục để trưởng thành" },
    { x: 65, y: 50, side: "left", label: "Ruộng bậc thang đất treo", note: "Các cành ngang khổng lồ tích tụ những thảm đất hữu cơ dày trên cao" },
    { x: 26, y: 68, side: "right", label: "Ma trận vỏ cây phụ sinh", note: "Vỏ cây nứt sâu nâng đỡ những khu vườn nhiều tầng của rêu, địa y và dương xỉ" },
    { x: 50, y: 88, side: "left", label: "Cảnh quan rễ bạnh vè", note: "Rễ khổng lồ tỏa rộng tạo thành các bức tường che chắn mặt đất" }
  ]}
  figNo="02"
  caption="Một sinh vật, được đọc như một địa chỉ chứ không phải một cái cây. Mỗi đặc điểm ở đây đều là môi trường sống mà ai đó phụ thuộc vào: vỏ cây đủ sâu để giữ các khu vườn, cành đủ rộng để tích tụ đất trong không khí, những hốc rỗng mất hàng thế kỷ để mở ra, một hệ thống rễ định hình lại mặt đất trong vòng một trăm mét. Trên Trái Đất, một cây tầng vượt tán duy nhất có thể mang theo hơn một trăm loài phụ sinh và hàng trăm loài côn trùng đặc hữu của vật chủ. Pandora không bao giờ cung cấp cho chúng ta danh sách khách trọ cho trường hợp này — đó chính xác lại là con số mà chúng ta muốn biết nhất vào buổi sáng ngày hôm sau."
  tier="inference"
/>
...
<DiagramFigure
  ...
  labels={[
    { x: 12, y: 38, side: "right", label: "Tán dẻ rừng lịch sử", note: "Dẻ Mỹ chiếm tới 40% tán rừng lá rộng miền đông trước bệnh dịch" },
    { x: 24, y: 88, side: "right", label: "Mùa quả ổn định", note: "Nguồn hạt rụng dồi dào hằng năm nuôi mạng lưới thức ăn phức tạp" },
    { x: 74, y: 72, side: "left", label: "Tuyệt chủng chức năng", note: "Chồi rễ nhiễm bệnh liên tục chết trở lại, khiến loài biến mất về mặt chức năng" },
    { x: 80, y: 26, side: "left", label: "Rừng thay thế đơn giản hóa", note: "Các quần xã sồi-phong thứ sinh thấp hơn và chu kỳ hạt thất thường" }
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  labels={[
    { x: 22, y: 35, side: "left", label: "Đệm nhiệt của cây độc cần", note: "Tán lá kim thường xanh dày tạo tầng dưới tán tối, mát và ẩm" },
    { x: 68, y: 42, side: "left", label: "Vạt cây độc cần bị khoanh vỏ", note: "Cái chết mô phỏng do rệp mở tán, dội bức xạ mặt trời xuống nền rừng" },
    { x: 84, y: 42, side: "right", label: "Quần xã ven bìa rụng lá", note: "Thực vật ưa ấm xâm lấn thay thế thảm thực vật bản địa" },
    { x: 28, y: 88, side: "left", label: "Sinh cảnh suối nước lạnh", note: "Bóng râm của cây độc cần bảo vệ côn trùng thủy sinh ưa lạnh và cá hồi suối" }
  ]}
  figNo="08"
...
<DataComparison
  stats={[
    ...
    { label: "Cây độc cần đông", value: "Chu trình nitơ", note: "Các thí nghiệm khía vòng vỏ tại Rừng Harvard: ánh sáng nền rừng tăng nhiều bậc cường độ, đất ấm lên, nitrat rò rỉ vào suối, các loài chim ưa bóng râm biến mất, các quần thể cây chuyển vĩnh viễn thành bạch dương đen.", tone: "cyan" },
