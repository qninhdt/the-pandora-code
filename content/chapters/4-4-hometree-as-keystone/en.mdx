...
<Callout variant="caution" title="What we are doing when we fill that silence">
...
<Callout variant="caution" title="Where the reasoning is mine rather than canon's">
...
<Callout variant="caution" title="An honest uncertainty that changes the size of everything above">
