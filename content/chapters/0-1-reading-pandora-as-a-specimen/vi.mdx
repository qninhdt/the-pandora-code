<DiagramFigure
  ...
  labels={[
    { x: 28, y: 52, side: "left", label: "Mẫu vật được ghim", note: "Quan sát trực tiếp thực thể vật lý trước khi xây dựng các mô hình giải thích." },
    { x: 36, y: 22, side: "left", label: "Thấu kính phóng đại", note: "Xem xét kỹ lưỡng các chi tiết thực nghiệm trước khi kiến tạo khung lý thuyết." },
    { x: 75, y: 72, side: "right", label: "Sổ ghi chép thực địa", note: "Ghi lại các quan sát và xác định ranh giới của những điều chưa thể lý giải." }
  ]}
...
<EvidenceGradeLadder
  caption="Hãy tự tay thẩm định. Mở màn bằng thử nghiệm tiêu chuẩn vàng, rồi thêm vào ba sai sót mà một hội đồng phản biện thực sự sẽ tìm ra, và xem nó tụt xuống dưới cả cái nghiên cứu quan sát khiêm nhường mà bạn vừa nâng lên bằng hai điểm mạnh. Nấc khởi điểm là nguồn gốc; mọi thứ sau đó là sự nghiêm ngặt. Đây chính là cỗ máy, và bạn đang là người quay tay nó."
/>
...
<DiagramFigure
  ...
  labels={[
    { x: 10, y: 42, side: "right", label: "Canon khả kiến", note: "Điểm tựa vững chắc: các chi tiết thực nghiệm được mô tả trực tiếp trong tác phẩm gốc." },
    { x: 90, y: 42, side: "left", label: "Hiện thực bất khả kiến", note: "Bờ bên kia: những hệ quả vật lý logic mà thước phim không thể hiển thị trực tiếp." },
    { x: 50, y: 45, side: "right", label: "Suy luận có căn cứ", note: "Nhịp cầu khoa học chuẩn mực nối liền dữ liệu đã biết với các kết luận có thể kiểm chứng." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 52.5, y: 15, side: "left", label: "Novum giả định", note: "Tiền đề bất khả duy nhất được thừa nhận: sợi dây phát sáng neo giữ khối đất đá lơ lửng." },
    { x: 62, y: 65, side: "right", label: "Vật lý thông thường", note: "Dòng nước đổ tuân thủ trọn vẹn động lực học chất lưu Newton và lực hấp dẫn chuẩn tắc." },
    { x: 23, y: 71, side: "right", label: "Bay khí động học", note: "Cơ chế bay sinh học tuân theo các quy luật lực nâng, lực cản và mật độ khí quyển thông thường." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 47, side: "left", label: "Chuỗi carbon linh hoạt", note: "Các liên kết phân nhánh duy trì tính linh động trong dung môi lỏng, tạo nên sự đa dạng sinh hóa phong phú." },
    { x: 68, y: 38, side: "left", label: "Mạng tinh thể silicon cứng nhắc", note: "Các liên kết tứ diện lặp lại tự khóa chặt vào một khung khoáng vật có trật tự nhưng bất biến." },
    { x: 85, y: 50, side: "right", label: "Cái bẫy khoáng vật", note: "Ái lực cực cao của silicon với oxy nhanh chóng kết tủa thành các chất rắn dạng đá bền vững, không hòa tan." }
  ]}
  figNo="04"
...
<DiagramFigure
  ...
  labels={[
    { x: 20, y: 34, side: "left", label: "Novum giả định", note: "Chỉ có hòn đá lơ lửng là được miễn trừ khỏi điểm tựa trọng trường thông thường." },
    { x: 38, y: 54, side: "left", label: "Truyền động thủy lực", note: "Dòng nước rơi truyền động lượng và năng lượng theo cơ học chất lưu cổ điển." },
    { x: 54, y: 54, side: "right", label: "Khớp nối cơ khí", note: "Bánh răng, guồng nước và đòn bẩy vẫn chịu sự chi phối hoàn toàn của ma sát, lực đòn bẩy và lực tiếp xúc." },
    { x: 78, y: 52, side: "right", label: "Món nợ trọng trường", note: "Quả đối trọng rơi xuống tuân thủ định luật bảo toàn năng lượng và công cơ học chuẩn tắc." }
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  labels={[
    { x: 14, y: 45, side: "left", label: "Khay 1: Canon", note: "Bằng chứng phim ảnh trực tiếp: chỉ trích dẫn những gì được thể hiện tường minh trong các phân cảnh chính thống." },
    { x: 38, y: 48, side: "right", label: "Khay 2: Suy luận", note: "Bắc cầu qua những khoảng trống chưa lên phim bằng phép ngoại suy logic và nhất quán." },
    { x: 61, y: 37, side: "left", label: "Khay 3: Phỏng đoán", note: "Novum có kiểm soát: chấp nhận một tiền đề bất khả duy nhất được ràng buộc chặt chẽ bởi các điều kiện biên." },
    { x: 84, y: 48, side: "right", label: "Khay 4: Khoa học thực", note: "Hệ quy chiếu thực nghiệm: các thuộc tính định lượng được đối chiếu và kiểm nghiệm với vật lý và hóa học Trái Đất." }
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 15, y: 56, side: "left", label: "Nguồn tạp nhiễm", note: "Điếu thuốc đang cháy phát tán các hạt bụi khí và chất gây ô nhiễm hóa học ngay cạnh đĩa nuôi cấy mở." },
    { x: 53, y: 60, side: "left", label: "Mẫu vật phơi nhiễm", note: "Các hạt lắng đọng trực tiếp lên mô thực vật sống, tạo ra các sai số thực nghiệm ngoài tầm kiểm soát." },
    { x: 86, y: 60, side: "right", label: "Đối chứng được bảo vệ", note: "Đĩa đậy kín ngăn chặn sự lắng đọng của bụi hạt, cô lập chuẩn xác các biến số sinh học." }
  ]}
  figNo="07"
