<DiagramFigure
  ...
  labels={[
    { x: 16, y: 35, side: "right", label: "Nhân chứng thứ hai", note: "Tulkun lưu giữ lịch sử truyền khẩu lâu đời hơn cả loài Na'vi" },
    { x: 58, y: 49, side: "left", label: "Bốn mắt tinh tường", note: "Hệ thống thị giác đa hướng theo dõi cả mặt nước và đáy biển" },
...
<DiagramFigure
  ...
  labels={[
    { x: 19, y: 38, side: "right", label: "Thị tộc âm điệu (Coda clan)", note: "Mỗi cộng đồng tulkun sử dụng các chuỗi âm thanh đặc trưng" },
...
<DiagramFigure
  ...
  labels={[
    { x: 26, y: 66, side: "right", label: "Con đầu đàn giàu kinh nghiệm", note: "Tulkun già dẫn dắt đàn vượt qua các vùng biển nguy hiểm" },
...
Kinh nghiệm tích lũy tuyến tính theo tuổi, nên nó không dàn đều khắp bầy—nó dồn về đầu già. Lấy đi ba cá thể già nhất khỏi một bầy mà những con lớn tuổi nhất tiệm cận tuổi thọ tulkun theo nguyên tác, 150 đến 250 năm, thì số đầu con giảm chưa tới một phần ba nhưng hơn nửa tổng lượng trải nghiệm mà cả bầy từng sống qua ra đi cùng chúng. Điều đó có nghiêm trọng hay không còn tùy vào năm khốn khó hiếm đến mức nào. Nếu năm khốn khó xảy ra thường xuyên, con non trưởng thành cũng từng gặp, nên bầy có lớp đệm. Nếu nó thật hiếm, ký ức ấy gần như không tồn tại ở bất kỳ con nào khác. Cet-Ops nhắm vào những con lớn nhất và những con mẹ đang dẫn con — tức đúng cái đuôi xa nhất của phân bố đó, chứ không phải một mẫu đại diện.
...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 71, y: 75, side: "left", label: "Thẻ theo dõi vệ tinh", note: "Theo dõi quỹ đạo bơi và độ sâu lặn biển" }
  ]}
  figNo="04"
...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 84, y: 68, side: "left", label: "Cơ thể có thể tái tạo trước", note: "Số lượng cá thể có thể phục hồi nhưng văn hóa cần nhiều thế kỷ" }
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 27, y: 40, side: "left", label: "Giao diện liên kết Tsaheylu", note: "Liên kết thần kinh trực tiếp truyền tải tiểu sử thế hệ xuyên loài" },
