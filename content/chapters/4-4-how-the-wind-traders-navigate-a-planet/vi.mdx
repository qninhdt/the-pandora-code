...
<DiagramFigure
  ...
  labels={[
    { x: 28, y: 68, side: "left", label: "Người hoa tiêu", note: "Đọc từng tầng của cột không khí thẳng đứng thay vì nhìn đường chân trời." },
    { x: 32, y: 26, side: "right", label: "Bàn tay chỉ hướng", note: "Xác định đồng thời một cao độ và hướng bay đi kèm góc xoay Ekman." },
    { x: 72, y: 42, side: "left", label: "Các tầng mây xếp lớp", note: "Dấu hiệu thị giác trực quan của hiện tượng đứt gió đổi hướng theo độ cao." },
    { x: 78, y: 18, side: "left", label: "Những vệt gió xiết tầng cao", note: "Dòng sông chảy xiết về phía đông nằm sát đỉnh tầng đối lưu." },
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    { x: 80, y: 20, side: "left", label: "Tầng cao: Dòng xiết hướng đông", note: "Mây ti mỏng kéo sợi lao nhanh sang bên phải." },
    { x: 50, y: 48, side: "right", label: "Tầng giữa: Vùng lặng gió", note: "Khối không khí tù đọng hầu như không chuyển động." },
    { x: 24, y: 58, side: "left", label: "Đoàn caravan giữa khoảng lặng", note: "Lựa chọn cao độ để quyết định dòng sông khí quyển nào sẽ mang mình đi." },
    { x: 20, y: 82, side: "right", label: "Tầng thấp: Gió mậu dịch hướng tây", note: "Tầng ma sát sát mặt đất trôi dạt về bên trái." },
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 55, y: 32, side: "left", label: "Dải lụa dòng xiết uốn lượn", note: "Dòng sông khí quyển tầng cao với bờ bến phân định rõ ràng." },
    { x: 38, y: 72, side: "right", label: "Đoàn caravan đang leo cao", note: "Chạm tới dòng xiết giúp rút ngắn hành trình từ vài tháng xuống dưới 10 ngày." },
    { x: 72, y: 78, side: "left", label: "Đường chân trời hành tinh cong", note: "Vệt sáng mỏng của bầu khí quyển tiếp giáp với không gian." },
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  labels={[
    { x: 62, y: 22, side: "left", label: "Mây thấu kính xếp chồng", note: "Những đĩa mây hạnh nhân mượt mà đánh dấu đỉnh sóng dừng khuất gió." },
    { x: 48, y: 52, side: "right", label: "Caravan cưỡi lực nâng sóng núi", note: "Mượn công của ngọn núi để leo thẳng lên cao độ hành trình miễn phí." },
    { x: 22, y: 82, side: "right", label: "Rặng núi chắn gió", note: "Chướng ngại vật ép luồng khí ổn định dao động mạnh theo phương thẳng đứng." },
  ]}
  figNo="04"
...
<DiagramFigure
  ...
  labels={[
    { x: 58, y: 24, side: "left", label: "Đỉnh sóng thanh bình", note: "Mây thấu kính tầng tầng đánh dấu luồng khí bốc lên mượt mà bên trên." },
    { x: 45, y: 48, side: "right", label: "Caravan giữ cự ly an toàn", note: "Duy trì vị trí trong vùng khí trong lành phía trên đới đứt gãy của rotor." },
    { x: 55, y: 78, side: "left", label: "Trục xoáy rotor hỗn loạn", note: "Cuộn xoáy ngang nhào lộn dữ dội — mang tính hủy diệt đối với giàn dây chằng." },
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  labels={[
    { x: 48, y: 28, side: "left", label: "Vòm trời lặng gió phẳng lì", note: "Sóng hành tinh bị khóa đứng và gãy gập — luồng khí ngang và dọc đều chết lặng." },
    { x: 52, y: 58, side: "right", label: "Dây chằng buông thẳng đứng", note: "Gió bằng không so với mặt đất; toàn bộ cột khí không còn tầng gió nhanh." },
    { x: 26, y: 68, side: "left", label: "Thủy thủ đoàn nằm chờ", note: "Kiên nhẫn tiêu dần lương thực chờ khối nghẽn khí quyển tan rã." },
  ]}
  figNo="08"
...
<DiagramFigure
  ...
  labels={[
    { x: 28, y: 45, side: "left", label: "Bậc trưởng lão xướng ca", note: "Hồi tưởng các cặp độ cao–hướng bay được hiệu chỉnh qua nhiều thế hệ sinh mạng." },
    { x: 52, y: 48, side: "right", label: "Làn sương ký ức phát quang", note: "Bụi sáng phác họa các tầng gió — tri thức khoa học được lưu giữ không cần giấy mực." },
    { x: 74, y: 54, side: "right", label: "Các học việc tiếp thu hải trình", note: "Lưu truyền bộ mã điều hướng trong truyền thống truyền khẩu." },
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 58, y: 38, side: "right", label: "Polyphemus: Ngọn đèn cố định", note: "Treo bất động trên bầu trời — điểm tựa vĩnh cửu để định vị kinh độ và vĩ độ." },
    { x: 42, y: 44, side: "left", label: "Mặt trăng chuyển động: Chiếc đồng hồ", note: "Bộ máy cơ học thiên thể chuyển động nhịp nhàng trên đĩa hành tinh mẹ." },
    { x: 18, y: 86, side: "right", label: "Bóng caravan trên đường chân trời", note: "Định vị hành trình nhờ hệ tọa độ thiên văn vĩnh cửu." },
  ]}
  figNo="07"
...
<DiagramFigure
  ...
  labels={[
    { x: 32, y: 26, side: "left", label: "Bụng túi khí căng cứng", note: "Tăng lực nổi dâng cao ngay khi khối lượng dằn được giải phóng." },
    { x: 46, y: 52, side: "left", label: "Dõi theo dòng nước dằn", note: "Thực hiện một lần rút bớt không thể hoàn lại từ ngân sách vật dằn." },
    { x: 68, y: 74, side: "right", label: "Vòng cung nước rơi xuống vực", note: "Khối lượng vứt bỏ vĩnh viễn để mua một cú leo cao khẩn cấp." },
  ]}
  figNo="09"
