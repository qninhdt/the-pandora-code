...
<DiagramFigure
  ...
  labels={[
    { x: 28, y: 68, side: "left", label: "The navigator", note: "Reading the vertical column deck by deck, not the horizon." },
    { x: 32, y: 26, side: "right", label: "Raised palm heading", note: "Specifying both an altitude and the rotational heading that comes with it." },
    { x: 72, y: 42, side: "left", label: "Stacked cloud decks", note: "Visual confirmation of directional wind shear across heights." },
    { x: 78, y: 18, side: "left", label: "High fast streaks", note: "The high-speed eastward river near the top of the weather layer." },
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    { x: 80, y: 20, side: "left", label: "Top deck: Eastward jet", note: "Thin streaked cirrus streaming rapidly to the right." },
    { x: 50, y: 48, side: "right", label: "Middle deck: Slack wasteland", note: "Unstreaked stagnant air going almost nowhere." },
    { x: 24, y: 58, side: "left", label: "Caravan in gap", note: "Selecting altitude to change which atmospheric river carries it." },
    { x: 20, y: 82, side: "right", label: "Bottom deck: Westward trade", note: "Low friction layer streaming leftward." },
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 55, y: 32, side: "left", label: "Meandering jet ribbon", note: "A distinct high-altitude atmospheric river with clearly bounded banks." },
    { x: 38, y: 72, side: "right", label: "Climbing caravan", note: "Reaching the fast stream shortens transit from months to 10 days." },
    { x: 72, y: 78, side: "left", label: "Curved planetary horizon", note: "Thin atmospheric boundary along the edge of space." },
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  labels={[
    { x: 62, y: 22, side: "left", label: "Stacked lenticular caps", note: "Smooth almond clouds marking the crest of standing lee waves." },
    { x: 48, y: 52, side: "right", label: "Caravan on orographic lift", note: "Riding the mountain's upward work to reach cruising altitude for free." },
    { x: 22, y: 82, side: "right", label: "Dark windward ridge", note: "Obstacle forcing stable airflow into deep vertical oscillations." },
  ]}
  figNo="04"
...
<DiagramFigure
  ...
  labels={[
    { x: 58, y: 24, side: "left", label: "Serene wave crests", note: "Laminar lens caps marking smooth rising airflow above." },
    { x: 45, y: 48, side: "right", label: "Caravan holding high", note: "Positioned safely in clear air above the rotor's shear zone." },
    { x: 55, y: 78, side: "left", label: "Churning lee rotor", note: "Violently tumbling horizontal roll — structurally lethal to rigged aerostats." },
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  labels={[
    { x: 48, y: 28, side: "left", label: "Slack, featureless sky", note: "Planetary wave stalled and buckled — vertical and horizontal flows dead." },
    { x: 52, y: 58, side: "right", label: "Limp, vertical rigging", note: "Zero wind relative to ground; no fast layer anywhere in the column." },
    { x: 26, y: 68, side: "left", label: "Idle crew on stores", note: "Waiting out atmospheric blocking with no altitude escape option." },
  ]}
  figNo="08"
...
<DiagramFigure
  ...
  labels={[
    { x: 28, y: 45, side: "left", label: "The elder chanter", note: "Recalling altitude-heading sequences error-corrected across generations." },
    { x: 52, y: 48, side: "right", label: "Bioluminescent memory haze", note: "Motes tracing layered winds — structured knowledge carried without paper." },
    { x: 74, y: 54, side: "right", label: "Apprentices learning route", note: "Preserving the navigation code in human oral tradition." },
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 58, y: 38, side: "right", label: "Polyphemus: The fixed lamp", note: "Stationary in the sky — permanent fix for latitude and longitude." },
    { x: 42, y: 44, side: "left", label: "Transiting moon: The clock", note: "Orbital clockwork ticking against the banded face of the gas giant." },
    { x: 18, y: 86, side: "right", label: "Silhouetted caravan", note: "Navigating across a world with permanent celestial coordinates." },
  ]}
  figNo="07"
...
<DiagramFigure
  ...
  labels={[
    { x: 32, y: 26, side: "left", label: "Taut gasbag underside", note: "Gaining buoyant lift as mass is discarded." },
    { x: 46, y: 52, side: "left", label: "Watching the pour", note: "Crew executing an irreversible withdrawal from the flight ballast budget." },
    { x: 68, y: 74, side: "right", label: "Falling water arc", note: "Mass permanently lost into the abyss to buy an immediate climb." },
  ]}
  figNo="09"
