<DiagramFigure
  ...
  labels={[
    { x: 30, y: 64, side: "right", label: "Coordinated wildlife surge", note: "Terrestrial and aerial fauna break independent patterns to converge as a single immune response" },
    { x: 78, y: 47, side: "left", label: "Human RDA defense perimeter", note: "Industrial invaders targeted collectively by the planetary mind" },
    { x: 50, y: 82, side: "right", label: "Subterranean neural web", note: "Cyan filaments beneath the turf synchronizing global behavioral responses" },
    { x: 61, y: 14, side: "left", label: "Polyphemus overhead", note: "Parent gas giant, the magnetic backdrop against which Pandoran life evolved" }
  ]}
  figNo="01"
...
We have already taken that system apart, mechanism by mechanism. We found the wiring first (<ChapterRef slug="the-wood-wide-web" />) — that the forest is laced together not by root touching root but by an ancient fungal web threading between them, a real architecture with a real Earth analogue. We asked whether all that connection adds up to a mind (<ChapterRef slug="what-eywa-is" />), and found distributed cognition: intelligence with no central self, competence with nobody home. We measured what such a network could actually carry (<ChapterRef slug="the-bandwidth-of-a-planet" />), and ran the bandwidth against the hard limits that govern any channel. And we asked why burning a piece of it never seems to kill it (<ChapterRef slug="why-burning-eywa-doesnt-kill-it" />), and found the cold mathematics of redundancy and percolation — why a richly cross-linked network shrugs off damage that would sever a tidy one.

Four mechanisms, four chapters, each one a piece of Eywa held up to the light on its own. This chapter does the opposite. It steps back far enough to see all of them at once, because the question that has been waiting at the end of Part <PartRef id="the-living-network" numberOnly /> is not about any single mechanism. It is about the whole. When you assemble the wiring and the cognition and the bandwidth and the resilience into one planet-spanning system that recycles its own matter, defends its own balance, and stores its own dead — what kind of object have you got? A planet that merely *has* life on it, the way Earth has life smeared across its surface? Or a planet that, in some defensible and not merely poetic sense, *is* a single living thing?
...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 52, side: "right", label: "Terrestrial root web", note: "Hometree root matrix linking the land biomass into a continuous mesh" },
    { x: 75, y: 58, side: "left", label: "Marine Spirit Tree", note: "Subsea neural arbor anchored to the seabed, integrating oceanic life" },
    { x: 62, y: 29, side: "left", label: "Tulkun mobile carriers", note: "Sentient cetaceans transporting high-density memory across open waters" },
    { x: 50, y: 55, side: "right", label: "Closed biogeochemical loop", note: "Continuous energy and information circuit tying land and sea into one ledger" }
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 20, y: 40, side: "right", label: "Dead world (Mars analog)", note: "Atmosphere locked in chemical equilibrium: >95% inert CO2" },
    { x: 50, y: 40, side: "right", label: "Dead world (Venus analog)", note: "Dense equilibrium atmosphere devoid of biological disequilibrium" },
    { x: 80, y: 35, side: "left", label: "Atmospheric disequilibrium", note: "Reactive oxygen and methane coexisting impossibly in steady state" },
    { x: 80, y: 85, side: "left", label: "The biospheric pump", note: "Continuous global metabolic flux holding the atmospheric mixture out of chemical balance" }
  ]}
  figNo="03"
...
And here is the point that detonated the teleology objection: *nothing in Daisyworld is trying to regulate anything.* There is no planetary thermostat, no controller, no goal encoded anywhere. Each daisy is a selfish little organism growing where it finds the local temperature nice. The global regulation is a side effect — an <GlossaryTerm slug="emergence">emergent property</GlossaryTerm> of millions of selfish growth decisions coupled to the physics of albedo. Purpose was never needed. The regulation falls out of competition and feedback for free.
...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 19, side: "right", label: "Silicate weathering", note: "Atmospheric CO2 dissolves in rain, chemically weathering mountain silicate rock" },
    { x: 80, y: 52, side: "left", label: "Carbonate deposition", note: "Marine organisms lock dissolved carbon into carbonate shells and seafloor limestone" },
    { x: 50, y: 84, side: "right", label: "Plate subduction", note: "Tectonic conveyor carries carbonate slabs deep into mantle to be cooked" },
    { x: 21, y: 52, side: "right", label: "Volcanic outgassing", note: "Metamorphosed CO2 vented back into atmosphere, completing the planetary thermostat" }
  ]}
  figNo="04"
...
<DiagramFigure
  ...
  labels={[
    { x: 48, y: 82, side: "right", label: "Phytoplankton bloom", note: "Oceanic plankton produce dimethylsulfide (DMS) under thermal and solar stress" },
    { x: 48, y: 46, side: "right", label: "Aerosol nucleation", note: "Oxidized sulfur compounds drift upward to act as cloud condensation nuclei" },
    { x: 50, y: 24, side: "left", label: "Cloud albedo enhancement", note: "Dense reflective cloud decks bounce solar radiation directly back to space" },
    { x: 86, y: 55, side: "left", label: "Negative feedback closure", note: "Surface ocean cools, reducing thermal stress on plankton and stabilizing temperature" }
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 35, side: "right", label: "Negative feedback (the brake)", note: "High-albedo ice sheets reflect solar energy, buffering against minor warming" },
    { x: 65, y: 40, side: "left", label: "Positive feedback (the accelerator)", note: "Ice melts exposing dark open sea that absorbs incoming solar radiation" },
    { x: 82, y: 65, side: "left", label: "Permafrost runaway release", note: "Thawing tundra soil degasses methane bubbles, accelerating planetary heating" }
  ]}
...
Here is the whole of Part <PartRef id="the-living-network" numberOnly /> brought to a point. Earth is a planet that life has *transformed* into a self-regulating system — but the regulating is done blindly, by chemistry and competition, with nothing steering and no one home. The carbonate–silicate thermostat does not know it is a thermostat. The plankton do not know they brew clouds. The daisies do not know they hold a climate. Earth's homeostasis is real and it is profound, and it is also, every step of the way, the kind of mindless emergent regulation that Daisyworld proved you can get for free. Earth keeps itself habitable the way a river keeps to its bed — not by intending to, but because the alternative configurations didn't last.
...
<DiagramFigure
  ...
  labels={[
    { x: 24, y: 50, side: "right", label: "Earth (blind homeostasis)", note: "Five isolated, unlinked feedback loops operating without central coordination" },
    { x: 16, y: 31, side: "right", label: "Decoupled cycles", note: "Continental weathering, clouds, and ice regulate through accidental emergent equilibrium" },
    { x: 74, y: 50, side: "left", label: "Pandora (cybernetic Gaia)", note: "All five geochemical loops wired into one radiant central neural bus" },
    { x: 85, y: 34, side: "left", label: "Integrated planetary control", note: "Biosphere senses and actively directs climate homeostasis in real time" }
  ]}
  figNo="06"
