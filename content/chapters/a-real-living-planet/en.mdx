<DiagramFigure
  ...
  labels={[
    ...
    { x: 61, y: 14, side: "left", label: "Polyphemus tidal context", note: "Parent gas giant driving intense magnetospheric and tidal energy fluxes" }
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 87, y: 50, side: "left", label: "Successive biotic cast", note: "Pandoran megaflora inherit the exact same underlying geochemical fluxes" },
...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 74, y: 50, side: "left", label: "Pandora (cybernetic Gaia)", note: "All five geochemical loops wired into a radiant central sentient neural bus" },
    { x: 85, y: 34, side: "left", label: "Integrated planetary control", note: "Biosphere senses, anticipates, and actively directs climate homeostasis" }
  ]}
  figNo="06"
