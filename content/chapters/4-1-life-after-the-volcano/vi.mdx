...
<DiagramFigure
  ...
  figNo="01"
  labels={[
    { x: 33, y: 62, side: "right", label: "Tro, chứ không phải đất", note: "sạn xám thô — không mùn, không rễ, không một mẩu vụn" },
    { x: 55, y: 20, side: "left", label: "Một gã khổng lồ hóa than", note: "gỗ bị nung thành thứ nửa than nửa đá" },
    { x: 82, y: 66, side: "left", label: "Ngọn núi vẫn còn thở", note: "một lỗ phun khí đẩy hơi nóng qua lớp vỏ bên dưới" }
  ]}
...
<DiagramFigure
  ...
  figNo="02"
  labels={[
    { x: 22, y: 68, side: "right", label: "Đất đã sống sót", note: "ngân hàng hạt, rễ và nấm vẫn sống bên dưới lớp than" },
    { x: 26, y: 40, side: "right", label: "Đâm chồi từ một bản mẫu", note: "diễn thế thứ sinh — phục hồi trong vài thập kỷ" },
    { x: 76, y: 66, side: "left", label: "Bị nung thành đá vô trùng", note: "sự chôn vùi sâu xóa sổ chính mặt đất" },
    { x: 74, y: 34, side: "left", label: "Không còn gì để dựng lại", note: "diễn thế nguyên sinh — phục hồi trong hàng thế kỷ" }
  ]}
...
<DiagramFigure
  ...
  figNo="03"
  labels={[
    { x: 20, y: 46, side: "right", label: "Một gốc rễ, vẫn còn sống", note: "được che chở dưới sức nóng, sẵn sàng đâm chồi lại" },
    { x: 50, y: 58, side: "right", label: "Một hạt trong kho niêm phong", note: "vùi đủ sâu để sống sót qua sự chôn vùi" },
    { x: 78, y: 52, side: "left", label: "Một cái hang trụ vững", note: "một con vật ở dưới lòng đất khi bầu trời sụp xuống" },
    { x: 40, y: 20, side: "left", label: "Một hòn đảo phục hồi", note: "mỗi kẻ sống sót gieo mầm ra vùng đất vô trùng quanh nó" }
  ]}
...
<DiagramFigure
  ...
  figNo="04"
  labels={[
    { x: 30, y: 46, side: "right", label: "Một tiên phong trên đá bọt chết", note: "một cây lupin thảo nguyên ở nơi sách giáo khoa bảo chẳng có gì" },
    { x: 34, y: 74, side: "right", label: "Nitơ được tạo ra, không phải tìm thấy", note: "vi khuẩn ở rễ cố định nitơ mà đá trần thiếu vắng" },
    { x: 46, y: 82, side: "left", label: "Sạn do gió cuốn bị giữ lại", note: "một hòn đảo đất màu mỡ cho những kẻ tới sau" }
  ]}
...
<DiagramFigure
  ...
  figNo="05"
  labels={[
    { x: 34, y: 44, side: "right", label: "An toàn dưới đất khi luồng nổ quét qua", note: "một kẻ sống sót, không phải một kẻ chiếm cứ" },
    { x: 52, y: 72, side: "right", label: "Đất sẫm bị lôi lên xuyên qua tro", note: "lớp sống bị chôn vùi được trộn trở lại bề mặt" },
    { x: 74, y: 66, side: "left", label: "Bào tử nấm lan tỏa", note: "mang lên thứ cây cần để hút dưỡng chất từ đất nghèo" }
  ]}
...
<DiagramFigure
  ...
  figNo="06"
  labels={[
    { x: 40, y: 44, side: "right", label: "Một cây con không xuyên qua nổi", note: "rễ thất bại trong việc phá vỡ lớp vỏ niêm phong" },
    { x: 30, y: 66, side: "right", label: "Nước đọng giọt rồi trôi tuột", note: "tro kỵ nước gạt đi cơn mưa mà mầm nảy cần" },
    { x: 74, y: 74, side: "left", label: "Một rãnh xói mòn đã cắt sẵn", note: "xói mòn chực chờ cuốn phăng bất kỳ thứ gì trụ lại" }
  ]}
...
<DiagramFigure
  ...
  figNo="07"
  labels={[
    { x: 22, y: 46, side: "right", label: "Rễ hóa than đen", note: "mạng lưới cháy chết bên trong vùng bị chôn vùi" },
    { x: 74, y: 44, side: "left", label: "Một lưới sống bên phía nguyên vẹn", note: "trên Pandora, chính là bản thể của Eywa" },
    { x: 50, y: 74, side: "left", label: "Bị cắt lìa gọn ở ranh giới", note: "một mạng lưới không thể gieo lại từ một kẻ sống sót bị vùi" }
  ]}
...
<DiagramFigure
  ...
  figNo="08"
  labels={[
    { x: 30, y: 42, side: "right", label: "Trú ẩn trong một Cây Nhà đã chết", note: "những bộ rễ rỗng sụp đổ trở thành một ngôi làng" },
    { x: 44, y: 68, side: "right", label: "Xương, da và kim loại nhặt nhạnh", note: "dựng từ những gì đất chết và RDA để lại" },
    { x: 68, y: 20, side: "left", label: "Một con banshee cướp bóc được bọc giáp", note: "bạo lực hướng ra ngoài vì calo bên trong không mọc lên" },
    { x: 86, y: 66, side: "left", label: "Một đồng bằng chẳng cho gì", note: "lỗ phun khí và tro trải tới chân trời" }
  ]}
