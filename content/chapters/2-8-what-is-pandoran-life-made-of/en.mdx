...
<DiagramFigure
  ...
  labels={[
    { x: 26, y: 49, side: "right", label: "Stable phosphate rail", note: "The ordinary backbone remains intact in warm water long enough to preserve an archive." },
    { x: 75, y: 49, side: "left", label: "Arsenate cleavage", note: "The similar-looking rail hydrolyses into detached fragments in the same solvent." },
    { x: 80, y: 58, side: "left", label: "Archive erased by solvent", note: "A genome cannot store information if its own medium breaks the chain as it is written." },
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 24, y: 49, side: "right", label: "Known assay signal", note: "Familiar DNA-based microbes fluoresce because the detector was built to recognise them." },
    { x: 76, y: 54, side: "left", label: "Shadow community", note: "A chemically different population shares the droplet but returns no signal under the same test." },
    { x: 51, y: 33, side: "right", label: "Assumption boundary", note: "The illumination itself draws the blind spot: it reveals only the chemistry the lens already expects." },
  ]}
