...
<DiagramFigure
  ...
  labels={[
    { x: 26, y: 49, side: "right", label: "Thanh phosphate bền", note: "Xương sống thông thường còn nguyên trong nước ấm đủ lâu để giữ một kho lưu trữ." },
    { x: 75, y: 49, side: "left", label: "Cắt gãy arsenate", note: "Thanh trông tương tự bị thủy phân thành mảnh rời trong cùng dung môi." },
    { x: 80, y: 58, side: "left", label: "Dung môi xóa kho lưu trữ", note: "Bộ gene không thể lưu thông tin nếu chính môi trường của nó bẻ gãy chuỗi khi đang được viết." },
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 24, y: 49, side: "right", label: "Tín hiệu xét nghiệm quen thuộc", note: "Vi sinh vật DNA quen thuộc phát sáng vì máy dò được xây để nhận ra chúng." },
    { x: 76, y: 54, side: "left", label: "Cộng đồng bóng tối", note: "Quần thể hóa học khác sống chung trong giọt nước nhưng không trả tín hiệu dưới phép thử này." },
    { x: 51, y: 33, side: "right", label: "Biên giới giả định", note: "Chính luồng sáng vẽ ra điểm mù: nó chỉ hiện hóa học mà thấu kính đã chờ đợi." },
  ]}
