...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 22, side: "left", label: "Translucent dome", note: "The gas-filled bell displacing 65,000 cubic metres of air — lift without wingbeats." },
    { x: 72, y: 48, side: "right", label: "Circumferential muscle band", note: "Traveling contraction wave adjusting bell volume and trim." },
    { x: 38, y: 68, side: "left", label: "Woven catenary harness", note: "Broad bands distributing 70 tonnes of village load across the tissue." },
    { x: 62, y: 78, side: "right", label: "Gondolas and trailing tentacles", note: "Living quarters and sensory curtain trailing 30 metres into the slipstream." },
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 25, side: "left", label: "Internal gas compartments", note: "Multiple separated cells — a puncture causes trim loss, not catastrophic collapse." },
    { x: 48, y: 56, side: "right", label: "Liquid ballast reservoir", note: "Fluid stores adjusted to control net buoyancy and equilibrium altitude." },
    { x: 52, y: 84, side: "left", label: "Basal fermentation chamber", note: "Where dark fermentation converts prey sugar into hydrogen gas bubbles." },
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 22, y: 45, side: "left", label: "Point load failure", note: "Single-point attachment concentrates stress, tearing taut membrane." },
    { x: 75, y: 42, side: "right", label: "Catenary distribution", note: "Broad woven band spreads the same weight as gentle line-tension over metres." },
    { x: 78, y: 78, side: "right", label: "Suspended gondola load", note: "Tension directed along the curve without focal shear on the envelope." },
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  labels={[
    { x: 24, y: 38, side: "left", label: "Physalia: 30 cm float", note: "Earth siphonophore secreting gas and venting through pores on demand." },
    { x: 32, y: 70, side: "right", label: "Human scale reference", note: "Hand-sized organism exploiting density difference in water and air." },
    { x: 74, y: 32, side: "right", label: "Medusoid: 50 m dome", note: "Same crested gas-float architecture scaled up by two orders of magnitude." },
  ]}
  figNo="04"
...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 22, side: "right", label: "Gas compartment", note: "Filling with rising biohydrogen streams." },
    { x: 52, y: 52, side: "left", label: "Rising bubble channel", note: "Hydrogen ascends unhindered past the gut wall." },
    { x: 74, y: 56, side: "right", label: "Suppressed sink", note: "Methanogens and sulfate reducers absent — nobody eats the gas." },
    { x: 48, y: 82, side: "left", label: "Fermenting food mass", note: "Dark fermentation converting prey carbohydrates into hydrogen." },
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  labels={[
    { x: 52, y: 34, side: "left", label: "Medusoid dome rising", note: "Lighter overall mass immediately increases buoyant altitude." },
    { x: 55, y: 65, side: "right", label: "Muscular ballast vent", note: "Voiding fluid ballast — a one-way consumable withdrawal." },
    { x: 58, y: 82, side: "right", label: "Falling water column", note: "Mass permanently discarded to buy climb rate over the ridge." },
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 28, y: 36, side: "left", label: "Windray tugs in crosswind arc", note: "Flying dynamic arcs generates far higher airspeed and traction than static towing." },
    { x: 52, y: 52, side: "left", label: "Taut fibre towlines", note: "Transmitting heading force — zero aerostatic lift, only horizontal vectoring." },
    { x: 80, y: 48, side: "right", label: "Slowly yawing bell", note: "Encumbered by 46 tonnes of added mass, responding on a minutes-long timescale." },
  ]}
  figNo="07"
...
<DiagramFigure
  ...
  labels={[
    { x: 45, y: 22, side: "left", label: "Upward hydrogen flame", note: "Buoyant, low-emissivity flame climbs rapidly away from the habitat below." },
    { x: 38, y: 38, side: "left", label: "Incendiary strike point", note: "Mangkwan ember arrow puncturing the upper envelope membrane." },
    { x: 46, y: 82, side: "right", label: "Gondolas in clear air", note: "Unharmed by overhead flames — lethal threat is total loss of aerostatic lift." },
  ]}
  figNo="08"
...
<DiagramFigure
  ...
  labels={[
    { x: 24, y: 42, side: "right", label: "Leading caravan bell", note: "Drifting in a single moving wind layer with zero energy spent on lift." },
    { x: 45, y: 64, side: "left", label: "Gondola cooking fires", note: "Nomadic community living peacefully at walking pace across the sky." },
    { x: 72, y: 48, side: "right", label: "Trailing fleet line", note: "Paced by the drag equation's cube law — endurance bought with speed." },
  ]}
  figNo="09"
