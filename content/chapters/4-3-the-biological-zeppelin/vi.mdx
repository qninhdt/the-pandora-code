...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 22, side: "left", label: "Mái vòm bán trong suốt", note: "Vòm chuông chứa khí chiếm chỗ 65.000 mét khối không khí — lực nâng tĩnh khí không cần đập cánh." },
    { x: 72, y: 48, side: "right", label: "Dải cơ co thắt chu vi", note: "Sóng co bóp chạy vòng quanh giúp tinh chỉnh thể tích và cân bằng độ nghiêng." },
    { x: 38, y: 68, side: "left", label: "Đai treo dạng dây xích", note: "Dải đai bện sợi phân bổ 70 tấn tải trọng làng bản trải đều khắp vòm mô sống." },
    { x: 62, y: 78, side: "right", label: "Giỏ gondola và rèm xúc tu", note: "Khu vực sinh hoạt và xúc tu cảm giác rủ dài 30 mét vào khoảng không." },
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 25, side: "left", label: "Các khoang chứa khí bên trong", note: "Nhiều ngăn riêng biệt — vết thủng chỉ làm mất cân bằng cục bộ chứ không gây sụp đổ toàn phần." },
    { x: 48, y: 56, side: "right", label: "Bể chứa vật dằn lỏng", note: "Lượng chất lỏng dự trữ được xả bớt để kiểm soát lực nổi và độ cao cân bằng." },
    { x: 52, y: 84, side: "left", label: "Khoang lên men ở đáy", note: "Nơi quá trình lên men tối chuyển hóa thức ăn thành các bọt khí hydro nâng." },
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 22, y: 45, side: "left", label: "Điểm neo đơn lẻ rách vỡ", note: "Tải trọng tập trung làm tăng ứng suất cục bộ, xé toạc màng căng." },
    { x: 75, y: 42, side: "right", label: "Phân bổ lực dạng dây xích", note: "Dải đai rộng chuyển cùng trọng lượng đó thành lực căng êm ái trải dài nhiều mét." },
    { x: 78, y: 78, side: "right", label: "Tải trọng giỏ treo", note: "Lực kéo truyền theo đường cong tự nhiên mà không gây ứng suất cắt lên vách túi." },
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  labels={[
    { x: 24, y: 38, side: "left", label: "Physalia: Phao khí 30 cm", note: "Thủy tức Trái Đất tự tiết khí và xả khí qua lỗ chân lông theo nhu cầu." },
    { x: 32, y: 70, side: "right", label: "Thước đo tỷ lệ người", note: "Sinh vật cỡ bàn tay khai thác chênh lệch khối lượng riêng giữa nước và không khí." },
    { x: 74, y: 32, side: "right", label: "Medusoid: Vòm chuông 50 m", note: "Cùng giải pháp phao khí có mào nhưng phóng to quy mô thêm hai bậc độ lớn." },
  ]}
  figNo="04"
...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 22, side: "right", label: "Ngăn chứa khí nâng", note: "Được bơm đầy bởi dòng khí hydro sinh học bốc lên liên tục." },
    { x: 52, y: 52, side: "left", label: "Kênh dẫn bọt khí", note: "Hydro bay lên tự do qua thành ống tiêu hóa." },
    { x: 74, y: 56, side: "right", label: "Không có vi sinh vật tiêu thụ", note: "Vắng bóng vi khuẩn sinh methane và khử sulfate — không ai ngốn lượng khí này." },
    { x: 48, y: 82, side: "left", label: "Khối thức ăn lên men", note: "Quá trình lên men tối chuyển hóa carbohydrate của con mồi thành hydro." },
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  labels={[
    { x: 52, y: 34, side: "left", label: "Vòm Medusoid nâng cao", note: "Khối lượng tổng thể giảm ngay lập tức đưa khí cầu lên độ cao cân bằng mới." },
    { x: 55, y: 65, side: "right", label: "Van xả vật dằn cơ bắp", note: "Tống chất lỏng dằn ra ngoài — rút bớt từ tài khoản tiêu hao một chiều." },
    { x: 58, y: 82, side: "right", label: "Cột nước rơi tự do", note: "Khối lượng vứt bỏ vĩnh viễn để mua tốc độ vượt qua rặng núi." },
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 28, y: 36, side: "left", label: "Đội thú Windray bay cắt gió", note: "Bay theo vòng cung động lực học tạo tốc độ gió biểu kiến và lực kéo lớn gấp nhiều lần kéo thẳng." },
    { x: 52, y: 52, side: "left", label: "Dây kéo sợi bện căng thẳng", note: "Truyền lực bẻ hướng — không gánh lực nâng, chỉ cung cấp vector kéo ngang." },
    { x: 80, y: 48, side: "right", label: "Vòm chuông từ từ xoay mũi", note: "Gánh 46 tấn không khí cuốn theo (khối lượng gia tăng), đáp lại lệnh lái sau nhiều phút." },
  ]}
  figNo="07"
...
<DiagramFigure
  ...
  labels={[
    { x: 45, y: 22, side: "left", label: "Ngọn lửa hydro bốc thẳng lên", note: "Ngọn lửa nhẹ và bức xạ yếu bốc vút lên trời ra xa khỏi khu dân cư bên dưới." },
    { x: 38, y: 38, side: "left", label: "Điểm trúng tên lửa", note: "Mũi tên than hồng của tộc Mangkwan đâm thủng màng túi khí phía trên." },
    { x: 46, y: 82, side: "right", label: "Giỏ gondola trong vùng an toàn", note: "Không bị lửa thiêu — hiểm họa chết người duy nhất là mất sạch lực nâng." },
  ]}
  figNo="08"
...
<DiagramFigure
  ...
  labels={[
    { x: 24, y: 42, side: "right", label: "Khí cầu dẫn đầu caravan", note: "Trôi nổi trong một tầng gió chuyển động mà không tốn năng lượng để giữ độ cao." },
    { x: 45, y: 64, side: "left", label: "Bếp lửa trên giỏ gondola", note: "Cộng đồng du mục sinh hoạt bình yên ở tốc độ đi bộ trên bầu trời." },
    { x: 72, y: 48, side: "right", label: "Đội hình đoàn tàu nối đuôi", note: "Tốc độ bị ghìm lại bởi luật lũy thừa bậc ba của lực cản — đổi tốc độ lấy sự bền bỉ." },
  ]}
  figNo="09"
