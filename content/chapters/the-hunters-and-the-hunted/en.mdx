...
<DiagramFigure
  src="/images/chapters/the-hunters-and-the-hunted/fig-02-the-coupled-cycle.webp"
  alt="Two coupled luminous population waves over time: an upper cyan herbivore wave and a trailing magenta predator wave shifted to the right, showing the classic phase lag of Lotka-Volterra dynamics"
  figNo="02"
  labels={[
    { x: 30, y: 32, side: "left", label: "Prey abundance peak (Yerik)", note: "Herbivore population surges when predation pressure is low" },
    { x: 48, y: 58, side: "right", label: "Lagging predator peak (Nantang)", note: "Predator numbers climb with a generational delay, cresting after prey decline begins" },
    { x: 70, y: 75, side: "left", label: "Coupled phase offset", note: "The quarter-cycle lag keeps the population wheel turning indefinitely without collapsing" }
  ]}
  caption="The coupled pulse. The prey population wave (cyan) crests first; the predator wave (magenta) peaks a quarter-step later. Because predators require time to breed and recruit new hunters, their boom lags behind the food supply — creating an eternal oscillation rather than a static equilibrium."
  tier="real_science"
/>
...
<DiagramFigure
  src="/images/chapters/the-hunters-and-the-hunted/fig-04-functional-response.webp"
  alt="Three distinct glowing curves illustrating Holling's functional response types against a dark field: Type I linear plateau, Type II convex handling saturation, and Type III sigmoidal prey-switching S-curve"
  figNo="04"
  labels={[
    { x: 72, y: 25, side: "left", label: "Type I: Filter feeder cap", note: "Direct intake proportionality up to mechanical saturation (e.g. Tulkun plankton grazing)" },
    { x: 42, y: 38, side: "right", label: "Type II: Handling time limit", note: "Search time shrinks but digestion/handling taxes plateau consumption (e.g. Thanator)" },
    { x: 32, y: 78, side: "right", label: "Type III: Prey-switching refuge", note: "Low consumption at scarce densities gives depleted prey time to recover (e.g. Viperwolf)" }
  ]}
  caption="Three shapes of a hunter's appetite. As prey density grows, predation rates cannot rise forever. Type I hits a hard ceiling; Type II bends under the weight of handling time; Type III stays flat at low density before rising, providing a behavioural refuge that shields rare prey from extinction."
  tier="real_science"
/>
...
<DiagramFigure
  src="/images/chapters/the-hunters-and-the-hunted/fig-06-keystone-pull.webp"
  alt="A two-panel comparative painting: on the left, an apex predator maintains a lush, diverse multi-tiered forest; on the right, the predator is removed, causing massive herbivores to overgraze and strip the understory to bare mud"
  figNo="06"
  labels={[
    { x: 28, y: 25, side: "left", label: "Apex predator present", note: "Top-down control regulates giant browser densities and maintains canopy diversity" },
    { x: 22, y: 72, side: "left", label: "Lush intact understory", note: "Diverse flora and small fauna thrive in balanced structural niches" },
    { x: 74, y: 35, side: "right", label: "Predator-free overpopulation", note: "Unchecked mega-herbivores multiply rapidly without top-down mortality" },
    { x: 78, y: 75, side: "right", label: "Trophic collapse & denudation", note: "Overbrowsing strips vegetation, eroding soil and eliminating small browsers" }
  ]}
  caption="Pulling the archway's keystone. Left: with the top predator present, mega-herbivores are kept in check and the multi-layered understory flourishes. Right: remove the apex hunter and the released giants multiply, stripping the forest bare and driving smaller creatures to extinction through runaway habitat destruction."
  tier="inference"
/>
