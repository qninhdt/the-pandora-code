<DiagramFigure
  ...
  labels={[
    { x: 30, y: 22, side: "left", label: "Massive primary wing", note: "Span past 20 m — expansive aerodynamic membrane generating massive lift in dense atmosphere." },
    { x: 26, y: 68, side: "left", label: "Cliff launch ledge", note: "Vaulting off a precipice converts gravitational drop into initial airspeed without a ground run." },
    { x: 74, y: 82, side: "left", label: "Banshee rider for scale", note: "A distant ikran rider highlights the titanic scale of the apex predator." }
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    { x: 17, y: 50, side: "left", label: "Sparrow: instant takeoff", note: "Extremely low wing loading lets small birds depart almost vertically from a perch." },
    { x: 42, y: 61, side: "left", label: "Swan: waterborne run", note: "Heavier birds must sprint across water to build necessary takeoff speed." },
    { x: 78, y: 48, side: "right", label: "Pterosaur: slope launch", note: "Giant mass demands a launch slope, headwind, or forelimb vault to take wing." }
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  labels={[
    { x: 28, y: 62, side: "left", label: "Lightweight wing spar", note: "Hollow structural bone gives reach and surface area without excessive mass." },
    { x: 66, y: 52, side: "right", label: "Concentrated body mass", note: "Center of mass is tightly clustered near the shoulders and pelvis." },
    { x: 89, y: 79, side: "right", label: "Human scale comparison", note: "Giraffe-scale standing height demonstrates Earth's biomechanical flight limit." }
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 44, y: 32, side: "left", label: "Bird hindlimb leap", note: "Birds launch with hind legs, carrying those heavy muscles as dead weight throughout flight." },
    { x: 43, y: 76, side: "left", label: "Pterosaur forelimb vault", note: "Pterosaurs vault directly off their wing-arms, unifying the launch engine and flight engine." },
    { x: 82, y: 68, side: "right", label: "Integrated flight engine", note: "Pandora's giant fliers follow this forelimb-launch strategy to surpass Earth's size limits." }
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 48, side: "left", label: "Spread slotted wing", note: "Separated outer elements delay boundary layer stall during low-speed soaring." },
    { x: 75, y: 48, side: "right", label: "Swept sealed blade", note: "Tightly folded wing reduces parasitic drag for high-speed diving and pursuit." },
    { x: 50, y: 50, side: "right", label: "Dual flight regimes", note: "Dynamic planform morphing adapts the same aerodynamic structure to multiple speeds." }
  ]}
  figNo="07"
...
<DiagramFigure
  ...
  labels={[
    { x: 53, y: 28, side: "right", label: "Leading-edge vortex", note: "A stable low-pressure vortex core stays attached during stroke, dramatically increasing lift." },
    { x: 68, y: 62, side: "right", label: "Downward wake sheet", note: "Flapping cycle accelerates air downward, generating reaction lift." },
    { x: 30, y: 52, side: "left", label: "Wing base hinge", note: "Rapid wing articulation drives the unsteady aerodynamic vortex mechanism." }
  ]}
  figNo="08"
...
<DiagramFigure
  ...
  labels={[
    { x: 8, y: 38, side: "right", label: "High takeoff barrier (Earth)", note: "Thin air and 1.0g gravity demand high airspeed before wings can bite and lift." },
    { x: 61, y: 53, side: "right", label: "Lower takeoff barrier (Pandora)", note: "Lower gravity (0.8g) and dense atmosphere (1.2 atm) slash the velocity needed to fly." },
    { x: 65, y: 80, side: "left", label: "Atmospheric density gauge", note: "Higher fluid density increases dynamic pressure, multiplying lift generated per wing stroke." }
  ]}
  figNo="04"
...
<DiagramFigure
  ...
  labels={[
    { x: 66, y: 26, side: "right", label: "Soaring toruk", note: "Broad wingspan captures rising air currents, converting updrafts into altitude without flapping." },
    { x: 39, y: 42, side: "left", label: "Orographic updraft", note: "Deflected air currents along vertical cliff faces provide continuous vertical thrust." },
    { x: 74, y: 80, side: "right", label: "Flapping banshee", note: "Smaller fliers below expend active metabolic energy navigating lower turbulence." }
  ]}
  figNo="09"
