...
<DiagramFigure
  src="/images/chapters/the-night-ecology/fig-05-the-closed-cupboard.png"
  ...
  labels={[
    { x: 24, y: 47, side: "left", label: "Trạng thái mở", note: "Cây bắt đầu với các lá xòe ra" },
    { x: 50, y: 47, side: "right", label: "Trạng thái khép", note: "Vài giờ sau lá khép dù ngăn tủ vẫn tối như cũ" },
    { x: 76, y: 47, side: "right", label: "Mở trở lại", note: "Chu kỳ quay về mà không cần bình minh làm tác nhân" }
  ]}
  figNo="05"
...
<DiagramFigure
  src="/images/chapters/the-night-ecology/fig-06-clockwork-in-a-cell.png"
  ...
  labels={[
    { x: 25, y: 28, side: "left", label: "Gene bật", note: "Gene đồng hồ bắt đầu tạo protein" },
    { x: 75, y: 28, side: "right", label: "Protein tích tụ", note: "Sản phẩm có độ trễ tăng dần trong tế bào" },
    { x: 75, y: 75, side: "right", label: "Phản hồi khóa gene", note: "Protein tích tụ quay lại ức chế quá trình sản xuất" },
    { x: 25, y: 75, side: "left", label: "Protein được dọn sạch", note: "Phân hủy giải phóng gene và khởi động lại vòng lặp" }
  ]}
  figNo="06"
...
<DiagramFigure
  src="/images/chapters/the-night-ecology/fig-07-light-at-two-phases.png"
  ...
  labels={[
    { x: 18, y: 28, side: "left", label: "Đầu đêm sinh học", note: "Cùng xung sáng xanh làm đồng hồ nội tại trễ đi" },
    { x: 50, y: 28, side: "right", label: "Ban ngày sinh học", note: "Xung sáng ở đây hầu như không đổi pha" },
    { x: 82, y: 28, side: "right", label: "Cuối đêm sinh học", note: "Xung sáng lại kéo đồng hồ nội tại sớm lên" }
  ]}
  figNo="07"
...
<DiagramFigure
  src="/images/chapters/the-night-ecology/fig-08-the-retinas-second-wire.png"
  ...
  labels={[
    { x: 16, y: 44, side: "left", label: "Võng mạc tạo hình ảnh", note: "Tế bào que và nón gửi thông tin thị giác chi tiết về phía sau" },
    { x: 61, y: 47, side: "right", label: "Đường melanopsin", note: "Tế bào thưa chỉ báo cáo ánh sáng thiên xanh, không dựng hình" },
    { x: 58, y: 76, side: "right", label: "Đồng hồ chủ", note: "Cặp đồng hồ nhỏ trên giao thoa thị giác đặt nhịp ngày đêm" }
  ]}
  figNo="08"
...
<DiagramFigure
  src="/images/chapters/the-night-ecology/fig-09-the-nocturnal-inheritance.png"
  ...
  labels={[
    { x: 18, y: 52, side: "left", label: "Thú có vú cổ sống đêm", note: "Tai lớn, ria và khứu giác thay cho bộ giác quan ưu tiên ban ngày" },
    { x: 50, y: 52, side: "right", label: "Thằn lằn hoạt động ngày", note: "Mẫu so sánh ở giữa giữ lại mạng thụ thể màu phong phú hơn" },
    { x: 82, y: 52, side: "right", label: "Thú có vú hiện đại", note: "Di sản sống đêm vẫn hiện rõ trên gương mặt" },
    { x: 50, y: 87, side: "right", label: "So sánh thụ thể", note: "Các ô của thú có vú thiên xanh còn thằn lằn giữ nhiều màu hơn" }
  ]}
  figNo="09"
...
<DiagramFigure
  src="/images/chapters/the-night-ecology/fig-10-living-on-mars-time.png"
  ...
  labels={[
    { x: 12, y: 39, side: "left", label: "Đèn giàu quang phổ xanh", note: "Ánh sáng đúng giờ được dùng như điều trị để đặt lại đồng hồ" },
    { x: 29, y: 50, side: "left", label: "Nhân viên thiếu ngủ", note: "Ngày làm việc dài bào mòn sự tỉnh táo khi lịch bị trôi" },
    { x: 80, y: 25, side: "right", label: "Ánh ngày Trái Đất", note: "Thế giới bên ngoài vẫn chạy theo chiếc đồng hồ địa cầu thông thường" },
    { x: 79, y: 82, side: "right", label: "Phác đồ melatonin", note: "Liều dùng đúng giờ giúp giữ lịch Sao Hỏa được quản lý" }
  ]}
  figNo="10"
