<DiagramFigure
  ...
  labels={[
    { x: 58, y: 22, side: "left", label: "Polyphemus", note: "the gas giant's banded face fills a third of the sky" },
    { x: 70, y: 40, side: "right", label: "The sun, eclipsed", note: "the small bright star slides behind the giant's limb" },
    { x: 20, y: 80, side: "left", label: "Twilight at noon", note: "the forest dims most of the way through every day" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 10, y: 38, side: "right", label: "Alpha Centauri A", note: "the bright yellow sun Pandora's giant orbits" },
    { x: 42, y: 52, side: "left", label: "Polyphemus", note: "a gas giant about one Earth-distance from the star" },
    { x: 60, y: 57, side: "right", label: "Pandora", note: "the moon, hugging close against the giant" },
    { x: 88, y: 33, side: "left", label: "B and Proxima", note: "the system's other two suns, far off in the dark" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 47, y: 44, side: "left", label: "Scorched, close in", note: "too near the star, oceans boil away" },
    { x: 73, y: 58, side: "right", label: "The temperate band", note: "where Polyphemus orbits — water can stay liquid" },
    { x: 14, y: 20, side: "right", label: "Frozen, far out", note: "beyond the band, space is too cold" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 14, y: 18, side: "right", label: "Direct starlight", note: "white light from the system's sun" },
    { x: 85, y: 28, side: "left", label: "Reflected & infrared heat", note: "the giant's glow and its own escaping warmth" },
    { x: 55, y: 58, side: "right", label: "Tidal heating", note: "frictional warmth cracking up from within" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 45, y: 28, side: "left", label: "Polyphemus", note: "its magnetosphere traps the killing particles" },
    { x: 20, y: 74, side: "right", label: "Radiation belts", note: "trapped particles that strip a small moon's air" },
    { x: 79, y: 45, side: "right", label: "Pandora, in the gap", note: "sheltered in the calm between the belts" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 13, y: 72, side: "right", label: "Alpha Centauri A", note: "a brilliant point low in the southern sky, four light-years off" },
    { x: 80, y: 48, side: "left", label: "Our instruments", note: "we already point our best telescopes here" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 84, y: 17, side: "left", label: "Alpha Centauri B", note: "A single point of light, not a second sun disc, bright enough to cast directional orange shadows." },
    { x: 38, y: 29, side: "right", label: "Polyphemus in shadow", note: "The fixed gas giant fills the sky while its near face remains mostly unlit." },
    { x: 47, y: 81, side: "right", label: "The missing orange shadows", note: "A bright companion star should leave sharp warm edges across the otherwise cyan forest floor." },
  ]}
  figNo="07"
