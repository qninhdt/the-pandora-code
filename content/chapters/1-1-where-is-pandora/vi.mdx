<DiagramFigure
  ...
  labels={[
    { x: 58, y: 22, side: "left", label: "Polyphemus", note: "Đĩa vân sọc khổng lồ của hành tinh khí sừng sững trên nền trời, thống trị toàn bộ tầm nhìn của mặt trăng." },
    { x: 65, y: 37, side: "right", label: "Thiên thực mặt trời", note: "Alpha Centauri A trượt dần ra phía sau vành hành tinh khí khổng lồ, khởi đầu hiện tượng nhật thực giữa ban trưa." },
    { x: 26, y: 62, side: "left", label: "Hoàng hôn giữa ban ngày", note: "Khi ánh mặt trời trực tiếp tắt lịm, tầng tán rừng chìm vào màn hoàng hôn phát quang sinh học định kỳ mỗi ngày." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 10, y: 40, side: "right", label: "Alpha Centauri A", note: "Ngôi sao lùn vàng chính (G2V) mà Polyphemus quay quanh ở khoảng cách xấp xỉ 1,05 AU." },
    { x: 48, y: 52, side: "left", label: "Polyphemus", note: "Hành tinh khí khổng lồ kiểu Sao Thổ nằm trọn vẹn trong vùng có thể sống được (vùng Goldilocks) của hệ sao." },
    { x: 60, y: 60, side: "right", label: "Pandora", note: "Mặt trăng có kích thước tương đương Trái Đất quay sát hành tinh khí trong trạng thái khóa thủy triều đồng bộ." },
    { x: 87, y: 35, side: "left", label: "Centauri B & Proxima", note: "Ngôi sao đồng hành lùn cam (B) và ngôi sao lóa đỏ xa xôi (Proxima)." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 42, y: 38, side: "left", label: "Vùng thiêu đốt bên trong", note: "Bức xạ sao quá mức kích hoạt hiệu ứng nhà kính mất kiểm soát, khiến nước lỏng không thể tồn tại ổn định trên bề mặt." },
    { x: 71, y: 56, side: "right", label: "Vùng có thể sống được", note: "Vành đai Goldilocks quanh sao, nơi Polyphemus và Pandora duy trì điều kiện nhiệt độ cho nước lỏng." },
    { x: 15, y: 22, side: "right", label: "Vùng băng giá bên ngoài", note: "Nằm ngoài đường tuyết, các hợp chất dễ bay hơi đóng băng và lượng bức xạ nhận được không đủ sưởi ấm." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 10, y: 14, side: "right", label: "Ánh sáng sao trực tiếp", note: "Bức xạ sơ cấp từ Alpha Centauri A cung cấp thông lượng bức xạ trực tiếp xuống đỉnh bầu khí quyển." },
    { x: 82, y: 25, side: "left", label: "Bức xạ hành tinh", note: "Polyphemus vừa phản xạ ánh sáng khả kiến của mặt trời vừa tự phát ra bức xạ nhiệt hồng ngoại nội tại mạnh mẽ." },
    { x: 55, y: 55, side: "right", label: "Tiêu tán nhiệt thủy triều", note: "Biến dạng do lực hấp dẫn tạo ra ma sát khổng lồ trong lòng mặt trăng, làm nứt toác lớp vỏ thành các khe nứt dung nham." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 47, y: 30, side: "left", label: "Từ quyển Polyphemus", note: "Từ trường khổng lồ của hành tinh khí bẫy giữ các hạt mang điện năng lượng cao cực kỳ nguy hiểm." },
    { x: 22, y: 72, side: "left", label: "Vành đai bức xạ bị giam cầm", note: "Các xuyến plasma kiểu Van Allen đậm đặc có khả năng bóc trần bầu khí quyển của những thiên thể không được bảo vệ." },
    { x: 75.5, y: 48, side: "right", label: "Pandora trong khe hở quỹ đạo", note: "Quay an toàn trong khoảng lặng từ tính êm đềm giữa các vành đai bức xạ mật độ cao." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 13.5, y: 75, side: "right", label: "Alpha Centauri A", note: "Ngọn hải đăng rực sáng trên bầu trời phương Nam của Trái Đất, cách chúng ta 4,37 năm ánh sáng." },
    { x: 70, y: 54, side: "left", label: "Đài thiên văn mặt đất", note: "Kính vành nhật độ tương phản cao và máy quang phổ vận tốc xuyên tâm rà soát kỹ lưỡng trong luồng lóa sáng của ngôi sao." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 89, y: 15, side: "left", label: "Alpha Centauri B", note: "Ngôi sao đồng hành lùn K tỏa sáng như một điểm sao cường độ mạnh, rọi chiếu ánh sáng màu cam sắc nét." },
    { x: 35, y: 30, side: "left", label: "Polyphemus trong bóng tối", note: "Hành tinh khí chiếm trọn bầu trời, với các dải mây tối chỉ được chiếu sáng mờ nhạt bởi ánh phản chiếu từ Pandora và sao B." },
    { x: 52, y: 88, side: "right", label: "Bóng đổ cam có hướng", note: "Những vệt bóng màu hổ phách cắt ngang ánh phát quang xanh lam, khiến màn đêm thực sự không thể xuất hiện trong suốt nhiều thập kỷ." }
  ]}
  figNo="07"
