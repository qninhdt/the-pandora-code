<DiagramFigure
  ...
  labels={[
    { x: 75, y: 48, side: "right", label: "Four glowing predatory eyes", note: "Dual-tier optical sensors provide stereoscopic depth and night-vision targeting." },
    { x: 48, y: 65, side: "left", label: "Six-limbed muscular chassis", note: "Quadrupedal forelimb strike paired with rear sprint legs preserves the Pandoran lattice." },
    { x: 76, y: 72, side: "right", label: "Apex ambush kill", note: "Convergent feline hunting mechanics: crushing bite and forelimb pinning of prey." },
    { x: 55, y: 44, side: "left", label: "Flank breathing spiracles", note: "Direct aerating slits bypass oral respiration, sustaining oxygen flow during sprint attacks." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 30, y: 38, side: "left", label: "Earth panther (Tetrapod)", note: "Mammalian apex predator: 4 limbs, 2 stereoscopic eyes, oral respiration." },
    { x: 86, y: 36, side: "right", label: "Pandoran thanator (Hexapod)", note: "Xenobiological apex predator: 6 limbs, 4 eyes, armored sensory crest, flank spiracles." },
    { x: 74, y: 55, side: "right", label: "Convergent pouncing dynamics", note: "Identical aerodynamic crouch and forward strike demanded by biomechanical laws of predation." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 88, y: 50, side: "right", label: "Body size axis (Mass)", note: "Horizontal gradient running from microfauna up to multi-ton megaherbivores." },
    { x: 50, y: 10, side: "right", label: "Trophic axis (Carnivore)", note: "Vertical gradient from primary autotrophic grazers up to hyper-carnivores." },
    { x: 65, y: 32, side: "left", label: "Convergent apex predator niche", note: "Earth panther and Pandoran thanator independently occupy the large-carnivore coordinate." },
    { x: 85, y: 45, side: "left", label: "Megaherbivore niche", note: "Earth elephant and Pandoran titanothere fill identical high-biomass browsing roles." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 14, y: 18, side: "right", label: "Twig specialist ecomorph", note: "Slender bodies and short limbs evolved repeatedly for navigating narrow perches." },
    { x: 84, y: 63, side: "left", label: "Trunk-ground ecomorph", note: "Long hind legs for sprinting down tree trunks and capturing prey on the ground." },
    { x: 50, y: 44, side: "left", label: "Independent island radiations", note: "Each Greater Antillean island generated the same suite of ecomorphs from distinct kin." },
    { x: 38, y: 46, side: "right", label: "Trunk-crown specialist", note: "Large toepads and green camouflage adapted for life in the high leafy canopy." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 85, y: 20, side: "right", label: "Shark (Fish): lateral tail", note: "Ancestral fish lateral undulation drives a vertical caudal fin side-to-side." },
    { x: 86, y: 52, side: "right", label: "Ichthyosaur (Reptile): lateral sweep", note: "Reptilian ancestry preserves lateral spinal flexion with a vertical tail fin." },
    { x: 85, y: 84, side: "right", label: "Dolphin (Mammal): vertical fluke", note: "Mammalian terrestrial ancestry (dorsoventral running spine) produces an up-and-down fluke." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 60, y: 8, side: "left", label: "Canopy reacher", note: "Long neck and towering stature access high crown leaves inaccessible to others." },
    { x: 62, y: 48, side: "left", label: "Sub-canopy browser", note: "Intermediate herbivores exploit mid-tier foliage and woody shrubs." },
    { x: 42, y: 88, side: "left", label: "Forest-floor grazer", note: "Low-slung herbivores specialize in ground ferns, fallen fruit, and root shoots." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 42, y: 56, side: "left", label: "Bifurcated forelimbs", note: "Single upper arm dividing into paired hands — intermediate step from six limbs to four." },
    { x: 55, y: 12, side: "right", label: "Single occipital queue", note: "Consolidation of the ancestral dual neural braids into a single cranial queue." },
    { x: 84, y: 38, side: "right", label: "Na'vi bipedal silhouette", note: "Background figure highlights evolutionary trajectory toward four-limbed arboreal bipedalism." },
    { x: 18, y: 36, side: "left", label: "Ancestral hexapod form", note: "Background creature displays standard unreduced six-limbed quadrupedal build." }
  ]}
