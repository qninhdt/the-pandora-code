<DiagramFigure
  ...
  labels={[
    ...
    { x: 50, y: 68, side: "left", label: "Electrochemical Synaptic Web", note: "Dense root-to-root grid carrying the electrochemical signalling Grace compares to synapses." },
    { x: 88, y: 60, side: "left", label: "Inter-Tree Link (substrate unnamed)", note: "Physical continuity between separate root systems; canon says roots and never says what bridges them." }
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    { x: 22, y: 28, side: "right", label: "Sunlit Canopy Tree (Source)", note: "Mature emergent canopy captures abundant solar photons, generating substantial surplus photosynthate." },
    ...
    { x: 72, y: 40, side: "left", label: "Shaded Understory Sapling (Sink)", note: "Light-starved young tree receives net carbon along a source-to-sink gradient — the transfer Simard measured." }
  ]}
  figNo="04"
...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 71, y: 74, side: "right", label: "Glacial Fungal Spike Train (~0.7 cm/min)", note: "Hyphal electrical spikes propagate at centimeters per minute — too slow for real-time planet-wide tactical thought." },
  ...
  figNo="06"
  caption="The line that physics breaks. A synapse fires in thousandths of a second; a signal in a real fungal network creeps at roughly seven millimetres a minute. The wiring is genuinely electrochemical, just as canon says — but it is glacially slow. A network can hold more connections than a brain and still be utterly unable to think like one, because thought is not about how many wires you have. It is about how fast a signal can cross them."
  tier="real_science"
/>
...
<DataComparison
  stats={[
    ...
    { label: "Fungal electrical spike", value: "~0.7 cm/min", note: "Orders of magnitude slower than a neuron", tone: "teal" },
