...
<DiagramFigure
  ...
  labels={[
    { x: 22, y: 58, side: "right", label: "Roots fall short", note: "Each tree's expensive roots remain local" },
    { x: 50, y: 28, side: "left", label: "The barrier", note: "A stream is enough to break root-to-root contact" },
    { x: 62, y: 76, side: "left", label: "The fungal bridge", note: "Fine hyphae cross the distance the roots cannot" },
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 10, y: 42, side: "right", label: "Measured source", note: "Two seedlings and one shared strand are the narrow observation at the start of the chain." },
    { x: 43, y: 58, side: "right", label: "Caveats thinning", note: "Each copied page enlarges the claim while one qualification quietly disappears." },
    { x: 83, y: 58, side: "left", label: "Forest-wide myth", note: "The final image shows a deliberate mature-forest service that the first experiment never established." },
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 68, side: "right", label: "Idealized internet", note: "The imagined side turns every root into one seamless, permanently glowing network." },
    { x: 52, y: 53, side: "right", label: "A shifting boundary", note: "The split marks the difference between a convenient metaphor and a field system that changes locally." },
    { x: 79, y: 68, side: "left", label: "Wild patchwork", note: "Real fungal individuals overlap, break, and regrow around gaps rather than forming one immortal body." },
  ]}
