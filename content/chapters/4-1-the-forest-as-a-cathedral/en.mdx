...
<TierLegend
  title="What each tier lets this chapter say"
  tiers={[
    {
      kind: "canon",
      gloss: "Shown directly on screen: the towering Hometree, the vaulted forest, the Na'vi living up inside the trunk.",
      realWorld: "A primary source — something you can point to and replay.",
      example: "The Omatikaya live inside a colossal Hometree, climbing it from base to crown."
    },
    {
      kind: "inference",
      gloss: "Reasoned from canon: the bridge that says low gravity and dense, CO2-rich air are what let the trees clear Earth's height limit.",
      realWorld: "Abduction — the explanation that best fits the evidence we have.",
      example: "Pandora's 0.8 g and dense atmosphere push the hydraulic tree-height ceiling upward."
    },
    {
      kind: "speculation",
      gloss: "A plausible model on an unconfirmed premise — granted, then held to every other law.",
      realWorld: "A disciplined hypothesis: change one variable, make the rest pay full price.",
      example: "A Hometree reaches a full 300 m, well past the ~130 m Earth physics permits."
    },
    {
      kind: "real_science",
      gloss: "Verifiable Earth science — the ground truth we test the fiction against.",
      realWorld: "Established ecology and plant physiology — the bedrock, not a claim about Pandora.",
      example: "Earth's tallest trees top out near 122-130 m because the water column can be pulled no higher."
    }
  ]}
/>
