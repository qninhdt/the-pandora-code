...
<DiagramFigure
  ...
  labels={[
    { x: 24, y: 47, side: "left", label: "Open state", note: "The plant begins with its leaves spread" },
    { x: 50, y: 47, side: "right", label: "Folded state", note: "Hours later the leaves close despite no change in the dark cupboard" },
    { x: 76, y: 47, side: "right", label: "Open again", note: "The cycle returns without a sunrise to trigger it" }
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 28, side: "left", label: "Gene switched on", note: "The clock gene starts producing its protein" },
    { x: 75, y: 28, side: "right", label: "Protein accumulates", note: "The delayed product builds through the cell" },
    { x: 75, y: 75, side: "right", label: "Feedback closes the gene", note: "The accumulated protein returns to suppress production" },
    { x: 25, y: 75, side: "left", label: "Protein clears", note: "Breakdown releases the gene and starts the loop again" }
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 18, y: 28, side: "left", label: "Early biological night", note: "The same blue pulse delays the internal clock" },
    { x: 50, y: 28, side: "right", label: "Biological day", note: "A pulse here has little phase-shifting effect" },
    { x: 82, y: 28, side: "right", label: "Late biological night", note: "The pulse advances the internal clock instead" }
  ]}
  figNo="07"
...
<DiagramFigure
  ...
  labels={[
    { x: 16, y: 44, side: "left", label: "Image-forming retina", note: "Rods and cones send detailed visual information rearward" },
    { x: 61, y: 47, side: "right", label: "Melanopsin pathway", note: "Sparse cells report blue-weighted light rather than an image" },
    { x: 58, y: 76, side: "right", label: "Paired master clock", note: "The tiny clock above the optic chiasm sets daily timing" }
  ]}
  figNo="08"
...
<DiagramFigure
  ...
  labels={[
    { x: 18, y: 52, side: "left", label: "Early nocturnal mammal", note: "Large ears, whiskers and scenting replace a daylight-first sensory kit" },
    { x: 50, y: 52, side: "right", label: "Daylight lizard", note: "The central comparison keeps a richer colour-receptor mosaic" },
    { x: 82, y: 52, side: "right", label: "Modern mammal", note: "The nocturnal inheritance is still visible in the face" },
    { x: 50, y: 87, side: "right", label: "Receptor comparison", note: "Mammal insets are blue-heavy while the daylight lizard retains more colour" }
  ]}
  figNo="09"
...
<DiagramFigure
  ...
  labels={[
    { x: 12, y: 39, side: "left", label: "Blue-enriched light", note: "Timed light is used as treatment to reset the drifting clock" },
    { x: 29, y: 50, side: "left", label: "Sleep-deprived operator", note: "A longer workday erodes vigilance when the schedule drifts" },
    { x: 80, y: 25, side: "right", label: "Earth daylight", note: "The outside world keeps running on the ordinary terrestrial clock" },
    { x: 79, y: 82, side: "right", label: "Melatonin protocol", note: "A timed dose helps hold the managed Mars-time schedule together" }
  ]}
  figNo="10"
