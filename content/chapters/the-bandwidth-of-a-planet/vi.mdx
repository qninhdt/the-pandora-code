...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 24, y: 72, side: "left", label: "Lưới đồng bộ thần kinh bộ tộc", note: "Cả thị tộc đồng loạt cắm tua thần kinh vào hệ rễ để khuếch đại tín hiệu — nguyên tác cho thấy vòng người nhưng không nói nó góp phần gì." }
  ]}
  ...
  figNo="08"
  caption="Phép tính quay về với chính đêm mà nó cần phán xét. Hai cơ thể — một nguồn, một đích — được ghép qua Cây Linh Hồn, trong khi các liên kết thần kinh của cả thị tộc hội tụ lên tuyến đường giữa chúng. Nếu tải trọng là từng khớp thần kinh, buổi lễ phải kéo dài nhiều tháng. Nếu tải trọng là luồng ý thức đã nén, ánh sáng có thể sang tới nơi trước bình minh. Khung cảnh là nguyên tác; bộ mã hóa và tải trọng thì không."
  tier="canon"
/>
