<DiagramFigure
  ...
  labels={[
    { x: 28, y: 52, side: "left", label: "Pinned specimen", note: "Look at the physical organism first before developing explanatory models." },
    { x: 36, y: 22, side: "left", label: "Magnifying lens", note: "Inspect empirical details closely before constructing theoretical frameworks." },
    { x: 75, y: 72, side: "right", label: "Field notebook", note: "Record observations and identify the boundary of what is not yet understood." }
  ]}
...
<EvidenceGradeLadder
  caption="Do the appraisal yourself. Open with the gold-standard trial, then add the three flaws a real review would find, and watch it settle below the humble observational study you lifted with two strengths. The starting rung is provenance; everything after it is rigour. This is the machinery, and you are turning the crank."
/>
...
<DiagramFigure
  ...
  labels={[
    { x: 10, y: 42, side: "right", label: "Observable canon", note: "Solid ground: empirical details directly depicted in the source material." },
    { x: 90, y: 42, side: "left", label: "Unobserved reality", note: "The far bank: logical physical implications that the films cannot directly depict." },
    { x: 50, y: 45, side: "right", label: "Reasoned inference", note: "A disciplined scientific span connecting known data to testable conclusions." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 52.5, y: 15, side: "left", label: "Granted novum", note: "The single impossible premise: a luminous tether holding the landmass aloft." },
    { x: 62, y: 65, side: "right", label: "Ordinary physics", note: "Water cascades and follows standard Newtonian fluid dynamics and gravity." },
    { x: 23, y: 71, side: "right", label: "Aerodynamic flight", note: "Biological flight obeys conventional lift, drag, and atmospheric density laws." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 47, side: "left", label: "Flexible carbon chains", note: "Branching bonds remain mobile in liquid media, enabling rich biochemical diversity." },
    { x: 68, y: 38, side: "left", label: "Rigid silicon lattice", note: "Repeating tetrahedral bonds lock into an orderly, inflexible mineral framework." },
    { x: 85, y: 50, side: "right", label: "The mineral trap", note: "Silicon's high affinity for oxygen precipitates stable, insoluble rock-like solids." }
  ]}
  figNo="04"
...
<DiagramFigure
  ...
  labels={[
    { x: 20, y: 34, side: "left", label: "The granted novum", note: "Only the floating stone is exempt from ordinary gravitational support." },
    { x: 38, y: 54, side: "left", label: "Hydraulic transfer", note: "Falling water transfers momentum and energy according to classical fluid mechanics." },
    { x: 54, y: 54, side: "right", label: "Mechanical linkage", note: "Gears, wheels, and levers remain accountable to friction, leverage, and contact forces." },
    { x: 78, y: 52, side: "right", label: "Gravitational debt", note: "The falling counterweight obeys standard conservation of energy and mechanical work." }
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  labels={[
    { x: 14, y: 45, side: "left", label: "Tray 1: Canon", note: "Direct film evidence: cite only what is explicitly depicted in canonical scenes." },
    { x: 38, y: 48, side: "right", label: "Tray 2: Inference", note: "Bridging observations across unfilmed gaps through consistent logical extrapolation." },
    { x: 61, y: 37, side: "left", label: "Tray 3: Speculation", note: "Constrained novum: granting a single impossible premise tethered by boundary conditions." },
    { x: 84, y: 48, side: "right", label: "Tray 4: Real Science", note: "Empirical baseline: measurable properties tested against terrestrial chemistry and physics." }
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 15, y: 56, side: "left", label: "Contamination source", note: "The burning cigarette generates airborne particulates and chemical pollutants next to open cultures." },
    { x: 53, y: 60, side: "left", label: "Exposed sample", note: "Particulates precipitate onto living plant tissue, introducing uncontrolled experimental artifacts." },
    { x: 86, y: 60, side: "right", label: "Protected control", note: "The sealed dish prevents particulate deposition, isolating biological variables." }
  ]}
  figNo="07"
