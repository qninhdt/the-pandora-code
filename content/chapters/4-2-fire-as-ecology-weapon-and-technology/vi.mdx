...
<DiagramFigure
  ...
  figNo="01"
  labels={[
    { x: 45, y: 35, side: "right", label: "Lỗ thông gió khuất gió", note: "vừa đủ dưỡng khí cho hòn than thở, bố trí ở mặt khuất luồng gió ép" },
    { x: 49, y: 51, side: "right", label: "Than củi, không phải gỗ", note: "nước và các chất dễ bay hơi đã cạn — chỉ còn than hồng âm ỉ, không có ngọn lửa để bị gió thổi tắt" },
    { x: 40, y: 66, side: "left", label: "Mặt đá đặc đón gió", note: "tấm chắn gió ngăn luồng khí bay cướp mất nhiệt lượng" }
  ]}
...
Mangkwan là bộ tộc mà các bộ phim gọi là Người Tro Tàn (Ash People). Một thế hệ trước, một vụ phun trào núi lửa đã cướp đi toàn bộ thế giới của họ. Cây Mẹ Hometree, lãnh địa săn bắn, khu rừng từng nuôi dưỡng, che chở và bao bọc họ — tất cả đều bị chôn vùi dưới dòng lũ mạt vụn núi lửa và lớp tro tephra dày hàng mét chỉ trong một buổi chiều. [Chương trước](/chapters/life-after-the-volcano) đã giải thích vì sao vùng đất ấy đến nay vẫn chết lặng: vụ phun trào không chỉ giết chết cánh rừng, nó xóa sổ luôn lớp đất mặt mà cánh rừng kế tiếp cần để tái sinh, đưa đồng hồ sinh học quay trở lại vạch xuất phát trên đá trần. Những gì tư liệu canon bổ sung, và cũng là trọng tâm của chương này, là cách những kẻ sống sót đối diện với thực tại.
...
<DiagramFigure
  ...
  figNo="02"
  labels={[
    { x: 29, y: 26, side: "right", label: "Cao, sáng, đáy ngọn lửa nhạt", note: "Không khí Trái Đất — phản ứng giữ lại được nhiệt lượng nội tại" },
    { x: 70, y: 58, side: "left", label: "Lùn và mờ xỉn", note: "Cùng lượng nhiên liệu, nhưng một phần sáu không khí bị thay thế bằng carbon dioxide" },
    { x: 30, y: 82, side: "right", label: "Hai bó nhiên liệu giống hệt", note: "Nhiên liệu không phải biến số ở đây; sự khác biệt nằm ở bầu không khí" }
  ]}
...
Cần nói thẳng rằng canon chưa từng nhắc đến chi tiết này. Không có một dòng nào trong tư liệu chính thức bàn về việc không khí Pandora giúp lửa cháy dễ hơn hay khó hơn. Thành phần không khí là canon; nhưng hệ quả của nó là vật lý thực nghiệm, và vật lý thì rõ ràng: duy trì lửa trên Pandora là một kỳ tích khó khăn hơn Trái Đất rất nhiều, và tộc Mangkwan là những kẻ duy nhất buộc phải làm chủ kỳ tích ấy để sinh tồn.

<Callout variant="warning" title="Vị thế của lập luận này">
Thành phần khí quyển là dữ kiện canon chính thức. Toàn bộ các suy luận dẫn xuất ở đây — từ việc suy giảm nhiệt độ ngọn lửa, giảm tốc độ lan truyền cháy, nguy cơ bị gió thổi tắt cho đến việc diễn giải thiết kế chiếc lò than đá bọt — đều là việc áp dụng khoa học cháy Trái Đất vào các con số canon. Các bộ phim không đề cập đến điều này. Sự im lặng đó là một khoảng trống nghiên cứu giá trị, nhưng nó vẫn là khoảng trống suy luận, và chiếc lò than chắn gió là góc nhìn phân tích của chúng ta đối với mẫu vật chứ không phải một sự thật hiển nhiên được canon tuyên bố.
</Callout>
...
<DiagramFigure
  ...
  figNo="03"
  labels={[
    { x: 14, y: 40, side: "right", label: "Ngọn lửa duy nhất trong khung hình", note: "và nó không bao giờ tiến lại gần hơn vị trí này" },
    { x: 47, y: 62, side: "right", label: "Khoảng đất trống", note: "không có gì băng qua — không ngọn lửa, không tàn đóm, không tiếp xúc vật lý" },
    { x: 72, y: 40, side: "left", label: "Đã bắt đầu bốc khói", note: "lá cây ngả vàng và xoăn lại chỉ nhờ nhiệt lượng bức xạ truyền tới" },
    { x: 88, y: 62, side: "left", label: "Vẫn chưa bị tổn hại", note: "nằm lùi sâu hơn về phía sau, dưới ngưỡng thông lượng nhiệt kích cháy" }
  ]}
...
<DiagramFigure
  ...
  figNo="04"
  labels={[
    { x: 20, y: 22, side: "right", label: "Tàn đóm phát tán ngẫu nhiên", note: "Cột khói nâng chúng lên; hướng gió quyết định nơi chúng rơi xuống" },
    { x: 15, y: 72, side: "right", label: "Đám cháy nguồn", note: "Đã chạm tới giới hạn khoảng cách mà bức xạ nhiệt có thể vươn tới" },
    { x: 74, y: 33, side: "left", label: "Một hòn than được kiểm soát", note: "Cùng một cơ chế vật lý nhưng đã loại bỏ hoàn toàn tính ngẫu nhiên" },
    { x: 68, y: 45, side: "left", label: "Đường bay thẳng và chủ động", note: "Vận chuyển nguồn lửa đến mục tiêu theo chủ ý thay vì phó mặc cho may rủi" }
  ]}
...
Các mũi tên lửa của họ cũng bắt nguồn từ cùng một nền tảng vật lý. Canon và sách ảnh mô tả những mũi tên cháy được châm lửa từ than hồng mang theo — và nếu bạn là người thiết kế chúng, bạn sẽ không bao giờ dùng bùi nhùi khô. Bùi nhùi khô sẽ bị gió thổi tắt ngay khi rời dây cung. Thứ sống sót được ở tốc độ bay cao phải là một chất kết dính đậm đặc, cháy chậm, bám chặt vào thân tên và giữ ngọn lửa ẩn sâu bên trong lớp biên khí động học của chính nó: nhựa cây, mỡ động vật, hắc ín, lưu huỳnh. Chính xác là nhóm vật liệu mà canon đặt vào tay người Mangkwan. Những người thợ chế tạo tên lửa thời cổ trên Trái Đất, khi giải bài toán tương tự trong không khí thông thường, cũng đã hội tụ về cùng một danh mục công thức pha chế.
...
<DiagramFigure
  ...
  figNo="05"
  labels={[
    { x: 17, y: 57, side: "right", label: "Một đốm lửa nhỏ ở mép cánh", note: "Đó là tất cả lượng lửa cần thiết để kích hoạt sự sụp đổ cơ học" },
    { x: 27, y: 52, side: "right", label: "Màng cánh co rút thành các nếp gờ", note: "Collagen biến tính ở 58–65 °C và co rút mạnh dọc theo các thớ sợi" },
    { x: 74, y: 30, side: "left", label: "Cánh còn lại vẫn căng mượt", note: "Vẫn tạo đủ lực nâng tối đa — và đó chính là nguồn cơn của thảm họa" },
    { x: 55, y: 68, side: "left", label: "Lật nhào về phía cánh hỏng", note: "Mô-men xoắn ngoài ý muốn xuất hiện, vượt quá quyền kiểm soát của con vật" }
  ]}
...
Khi dòng dung nham giàu silica phun trào lên bề mặt và nguội đi quá nhanh khiến các nguyên tử không kịp sắp xếp thành mạng tinh thể có trật tự, nó sẽ đông cứng lại thành thủy tinh — một chất rắn vô định hình không có trật tự tuần hoàn bên trong, chỉ là một mạng lưới lộn xộn giữa silicon và oxy bị khóa chặt giữa trạng thái lỏng. Trên Trái Đất, chúng ta gọi nó là đá vỏ chai (obsidian). Vùng Ashlands trong canon hình thành theo đúng quy trình địa chất này, sản sinh ra một loại khoáng vật tương tự obsidian, và tộc Mangkwan đã gây dựng toàn bộ hệ thống công cụ của mình trên nền tảng đó.
...
<DiagramFigure
  ...
  figNo="06"
  labels={[
    { x: 30, y: 30, side: "right", label: "Điểm chịu lực ghè", note: "Một điểm tác động duy nhất, truyền nón ứng suất xuyên vào lòng khối đá" },
    { x: 45, y: 45, side: "right", label: "Các gợn sóng trong thủy tinh", note: "Dấu tích của mặt đầu vết nứt lan truyền — không có mặt phẳng tinh thể nào dẫn dắt" },
    { x: 68, y: 78, side: "left", label: "Lưỡi bén dày vài nguyên tử", note: "Sắc bén hơn dao mổ thép y tế cả một bậc độ lớn" }
  ]}
...
<DiagramFigure
  ...
  figNo="07"
  labels={[
    { x: 40, y: 48, side: "right", label: "Lạnh, xám, không bao giờ nóng đỏ", note: "Được định hình bằng lực đập búa cơ học, không dùng nhiệt nung chảy" },
    { x: 55, y: 42, side: "left", label: "Vết búa đập lõm khắp bề mặt", note: "Mỗi nhát búa làm kim loại cứng hơn nhưng cũng đưa nó lại gần ngưỡng nứt vỡ" },
    { x: 80, y: 66, side: "left", label: "Lò than đặt cạnh bàn gia công", note: "Cung cấp vài trăm độ để ủ mềm kim loại trở lại — hoàn toàn không cần tới nhiệt độ nóng chảy" }
  ]}
...
<DiagramFigure
  ...
  figNo="08"
  labels={[
    { x: 32, y: 12, side: "right", label: "Khoản nợ bốc hơi", note: "Nitơ bay hơi từ 200 °C — gần như biến mất hoàn toàn trên 500 °C" },
    { x: 24, y: 22, side: "right", label: "Quả nón chờ đợi nhiều năm", note: "Lớp nhựa niêm phong bị nhiệt nung chảy, giải phóng hạt xuống nền đất đã dọn sạch" },
    { x: 60, y: 52, side: "left", label: "Khoản có ở lại", note: "Canxi, magie và kali — tạo thành luống tro kiềm giàu khoáng trên nền đất sống" },
    { x: 55, y: 80, side: "left", label: "Than sinh học trong lòng đất", note: "Sẽ tiếp tục cải tạo cấu trúc và độ ẩm của vùng đất này suốt một ngàn năm tới" }
  ]}
...
<DiagramFigure
  ...
  figNo="09"
  labels={[
    { x: 20, y: 72, side: "right", label: "Mầm xanh trở lại sau một thập kỷ", note: "Đất, ngân hàng hạt mầm và luống tro màu mỡ cùng sống sót bên nhau" },
    { x: 12, y: 45, side: "right", label: "Cháy thành than, không bị chôn vùi", note: "Ngọn lửa lấy đi tán rừng đứng nhưng để lại chiếc khuôn cho sự sống tái sinh" },
    { x: 82, y: 26, side: "left", label: "Bị chôn vùi, không chỉ bị đốt", note: "Lớp tro tephra vô sinh dày hàng mét đã niêm phong toàn bộ sổ sách ngoài tầm với" },
    { x: 72, y: 66, side: "left", label: "Trơ trụi suốt một thế kỷ", note: "Cùng mức độ tàn phá trong ngày thảm họa, nhưng sổ sách ghi nhận hoàn toàn trái ngược" }
  ]}
  ...
  rungs={[
    {
      ...
      evidence: "Thành phần khí quyển là canon, và vai trò của CO₂ vừa là chất pha loãng nhiệt vừa là vật thể thứ ba dập tắt gốc tự do là kiến thức hóa học cháy kinh điển với nhiệt dung đã được đo đạc chính xác.",
      caution: "Canon hoàn toàn im lặng về hành vi của lửa trên Pandora, và hóa sinh sinh khối thực vật Pandora chưa được biết rõ — các mô thực vật giàu nhựa hoặc dễ bay hơi có thể bù đắp một phần bất lợi từ khí quyển.",
    },
    {
    ...
    },
    {
      ...
      caution: "Việc tộc Mangkwan phân chia vật liệu theo đúng công năng này là suy luận từ bộ công cụ được khắc họa; canon không mô tả chi tiết logic lựa chọn vật liệu của họ.",
    },
    {
      ...
      verdict: "contested",
      evidence: "Độ sâu chôn vùi và sự cằn cỗi kéo dài là canon; hiệu ứng luống tro và sự bay hơi của nitơ là các quá trình sinh thái Trái Đất đã được chứng minh.",
      caution: "Luận điểm này áp đặt mô hình kế toán dinh dưỡng Trái Đất lên một chất nền địa hóa mà canon chưa bao giờ mô tả chi tiết, và dựa trên suy luận rằng mạng lưới cục bộ đã bị cắt đứt hoàn toàn thay vì chỉ tạm thời ngưng trệ.",
    },
  ]}
/>
