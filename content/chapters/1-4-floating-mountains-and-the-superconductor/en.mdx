...
Canon is specific about the cause: the mountains float because of <GlossaryTerm slug="unobtanium">unobtanium</GlossaryTerm>, a mineral concentrated in their cores. Pandora's magnetic field is unusually strong — the moon's iron core does the ordinary planetary dynamo thing, but buried unobtanium is described as amplifying that baseline field more than a hundredfold. Where Pandora's field overlaps the field of the gas giant it orbits, Polyphemus, you get a region of violent, concentrated magnetic flux: the **Flux Vortex**, centred over the mountains themselves.

<DiagramFigure
  src="/images/chapters/floating-mountains-and-the-superconductor/fig-02-flux-vortex-map.webp"
  labels={[
    { x: 26, y: 30, side: "right", label: "Polyphemus's field", note: "the gas giant's vast magnetosphere" },
    { x: 75, y: 55, side: "left", label: "Pandora's field", note: "the moon's own, smaller field" },
    { x: 52, y: 46, side: "left", label: "The Flux Vortex", note: "where the two fields crowd and tangle" },
    { x: 50, y: 80, side: "right", label: "Over the Hallelujah range", note: "the mountains hang right beneath it" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 30, y: 68, side: "right", label: "First electron", note: "drags the lattice of positive ions inward" },
    { x: 72, y: 32, side: "left", label: "Drawn into the wake", note: "the second electron follows — a bound pair" },
    { x: 16, y: 22, side: "right", label: "The ion lattice", note: "the positive grid the pairing borrows" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 10, y: 40, side: "right", label: "The field tries to enter", note: "approaching from outside" },
    { x: 72, y: 28, side: "left", label: "Lines bend around", note: "lossless surface currents repel them" },
    { x: 50, y: 50, side: "right", label: "Nothing inside", note: "the field is expelled from the bulk entirely" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 20, side: "right", label: "A forest of flux threads", note: "the field pierces in discrete points" },
    { x: 55, y: 75, side: "left", label: "One quantized vortex", note: "each carries exactly one quantum of flux" },
    { x: 22, y: 70, side: "right", label: "Threading the bulk", note: "the mixed state of a type-II superconductor" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 42, y: 42, side: "left", label: "Threads pinned in defects", note: "vortex cores drop into the lattice flaws" },
    { x: 16, y: 50, side: "right", label: "Locked in every direction", note: "it can't drift along the threads" },
    { x: 62, y: 50, side: "left", label: "Sewn to the field", note: "rigidly fixed in three dimensions" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 40, y: 42, side: "right", label: "Locked, not balancing", note: "fixed at its height and tilt, hands-off" },
    { x: 44, y: 64, side: "right", label: "Pinned at a set distance", note: "hovering above the magnet track" },
    { x: 82, y: 18, side: "left", label: "Inverted, it still hangs", note: "held beneath the track, refusing to fall" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 26, y: 20, side: "right", label: "Quasicrystalline lattice", note: "unobtanium's never-repeating structure" },
    { x: 50, y: 40, side: "right", label: "A thread caught in a void", note: "the flux line snags and pins here" },
    { x: 72, y: 86, side: "left", label: "Microscopic voids", note: "pinning centres riddling the bulk" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 12, side: "left", label: "Pull upward", note: "the pinned core is locked to the field above" },
    { x: 50, y: 38, side: "right", label: "Superconducting core", note: "sewn to the flux at the surface" },
    { x: 50, y: 72, side: "right", label: "Heavy ballast keel", note: "dead non-magnetic rock hanging below" },
    { x: 50, y: 90, side: "left", label: "Pull downward", note: "two opposed springs find a stable equilibrium" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 70, y: 28, side: "left", label: "The mountain in miniature", note: "Hallelujah's physics, scaled to a carriage" },
    { x: 64, y: 56, side: "left", label: "Floating on the gap", note: "flux-pinning holds the car above the rail" },
    { x: 30, y: 72, side: "right", label: "The pinned track", note: "the same lock, built into a railway" }
  ]}
...
<FloatingMountainFigure
  ...
  caption="The Hallelujah range at sunset — not magic, but flux pinning scaled up to the size of a planet."
/>
