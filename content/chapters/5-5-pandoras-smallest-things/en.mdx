<DiagramFigure
  ...
  labels={[
    { x: 23, y: 44, side: "right", label: "Intact leaf", note: "Carbon and nutrients still locked inside living architecture" },
    { x: 53, y: 47, side: "left", label: "Decomposer frontier", note: "Tissue softens as enzymes and small consumers open it" },
    { x: 83, y: 48, side: "left", label: "Fungal filaments", note: "An external digestive network spreads through the remains" },
    { x: 88, y: 72, side: "left", label: "Root tip", note: "Released nutrients can re-enter the living forest here" },
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 23, side: "right", label: "Gas-filled pore", note: "A drained channel admits air after rain" },
    { x: 40, y: 46, side: "right", label: "Connected water film", note: "Dissolved food and cells can travel along this thin road" },
    { x: 57, y: 24, side: "left", label: "Bound mineral grains", note: "Roots, hyphae and microbial glues build the aggregate" },
    { x: 72, y: 65, side: "left", label: "Oxygen-poor core", note: "Water remains while oxygen diffusion slows" },
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 17, y: 15, side: "right", label: "Leaf input", note: "Fragments of fallen plant matter feed living microbial cells at the aggregate surface." },
    { x: 35, y: 45, side: "right", label: "Microbial turnover", note: "Cells consume the leaf, build biomass, and become the next material to enter the soil archive." },
    { x: 57, y: 67, side: "left", label: "Mineral binding", note: "Microbial residues cling to clay and metal-oxide surfaces instead of remaining freely exposed." },
    { x: 79, y: 66, side: "left", label: "Protected pore", note: "Physical enclosure limits enzyme and consumer access, allowing necromass to persist." },
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 24, y: 38, side: "right", label: "Tank-grown body", note: "A genome and an anatomy do not specify a mature microbial community" },
    { x: 48, y: 33, side: "left", label: "Controlled boundary", note: "The laboratory can limit exposure, but cannot make exposure irrelevant" },
    { x: 75, y: 40, side: "left", label: "Environmental assembly", note: "Skin, mouth, food and breath become routes of colonisation" },
    { x: 73, y: 58, side: "right", label: "Gut habitat", note: "Canon never states which community makes this ecosystem functional" },
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  labels={[
    { x: 22, y: 42, side: "right", label: "Foreign arrivals", note: "Exposure is only the first gate, not an infection" },
    { x: 44, y: 50, side: "left", label: "Mismatched attachment", note: "Without a usable molecular handle, contact ends at the surface" },
    { x: 76, y: 35, side: "left", label: "Resident community", note: "Occupied space and consumed resources resist newcomers" },
    { x: 74, y: 73, side: "left", label: "Tissue defence", note: "Broad cellular responses can act without prior evolutionary acquaintance" },
  ]}
  figNo="04"
...
<DiagramFigure
  ...
  labels={[
    { x: 16, y: 52, side: "right", label: "Human base", note: "Cold clinical space controls breathing gas but does not seal every biological surface." },
    { x: 43, y: 48, side: "right", label: "Exo-pack worker", note: "A person crosses the threshold carrying a closed native sample whose exterior still carries residue." },
    { x: 72, y: 59, side: "left", label: "Two-way traffic", note: "Cart, boots, joints, and equipment make quiet routes in both directions across the airlock." },
    { x: 88, y: 87, side: "left", label: "Microbial hitchhikers", note: "The inset circles show Earth-like and native material travelling on surfaces, not through the air seal." },
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 26, y: 18, side: "right", label: "Layered archive", note: "Mud deposits preserve a biological sequence through time" },
    { x: 27, y: 50, side: "right", label: "Dormant parasite stages", note: "Resting eggs can be revived from separated sediment layers" },
    { x: 68, y: 50, side: "left", label: "Cross-time challenge", note: "Parasites from different dates meet hosts under controlled conditions" },
    { x: 84, y: 48, side: "left", label: "Living host", note: "Infectivity peaks near the historical host population each parasite tracked" },
  ]}
  figNo="05"
