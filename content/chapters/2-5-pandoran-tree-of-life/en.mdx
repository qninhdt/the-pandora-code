...
<DiagramFigure
  ...
  labels={[
    { x: 12, y: 41, side: "right", label: "Na'vi signature", note: "The humanoid body still exposes the same woven carbon-composite bone and neural queue." },
    { x: 38, y: 42, side: "right", label: "Thanator signature", note: "A land predator repeats the internal construction beneath a radically different exterior." },
    { x: 65, y: 42, side: "right", label: "Ikran signature", note: "Flight hardware changes, but the opened body keeps the inherited material pattern." },
    { x: 89, y: 42, side: "left", label: "Tulkun signature", note: "Even the ocean giant carries both shared novelties, making them stronger clade evidence than shape." },
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 73, y: 17, side: "left", label: "Modern whale", note: "The streamlined ocean body hides the terrestrial history that the joint can still reveal." },
    { x: 22, y: 63, side: "right", label: "Early whale skeleton", note: "A four-legged fossil keeps the transition from hoofed land mammal to ocean giant visible." },
    { x: 43, y: 37, side: "right", label: "Double-pulley ankle", note: "The distinctive joint matches even-toed hoofed mammals and anchors the family tree." },
    { x: 82, y: 39, side: "left", label: "Hippo comparison", note: "A living hippo carries the same ankle architecture despite its very different silhouette." },
  ]}
