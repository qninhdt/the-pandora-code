<DiagramFigure
  ...
  labels={[
    { x: 42, y: 38, side: "left", label: "Silicate rock", note: "Oxygen, silicon and magnesium, every atom of it fused in the shells of massive stars." },
    { x: 55, y: 58, side: "right", label: "Metallic glint", note: "Iron: the end of the fusion road, and the reason this world has a core at all." },
    { x: 88, y: 18, side: "left", label: "Living light", note: "Carbon and nitrogen shed by dying low-mass stars, now running a biosphere." }
  ]}
  alt="A cut slab of dark Pandoran rock held in a gloved hand under a field lamp, a metallic sheen glinting from the exposed face"
  figNo="01"
  caption="Pick up a stone on Pandora and you are holding something older than the moon, older than the star, older than most of the elements in your own hand. The interesting question is not what it is. It is where it has been."
  tier="inference"
/>
...
For the first few minutes after the Big Bang, the whole universe was hot and dense enough to be a fusion reactor, and for a while it behaved like one. <GlossaryTerm slug="big-bang-nucleosynthesis">Big Bang nucleosynthesis</GlossaryTerm> ran for roughly a quarter of an hour: protons and neutrons found each other, deuterium formed as soon as the ambient light was too feeble to smash it apart again, and the deuterium fused into helium.
...
<Callout variant="insight" title="The consequence, stated plainly">
Every atom in that stone except the hydrogen bound into its water was made *after* the Big Bang, inside a star. So was every atom in the tree you are standing under, and in your own hand. The universe did not come with rock. Rock is a manufactured product, and the factories are stars.
</Callout>
...
<NucleosynthesisLedger
  caption="Six samples from one moon, and six different production histories. Note what happens to ocean water when you switch from weighing it to counting it: by mass it is overwhelmingly oxygen, which is supernova ash, but by atom it is two-thirds hydrogen, which predates every star that ever existed. Both readings are honest. They are answers to different questions."
/>
...
<DiagramFigure
  ...
  labels={[
    { x: 44, y: 50, side: "right", label: "The merger itself", note: "Two neutron stars touching: about one second of contact, and the heaviest elements exist." },
    { x: 30, y: 70, side: "left", label: "Neutron-rich ejecta", note: "A few percent of a solar mass thrown clear, seeded with gold, platinum and uranium." },
    { x: 82, y: 18, side: "left", label: "Dispersal", note: "The debris mixes outward for tens of millions of years before any of it can end up in rock." }
  ]}
  alt="Two extremely dense compact objects merging in deep space, throwing off luminous tidal streams of debris that glow with a warm metallic sheen against the dark"
  figNo="02"
  caption="The only confirmed factory for gold, platinum and uranium: two neutron stars colliding, throwing off a fraction of a solar mass of neutron-drenched debris. The elements in a heavy-metal vein were made in about one second, in an event like this, long before Pandora's disk existed."
  tier="real_science"
/>

<Callout variant="science" title="How that argument was framed">
The two neutron-capture routes were named for their tempo. The <GlossaryTerm slug="s-process">slow</GlossaryTerm> one runs inside puffed-up dying stars of modest mass, where neutrons trickle in over centuries and each nucleus has time to settle before the next arrives; it builds up to lead and stops. The **rapid** one runs in the shredded, neutron-drenched debris of a merger, over about a second, and it runs so far past stability that it reaches uranium. Two processes, the same starting material, wildly different products — and a rock's mixture of them names which kind of catastrophe it inherited.
</Callout>
...
The second is <GlossaryTerm slug="metallicity">metallicity</GlossaryTerm>, and it is the more interesting of the two. Astronomers use the word to mean everything heavier than helium — which, from a rock's point of view, means *everything a planet is made of*. Both stars come in at about 0.22 dex above solar, which translates to roughly 1.6 times the Sun's supply of heavy elements.
...
<StatGrid
  stats={[
    { label: "System age — measured", value: "5.3 Gyr", vs: "Sun: 4.57", tone: "amber" },
    { label: "Heavy elements vs the Sun", value: "1.6×", vs: "Sun: 1.0", tone: "cyan" },
    { label: "Age stated by canon", value: "none", note: "No official source dates Pandora, Polyphemus or the system", tone: "magenta" }
  ]}
/>
...
<StatGrid
  stats={[
    { label: "Star of 25 solar masses", value: "~7 Myr", note: "Burns through its hydrogen and collapses before the disk of a young system would even disperse", tone: "magenta" },
    { label: "Star of 1 solar mass", value: "~10 Gyr", note: "Still on the main sequence after the age of the galaxy's thin disk", tone: "amber" },
    { label: "Alpha Centauri B, 0.9 solar", value: "~15 Gyr", note: "Longer-lived than the universe is old", tone: "teal" }
  ]}
/>
...
<DiagramFigure
  ...
  labels={[
    { x: 27, y: 74, side: "right", label: "First ignition", note: "Hydrogen and helium only: no carbon, no oxygen, nothing to radiate heat away." },
    { x: 60, y: 35, side: "right", label: "Massive by default", note: "Without coolants a collapsing cloud fragments coarsely, so the first stars came out huge." },
    { x: 15, y: 30, side: "right", label: "Metal-free gas", note: "The dark cloud they lit inside had no solids in it at all — no dust, no grains, no rock." }
  ]}
  alt="A vast dark cloud of gas in deep space with a handful of intensely bright blue-white points igniting within it, illuminating faint filaments"
  figNo="03"
  caption="The first stars had no metals to work with and nothing to cool their birth clouds, so they came out massive — and massive stars are impatient. They lit, burned through everything, and detonated inside a few million years, which is why the universe stopped being a hydrogen desert so quickly."
  tier="real_science"
/>
...
The first is how carbon gets made. Three helium nuclei have to meet, which requires the fleeting beryllium-8 to survive just long enough for a third helium to arrive. It works only because carbon-12 happens to have an excited state at almost exactly the energy the incoming pair brings with it — a resonance that boosts the <GlossaryTerm slug="triple-alpha-process">triple-alpha process</GlossaryTerm> by about seven orders of magnitude. Without that coincidence there is no carbon, no oxygen made from carbon, and no chemistry worth discussing.

The second is why the sequence ends. Fusion releases energy only while it is climbing toward more tightly bound nuclei, and <GlossaryTerm slug="nuclear-binding-energy">binding energy per nucleon</GlossaryTerm> peaks right around iron and nickel. Past that peak, fusing costs more than it yields. An iron core cannot pay for its own pressure. So the star's last act is a core that has no way left to hold itself up.

<DiagramFigure
  src="/images/chapters/from-stardust-to-pandora/fig-04-onion-shell-interior.webp"
  labels={[
    { x: 50, y: 26, side: "left", label: "Hydrogen envelope", note: "The outermost and coolest shell, and the one that lasts millions of years." },
    { x: 50, y: 48, side: "right", label: "Heavier shells inward", note: "Helium, carbon, neon, oxygen, silicon — each hotter, each faster, silicon lasting about a day." },
    { x: 50, y: 58, side: "left", label: "Iron core", note: "Fusing iron costs energy instead of releasing it, so the furnace stops here." }
  ]}
  alt="A cutaway of a massive star showing nested glowing shells in graded colours from a cool outer envelope to an intensely bright dense centre"
  figNo="04"
  caption="Every shell in a dying massive star is a different reaction running at a different temperature, and each one is shorter-lived than the last — hydrogen for millions of years, silicon for about a day. The dark iron centre at the middle is the reason the whole structure has only hours left."
  tier="real_science"
/>
...
<DiagramFigure
  ...
  labels={[
    { x: 42, y: 50, side: "left", label: "Shock front", note: "Where the ejecta meets the cold cloud, compressing gas past the point where it can hold itself up." },
    { x: 57, y: 53, side: "right", label: "Triggered collapse", note: "The same shell that delivers new elements also starts the next round of star formation." },
    { x: 20, y: 78, side: "right", label: "Unenriched cloud", note: "Ahead of the shock the gas is still old material, waiting to be seeded." }
  ]}
  alt="An expanding luminous shell of stellar debris ploughing into a dark dense cloud, compressing its edge into bright filaments"
  figNo="05"
  caption="Enrichment and star formation are the same event seen twice. The shell scatters newly made elements into the surrounding gas — and by compressing that gas, it triggers the collapse that turns the enriched material into the next generation of stars and their planets."
  tier="real_science"
/>

And then the crucial, easily skipped step: the debris has to *mix*. Ejecta plough into the surrounding <GlossaryTerm slug="interstellar-medium">interstellar medium</GlossaryTerm>, slow, cool, and over tens of millions of years turbulently blend into the dense cold clouds where new stars form. Every generation of stars therefore begins slightly richer than the last, and a system forming 5.3 billion years ago around a star like Alpha Centauri A inherits the accumulated output of everything that died before it.
...
Every cloud is turning a little. As it shrinks, conservation of angular momentum spins it faster, and material trying to fall straight in along the equator finds itself moving sideways too quickly to reach the centre. Gas falling in along the poles has no such problem. So the collapse is asymmetric: matter piles onto a central protostar from above and below, while everything near the equatorial plane settles into a spinning, flattened disk — a <GlossaryTerm slug="protoplanetary-disk">protoplanetary disk</GlossaryTerm>. Not a cloud of debris: something thin and orderly, with a temperature and a density that fall off smoothly outward.

<DiagramFigure
  src="/images/chapters/from-stardust-to-pandora/fig-06-collapse-into-a-disk.webp"
  labels={[
    { x: 33, y: 49, side: "left", label: "Newborn star", note: "Most of the cloud's mass ends up here; almost all of its rotation does not." },
    { x: 40, y: 62, side: "right", label: "The disk", note: "Gas with too much sideways motion to fall inward settles into a flat plane instead." },
    { x: 78, y: 50, side: "left", label: "Truncated edge", note: "A companion star two dozen Earth-distances out cuts the disk short at about 2.5-3 AU." }
  ]}
  alt="A dark contracting cloud core flattening into a broad glowing disk around a newborn star, with a second star at a distance visibly cutting the disk's outer edge short"
  figNo="06"
  caption="Rotation is why planetary systems are flat. Gas falling in near the equator has too much sideways motion to reach the centre and settles into a disk instead — and around Alpha Centauri A that disk was not free to run outward forever, because a second star was standing a couple of dozen Earth-distances away, cutting it short."
  tier="real_science"
/>
...
<CondensationSequenceDial
  caption="Slide the assembly point outward and watch the available inventory change. Inside the water line only rock, metal and sulfide have condensed, and anything built there comes out dense and dry. Cross the line and water ice joins the mix — the solid budget more than doubles, and the density of whatever assembles there falls by two-thirds. This one boundary decides whether a body is a rock or an iceball."
/>

Water is abundant, so freezing it out roughly doubles the mass of solid material available for building. That is why giant planets form beyond the <GlossaryTerm slug="snow-line">snow line</GlossaryTerm> and not inside it: only out there is there enough solid stuff to assemble a massive core quickly enough to matter.
...
The way out is collective rather than individual. When enough pebbles accumulate in one region, they drag the local gas along with them, which reduces the headwind, which lets more pebbles accumulate — a runaway. The pebbles pile into dense filaments — the <GlossaryTerm slug="streaming-instability">streaming instability</GlossaryTerm> — and once a filament is dense enough its own gravity takes over and it collapses directly into bodies tens to hundreds of kilometres across. No gradual sticking through the forbidden sizes; the disk skips over them.

<DiagramFigure
  src="/images/chapters/from-stardust-to-pandora/fig-07-pebbles-find-each-other.webp"
  labels={[
    { x: 45, y: 55, side: "left", label: "Pebble swarm", note: "Loose grains that cannot stick to each other and drift inward faster the bigger they get." },
    { x: 62, y: 52, side: "right", label: "Concentration", note: "Gas drag makes the swarm clump, and a dense enough clump stops needing collisions." },
    { x: 83, y: 53, side: "right", label: "Planetesimal", note: "Self-gravity takes over and the clump collapses straight past the missing size range." }
  ]}
  alt="A close view inside a protoplanetary disk where drifting grains gather into a dense elongated filament, with one region already collapsed into a single dark solid body"
  figNo="07"
  caption="Planet formation has a gap in the middle. Objects between a fist and a metre across neither stick reliably nor survive their own inward drift, so growth cannot proceed one collision at a time. Instead swarms of pebbles concentrate until their combined gravity takes over and collapses them straight into full-sized planetesimals."
  tier="real_science"
/>

Once bodies that size exist, growth accelerates. In <GlossaryTerm slug="pebble-accretion">pebble accretion</GlossaryTerm> a planetesimal's gravity bends the paths of drifting pebbles toward it, so it sweeps a volume far larger than its own cross-section, and the biggest object in a neighbourhood grows fastest. Ten Earth masses of solid core in a few hundred thousand years is achievable — comfortably inside the two-to-five-million-year window before the gas disperses.
...
<Callout variant="insight" title="So Polyphemus is an immigrant">
A giant planet cannot assemble where canon parks it. There is not enough solid material inside the water line to build a ten-Earth-mass core before the gas is gone. What resolves this is not special pleading — it is the most ordinary process in modern planet formation: <GlossaryTerm slug="planetary-migration">migration</GlossaryTerm>. A planet exchanges angular momentum with the disk it sits in, and drifts. Hundreds of the real exoplanets we have found are giants far closer to their stars than they could possibly have formed, and migration is why. Polyphemus almost certainly built its core out past the water line, in the narrow band the companion star left available, and then moved inward to where the films find it. Canon does not say this. The physics does not really permit anything else.
</Callout>
...
A giant planet, in the act of accreting gas, spins up a miniature version of the disk that made it: a <GlossaryTerm slug="circumplanetary-disk">circumplanetary disk</GlossaryTerm>, fed from above by inflowing material, orbiting the planet rather than the star. Moons condense out of it. This is where the Galilean moons came from, and it explains their most obvious property — they orbit in the same direction, in nearly the same plane, on nearly circular paths, like a scale model of a solar system.

<DiagramFigure
  src="/images/chapters/from-stardust-to-pandora/fig-08-a-disk-around-a-giant.webp"
  labels={[
    { x: 47, y: 42, side: "left", label: "Young giant", note: "Massive enough to open a gap in the stellar disk and keep feeding from its edges." },
    { x: 50, y: 62, side: "left", label: "Circumplanetary disk", note: "A miniature version of the disk that built the planet, and the only thing feeding the moons." },
    { x: 77, y: 62, side: "right", label: "Moons in progress", note: "Each grows until it migrates inward and is eaten, which caps the total at about a ten-thousandth of the host." }
  ]}
  alt="A young banded gas giant encircled by a thin bright disk of gas and dust in which several small moons are taking shape at different distances"
  figNo="08"
  caption="A giant planet builds its moons the way its star built it — in a flattened disk of its own, fed from above. This is why satellite systems come out orderly and prograde. It is also why they come out small: a moon growing heavier in a thin disk migrates inward faster, so the planet eats its own products about as quickly as it makes them."
  tier="real_science"
/>
...
<SatelliteMassBudget
  caption="Three real satellite systems, three very different hosts, and one ratio. Whatever a giant's mass, the moons it grows come to about a ten-thousandth of it — a self-limiting balance, because a moon growing heavier in a thin disk migrates inward faster and gets fed to the planet. Pandora sits an order of magnitude above that line, and dragging the host-mass slider does not rescue her: the mass Polyphemus would need is past where a planet stops being a planet."
/>
...
<WhatThisMeans title="The interesting failure">
This is the best kind of problem a piece of world-building can have, because it is a *quantitative* one. Nothing about Pandora is impossible — the elements were available, the star is real and metal-rich, the disk was viable, the giant's migration is routine. But an Earth-scale moon around a Jupiter-scale planet is not a thing a satellite system grows. It is a thing that has to be acquired some other way. And the same reasoning applies far beyond fiction: it is exactly why the search for real habitable exomoons is so daunting. The moons giant planets grow for themselves are Ganymedes and Titans — a hundredth of Earth's mass, not half of it. If large habitable moons exist, most of them are probably not native.
</WhatThisMeans>
...
<Callout variant="note" title="Where I'll leave it">
Canon supplies no formation account, so there is no fact here to be right or wrong about. What the physics does is rank the difficulties: the disk route strains a well-tested scaling law, capture strains the orbital architecture, and the merger route requires a specific violent accident at a specific time. My own reading is that the merger route asks least — it needs luck rather than new physics — but that is an inference, and it should be read as one.
</Callout>
...
<StatGrid
  stats={[
    { label: "Pandora — density implied by canon", value: "5.9", note: "grams per cm³, from the stated gravity and radius", tone: "amber" },
    { label: "Earth", value: "5.51", note: "and Earth is more self-compressed than a smaller world would be", tone: "cyan" },
    { label: "Ganymede — an ice moon", value: "1.94", note: "Titan 1.88, Europa 3.01 — the company Pandora is not keeping", tone: "teal" }
  ]}
/>
...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 50, side: "right", label: "Ice-rich moon", note: "Assembled beyond the water line: about half its mass is ice, so it comes out near 2 g/cm3." },
    { x: 75, y: 50, side: "left", label: "Rock-and-metal moon", note: "Assembled inside the water line, then differentiated: a large metal core under dense silicate." },
    { x: 75, y: 68, side: "right", label: "What the numbers pick", note: "Pandora's stated gravity and radius give 5.87 g/cm3 — the right-hand body, not the left." }
  ]}
  alt="Two moon cutaways side by side: the left one pale and largely translucent with a small dark centre, the right one dark and dense with a large bright metallic core"
  figNo="09"
  caption="Two moons the same size, built on opposite sides of the water line. The pale one is half ice around a modest rocky centre — the kind of body a giant planet's disk actually produces. The dark one is rock over a large metal core, and it is the one Pandora's stated gravity and radius describe. The difference is not decoration; it is a statement about where the material condensed."
  tier="inference"
/>
...
The heat comes from several sources at once. Accretion itself: every body that falls in arrives at escape velocity and converts its motion to heat. Core formation: as metal separates and sinks, its descent releases gravitational energy throughout the body. And radioactive decay — not the slow uranium-and-thorium warmth that still drives Earth's interior today, but a short-lived isotope of aluminium with a <GlossaryTerm slug="half-life">half-life</GlossaryTerm> under a million years, abundant enough in the early disk to melt anything that formed within the first couple of million years of it.

The result is a <GlossaryTerm slug="magma-ocean">magma ocean</GlossaryTerm>, and in a magma ocean elements distribute themselves by chemical preference. Some bind readily to oxygen and stay in the silicate melt; some dissolve into liquid metal and go down with it; some prefer sulfide; some refuse to stay in either and escape as gas. This is <GlossaryTerm slug="planetary-differentiation">planetary differentiation</GlossaryTerm>, the sorting that gives every rocky world its layered structure — and it is why Pandora's derived density implies not just heavy material but *organised* heavy material, iron below and rock above.
...
<Callout variant="warning" title="Why an orebody is strange">
Differentiation is very good at stripping metal-loving elements out of a crust. Platinum, gold, iridium and their relatives — the <GlossaryTerm slug="siderophile">siderophile</GlossaryTerm> elements — partition into liquid iron by factors of ten thousand or more, which is why Earth's crust is so poor in them relative to the bulk Earth — most of Earth's gold is in the core, unreachable. So a heavy, exotic phase concentrated in a *crust* at grades worth mining is not what differentiation produces by default. On Earth, ore deposits are the work of secondary processes: hydrothermal fluids, late magmatic sorting, or material delivered after the core had already finished forming. Unobtanium requires something of that kind. Canon offers no mechanism, and the physics of *what the mineral does* belongs to <ChapterRef slug="floating-mountains-and-the-superconductor" />. What belongs here is the plain statement that its concentration, not just its properties, is an unexplained problem.
</Callout>
...
<VolatileSourceFingerprint
  caption="Seawater's isotope ratio is a constraint, not a curiosity. Carbonaceous asteroid water sits essentially on top of it. Comet 67P, measured directly by the Rosetta spacecraft, is more than three times heavier — so the arithmetic caps comets at a couple of percent of the delivery before the blend overshoots the ocean we actually have. Nebular gas fails from the other direction. The suppliers are not a matter of taste."
/>
...
<Callout variant="note" title="One thing in that air that does not fit">
Canon's atmospheric inventory includes a slug of xenon at around five percent — an enormous figure for a heavy noble gas that on Earth is present at fractions of a part per million. Xenon is a genuine cosmochemical puzzle even here: Earth and Mars are both *depleted* in it relative to the meteorites they were built from, and the leading explanation is that xenon was preferentially ionised and dragged away during early atmospheric escape. A world that kept five percent of it needs the opposite history — a gentle young star, an unusual delivery, or a crust that later gave xenon back. I raise it because a formation chapter should own it, and set it down because canon offers nothing to resolve it, and what that air does to a body belongs to <ChapterRef slug="whats-in-the-air" />.
</Callout>

<DiagramFigure
  src="/images/chapters/from-stardust-to-pandora/fig-10-iron-rains-inward.webp"
  labels={[
    { x: 48, y: 50, side: "left", label: "Metal descending", note: "Molten iron and nickel are denser than the silicate melt, so they sink — and take gold and platinum with them." },
    { x: 48, y: 78, side: "right", label: "Core forming", note: "About a third of the body's radius, assembled in a few million years and still hot today." },
    { x: 62, y: 12, side: "right", label: "First atmosphere", note: "Gases dissolved in the melt escape through the crust: the air is outgassed, not inherited." }
  ]}
  alt="A cutaway of a young molten world with droplets of bright metal descending through a glowing orange interior toward a dense forming centre, and dark venting gas escaping the surface"
  figNo="10"
  caption="A newly assembled world is hot enough to sort itself. Metal descends, rock floats, and the gases dissolved in the melt escape upward to become the first atmosphere — which is why Pandora's derived density implies not merely heavy material but organised heavy material, and why its air is a product of its interior rather than a leftover of its birth cloud."
  tier="real_science"
/>
