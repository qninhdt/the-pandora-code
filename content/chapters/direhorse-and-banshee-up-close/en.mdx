...
That last detail deserves more than a passing mention, because "hollow" is doing a great deal of quiet work. Bone shot through with air spaces — **<GlossaryTerm slug="pneumatic-bone">pneumatic bone</GlossaryTerm>**, in the anatomist's word — is not weakened bone. A tube is not a weakened rod; at equal stiffness it is a *lighter* rod, because bending is resisted almost entirely by the material furthest from the centre, and everything near the axis is mass carried for nothing. Hollow the core out and the same rigidity survives on a fraction of the material — which is exactly why bird and pterosaur wing bones are thin-walled shells rather than solid struts, and why the banshee can afford to run cooling air through the middle of its own skeleton. But the saving is not free forever. Thin the wall far enough and the bone stops failing by bending and starts failing by crumpling, the way an empty can gives way underfoot.
...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 36, y: 66, side: "right", label: "Earth elephant", note: "Columnar gravitational pillars and dense solid bone required to support multi-ton mass at 1.0 g." },
    ...
    { x: 82, y: 68, side: "right", label: "Earth giant pterosaur (Quetzalcoatlus)", note: "Reached Earth's absolute biomechanical flight ceiling at roughly 10–11 m wingspan." }
  ]}
  figNo="03"
...
Notice what this does and does not say. Pandora did not produce a flying animal heavier than physics permits. The ikran weighs about what Earth's largest flyer weighed; it sits at the ceiling, not above it. What changed is where the ceiling sits — far enough that an animal of that mass can not merely glide but launch, climb, and haul a passenger, none of which <GlossaryTerm slug="quetzalcoatlus">Quetzalcoatlus</GlossaryTerm> could have done. The banshee is not a bigger animal than Earth allows. It is an Earth-limit animal living under kinder constants, with the slack spent on a rider.

<DiagramFigure
  src="/images/chapters/direhorse-and-banshee-up-close/fig-06-two-giant-launches.webp"
  alt="A matched comparative launch study: on the left, Quetzalcoatlus performing an explosive quadrupedal vault on an open Cretaceous plain; on the right, a mountain banshee with a Na'vi rider launching from a Pandoran cliff into open air"
  labels={[
    { x: 26, y: 46, side: "left", label: "Quetzalcoatlus quadrupedal launch", note: "Earth's giant pterosaur relied on explosive quadrupedal pole-vaulting from folded forelimb wing spars to clear the ground." },
    { x: 74, y: 44, side: "right", label: "Banshee cliff-drop launch", note: "Pandora's lower gravity (0.8 g) and denser atmosphere allow rapid wing deployment and immediate positive climb with a rider." },
    { x: 50, y: 20, side: "left", label: "Comparative launch physics", note: "Both animals represent peak flight mass (~200–250 kg), but divergent atmospheric constants dictate completely different launch physics." }
  ]}
  figNo="06"
  caption="Two giant launches across two worlds. Quetzalcoatlus had to vault explosively off all four limbs on level ground; the banshee drops from cliff perches into dense air, trading altitude for instant airspeed and carrying a rider aloft."
  tier="inference"
/>
