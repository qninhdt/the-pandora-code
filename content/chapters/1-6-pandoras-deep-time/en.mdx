<DiagramFigure
  ...
  labels={[
    { x: 49, y: 46, side: "left", label: "Glowing core", note: "First crystallization — the oldest age" },
    { x: 63, y: 30, side: "right", label: "Paler overgrowth rim", note: "A later, violent event" }
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    { x: 58, y: 11, side: "left", label: "Youngest layers on top" },
    { x: 70, y: 43, side: "left", label: "Datable volcanic ash band", note: "Pins absolute years onto the sequence" },
    { x: 50, y: 71, side: "left", label: "Oldest layers beneath" },
    { x: 35, y: 82, side: "right", label: "Geologist — for scale" }
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 38, y: 66, side: "left", label: "Molten young Pandora" },
    { x: 56, y: 42, side: "right", label: "Mars-sized impactor" },
    { x: 14, y: 28, side: "right", label: "Polyphemus's magnetic field", note: "Where the impact forges unobtanium" },
    { x: 88, y: 60, side: "left", label: "Polyphemus (gas giant)" }
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  labels={[
    { x: 37, y: 57, side: "left", label: "Core — first crystallization", note: "The oldest, undisturbed age" },
    { x: 56, y: 40, side: "right", label: "Concentric growth bands" },
    { x: 71, y: 31, side: "right", label: "Overgrowth rim", note: "Regrown at the impact — a younger age" }
  ]}
/>
...
<DiagramFigure
  ...
  labels={[
    { x: 31, y: 58, side: "left", label: "Pandora — flexed by tides" },
    { x: 47, y: 40, side: "left", label: "Stretched toward Polyphemus", note: "Flexing churns the interior to heat" },
    { x: 80, y: 26, side: "left", label: "Polyphemus's gravity" }
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  labels={[
    { x: 24, y: 42, side: "right", label: "Dead rock record", note: "Read fossil by fossil (Earth)" },
    { x: 72, y: 16, side: "left", label: "Pandora's living archive" },
    { x: 64, y: 52, side: "left", label: "Neural roots hold deep memory" },
    { x: 88, y: 74, side: "left", label: "Life preserved, still glowing" }
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 20, y: 46, side: "right", label: "Six separate limbs", note: "The presumed ancestral large-animal pattern keeps each limb attached independently." },
    { x: 52, y: 42, side: "right", label: "Prolemuris bridge", note: "Each upper arm forks into paired forearms, a visible intermediate between six and four." },
    { x: 82, y: 42, side: "left", label: "Four-limbed Na'vi", note: "The final body plan has two arms and two legs, but the proposed route remains an inference." },
  ]}
  figNo="07"
...
<DiagramFigure
  ...
  labels={[
    { x: 18, y: 55, side: "right", label: "Earth: body tracks habitat", note: "Across deep time, changing environments and changing bodies travel together." },
    { x: 42, y: 55, side: "right", label: "A lineage in motion", note: "The sequence changes form rather than preserving one fixed silhouette." },
    { x: 77, y: 55, side: "left", label: "Pandora: repeated form", note: "The Na'vi silhouette stays constant while fire, mountain, and forest replace one another." },
    { x: 78, y: 84, side: "left", label: "The stabilizing network", note: "A continuous luminous root mesh is the proposed mechanism behind the apparent stasis." },
  ]}
  figNo="08"
