...
<DiagramFigure
  ...
  labels={[
    { x: 20, y: 46, side: "right", label: "Sáu chi tách biệt", note: "Mẫu hình tổ tiên giả định ở động vật lớn giữ mỗi chi gắn độc lập." },
    { x: 52, y: 42, side: "right", label: "Cây cầu Prolemuris", note: "Mỗi cánh tay trên chẻ thành hai cẳng tay, một trung gian nhìn thấy giữa sáu và bốn chi." },
    { x: 82, y: 42, side: "left", label: "Na'vi bốn chi", note: "Kế hoạch cuối có hai tay và hai chân, nhưng con đường đề xuất vẫn là suy luận." },
  ]}
  figNo="07"
...
<DiagramFigure
  ...
  labels={[
    { x: 18, y: 55, side: "right", label: "Trái Đất: cơ thể đi cùng sinh cảnh", note: "Qua thời gian sâu, môi trường đổi và cơ thể cũng đổi theo." },
    { x: 42, y: 55, side: "right", label: "Một dòng dõi đang chuyển", note: "Chuỗi hình thay đổi hình thái thay vì giữ nguyên một bóng dáng." },
    { x: 77, y: 55, side: "left", label: "Pandora: hình thể lặp lại", note: "Bóng Na'vi giữ nguyên trong khi lửa, núi và rừng thay nhau xuất hiện." },
    { x: 78, y: 84, side: "left", label: "Mạng lưới ổn định hóa", note: "Mạng rễ phát sáng liên tục là cơ chế được đề xuất cho sự tĩnh tại bề ngoài." },
  ]}
  figNo="08"
