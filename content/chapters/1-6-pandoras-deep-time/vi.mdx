...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 35.5, y: 86, side: "right", label: "Nhà địa chất làm thước đo tỉ lệ", note: "Tỉ lệ con người làm nổi bật sự bồi tụ địa tầng khổng lồ qua thời gian sâu." }
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 58, side: "left", label: "Pandora bị kéo dãn do lực triều", note: "Gradien hấp dẫn làm biến dạng mặt trăng thành hình phỏng cầu thuôn dài như quả trứng." },
    { x: 38, y: 50, side: "left", label: "Bướu triều hướng về Polyphemus", note: "Vết nứt magma cực đại xuất hiện ở phần đầu đối diện hành tinh dưới ứng suất chu kỳ." },
    { x: 75, y: 30, side: "right", label: "Giếng hấp dẫn Polyphemus", note: "Khối lượng hành tinh khổng lồ không ngừng nhào nặn lòng sâu Pandora bằng lực triều." }
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  alt="Hai đoàn hình thể tiến qua thời gian sâu: một dòng dõi Trái Đất thay đổi cơ thể và môi trường qua bốn chặng, đặt cạnh bốn hình người Na'vi giống hệt nhau giữa những cảnh quan Pandora đổi khác phía trên một mạng rễ liên tục"
  labels={[
...
<OpenQuestions
  ...
  items={[
    ...
    },
    {
      ...
      answer: "Chiếu theo mọi quy luật nhiệt động lực học, một thiên thể có kích thước như Pandora — với phần lõi bị xé toạc bởi một vụ va chạm cổ xưa — đáng lẽ đã phải nguội lạnh và rơi vào câm lặng từ lâu. Sự gia nhiệt thủy triều từ Polyphemus là câu trả lời khả dĩ nhất, nhưng nó đòi hỏi một quỹ đạo lệch tâm được duy trì nhờ sự cộng hưởng với các mặt trăng khác. Nguyên tác không hề đề cập đến những mặt trăng anh em như vậy, do đó cỗ máy nhiệt này là kết quả suy luận từ các định luật vật lý chứ không phải một sự thật được nêu rõ."
    },
    {
