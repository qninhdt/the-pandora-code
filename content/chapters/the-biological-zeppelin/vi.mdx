...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 16, side: "right", label: "Vòm túi khí", note: "Vòm chuông bán trong suốt chứa khí hydro do trao đổi chất tạo ra" },
    { x: 50, y: 28, side: "right", label: "Vành cảm quan quanh mép", note: "Vòng thụ quang ở đường xích đạo quan sát mặt đất bên dưới" },
    { x: 30, y: 54, side: "left", label: "Khoang treo (gondola)", note: "Sàn giỏ bện dành cho hoa tiêu Na'vi và hàng hóa" },
    { x: 30, y: 80, side: "right", label: "Xúc tu buông dài", note: "Rèm xúc tu phóng điện quét qua không khí để làm choáng và bắt con mồi" }
  ]}
  figNo="01"
...
Mọi sinh vật bay mà chúng ta từng khảo sát đều là một cỗ máy giải quyết một phương trình duy nhất: tạo ra đủ <GlossaryTerm slug="lift">lực nâng</GlossaryTerm> để triệt tiêu trọng lượng bản thân, và chi trả cho lực nâng đó bằng cơ bắp, từng giây từng phút, mãi mãi. Ngừng trả giá và bạn rơi xuống đất. Đó là bản chất của *sự bay*, trên Trái Đất cũng như trên Pandora, đối với mọi loài chim, dơi, banshee và chính loài toruk vĩ đại.
...
Sự phân biệt đó nghe có vẻ câu nệ ngôn từ nhưng thực chất mang tính quyết định. Nó phân định ranh giới giữa việc hiểu bản chất <GlossaryTerm slug="aerostat">khí cầu</GlossaryTerm> (aerostat) và việc lặp lại một nhận định sai lầm phổ biến: Khí hydro có khối lượng mol bằng một nửa khí heli, nên một quả bóng hydro sẽ nâng được khối lượng gấp đôi. Hai gam mỗi mol so với bốn gam — hẳn phải nâng gấp đôi?
...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 75, y: 52, side: "right", label: "Mạng lưới phân tán tải trọng", note: "Dây treo dây xích (catenary) trải tải trọng thành lực căng dạng đường dọc thành vỏ" },
...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 65, y: 45, side: "left", label: "Khí cầu sinh học Pandora", note: "Túi khí khổng lồ nổi lên nhờ hiệu số khối lượng riêng với không khí đậm đặc của Pandora" },
...
<DiagramFigure
  ...
  labels={[
    { x: 43, y: 78, side: "right", label: "Bể lên men kỵ khí", note: "Vi sinh vật cộng sinh lên men con mồi đã ăn để sinh ra H₂" },
...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 52, y: 20, side: "left", label: "Vòm khí bán trong suốt", note: "Sáng lên nhờ ánh sáng xuyên qua chứ không phải phát quang — khí nâng không đổi khi dâng cao" },
    { x: 32, y: 53, side: "left", label: "Các khoang treo ngoại vi", note: "Bể nước của thủy thủ đoàn có thể trút bỏ để dâng cao ngay lập tức" }
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 20, y: 72, side: "right", label: "Windray dẫn đầu", note: "Chỉ cung cấp lực kéo ngang và định hướng, không cung cấp lực nâng nào" },
    { x: 77, y: 36, side: "left", label: "Khí cầu được lai dắt", note: "Cung cấp toàn bộ lực nâng, và mang theo 46 tấn không khí bị cuốn theo cần phải bẻ hướng" },
    { x: 48, y: 52, side: "right", label: "Dây kéo căng", note: "Sợi thực vật bện truyền lực kéo của đàn thú vào hệ dây chằng" },
    { x: 16, y: 28, side: "right", label: "Vòng cung cắt gió", note: "Bay ngang hướng gió thay vì bay thẳng giúp nhân lực kéo của mỗi con thú" }
  ]}
  figNo="07"
...
<DiagramFigure
  ...
  labels={[
    { x: 56, y: 12, side: "right", label: "Cột lửa bốc lên", note: "Ngọn lửa hydro bốc vút lên xa khỏi túi khí thay vì trút xuống" },
    { x: 52, y: 75, side: "left", label: "Bếp lửa trên khoang treo", note: "Bếp lửa hở được giữ ở vị trí thấp hẳn bên dưới túi khí" },
    { x: 52, y: 42, side: "right", label: "Túi chứa khí dễ cháy", note: "Hydro bắt cháy trong dải nồng độ rất rộng và gần như không cần tia lửa" },
    { x: 10, y: 53, side: "right", label: "Hộ tống Windray", note: "Đàn thú kéo giữ hướng bay khi túi khí phía trên bốc cháy" }
  ]}
  figNo="08"
...
<ClaimAudit
  rungs={[
    ...
    },
    {
      ...
      verdict: "well-supported",
      evidence: "Lập luận định luật bình phương – lập phương là toán học cơ bản và bán kính hòa vốn được tính toán trực tiếp. Nó cũng dự đoán chính xác sự vắng bóng của sinh vật khí cầu nhỏ trên Trái Đất.",
