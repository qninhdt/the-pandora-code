...
<DiagramFigure
  ...
  labels={[
    { x: 42, y: 56, side: "left", label: "Bifurcated forelimbs", note: "A single upper arm divides into paired hands — a possible developmental clue, not proof of a six-to-four transition." },
    { x: 55, y: 12, side: "right", label: "Single occipital queue", note: "A single queue is present; its evolutionary relationship to the Na'vi remains unresolved." },
    { x: 84, y: 38, side: "right", label: "Na'vi bipedal silhouette", note: "Background comparison suggests a possible trajectory toward four-limbed arboreal bipedalism; direct ancestry is unconfirmed." },
    { x: 18, y: 36, side: "left", label: "Six-limbed comparison form", note: "Background creature displays standard unreduced six-limbed quadrupedal build." }
  ]}
  alt="A painted study of a prolemuris in the canopy, emphasising its bifurcated forelimb that splits into two only near the hands and its single neural queue, posed between a small six-limbed forest creature on one side and a tall four-limbed Na'vi silhouette on the other as a visual comparison, not proof of a direct transition"
  figNo="07"
  caption="A radiation caught mid-step. The prolemuris carries a single upper arm that bifurcates into two forearms, and a single neural queue where its neighbours have two. The anatomy is suggestive of a living intermediate between Pandora's deep six-limbed stock and the four-limbed Na'vi, but canon does not establish a direct ancestral line."
  tier="inference"
/>
...
<RelatedChapters
  slugs={["six-limbs-and-the-bilateral-lattice", "pandoran-tree-of-life", "what-is-pandoran-life-made-of", "the-hunters-and-the-hunted"]}
  locale="en"
/>
