...
<TierLegend
  ...
  tiers={[
    {
      kind: "canon",
      gloss: "Shown directly on screen: the rideable mountain banshee, the colossal toruk, their cliff-launching and broad membranous wings.",
      realWorld: "A primary source — something you can point to and replay.",
      example: "The Na'vi break and ride banshees; the toruk is the apex predator of the Pandoran sky."
    },
    {
      kind: "inference",
      gloss: "The bridge we build: Pandora's ~0.8 g and denser air are what slide the flight ceiling up far enough to seat a banshee.",
      realWorld: "Applying a known law to a new case and reading off the result.",
      example: "Lower gravity plus thicker air move the power-curve crossing to a heavier mass — a Quetzalcoatlus-class flier becomes rideable."
    },
    {
      kind: "speculation",
      gloss: "Plausible but unconfirmed: exact banshee mass, carbon-fibre bones, double-force muscle, a xenon-laced atmosphere.",
      realWorld: "A reasonable guess that fills a gap canon never closes.",
      example: "Community wikis quote a 1.5-tonne banshee; the physics says a far lighter mass, or the wing loading is impossible."
    },
    {
      kind: "real_science",
      gloss: "Verifiable Earth science, none of it invented for this book.",
      realWorld: "Textbook flight biomechanics and palaeontology.",
      example: "The square-cube law, wing loading, the Pennycuick/Marden power ceiling, Reynolds regimes, Habib's quadrupedal launch."
    }
  ]}
/>
