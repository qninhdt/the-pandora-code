<DiagramFigure
  ...
  labels={[
    { x: 30, y: 22, side: "left", label: "Màng cánh chính khổng lồ", note: "Sải cánh vượt 20 m — màng khí động rộng lớn tạo lực nâng lớn trong bầu khí quyển đậm đặc." },
    { x: 26, y: 68, side: "left", label: "Mỏm đá phóng mình", note: "Lao khỏi một vách dựng biến độ cao rơi thành tốc độ bay ban đầu, không cần quãng chạy lấy đà." },
    { x: 74, y: 82, side: "left", label: "Kỵ sĩ banshee làm hệ quy chiếu", note: "Một kỵ sĩ ikran ở xa cho thấy quy mô khổng lồ của kẻ săn mồi đỉnh bảng." }
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    { x: 12, y: 18, side: "left", label: "Ngón cái mang vuốt", note: "Ngón cái tự do mang vuốt giúp bám leo vách đá và trụ lực để phóng mình cất cánh." },
    { x: 46, y: 22, side: "right", label: "Thanh xương mép trước", note: "Xương tay rỗng chủ đạo đóng vai trò dầm kết cấu chính của cả bộ máy bay." },
    { x: 42, y: 52, side: "left", label: "Màng cánh giàu mạch máu", note: "Tấm màng da căng cung cấp diện tích nâng rộng lớn với khối lượng kết cấu tối thiểu." },
    { x: 82, y: 76, side: "left", label: "Lõi xương composite", note: "Các giằng xốp bên trong tạo độ cứng chống uốn cao mà không phải trả giá bằng xương đặc." }
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 48, side: "left", label: "Cánh xẻ rãnh mở rộng", note: "Các phần tử ngoài tách rời làm chậm hiện tượng mất lực nâng khi lượn ở tốc độ thấp." },
    { x: 75, y: 48, side: "right", label: "Lưỡi cánh vuốt kín", note: "Cánh gập sát và bịt kín giảm lực cản ký sinh cho những cú bổ nhào và truy đuổi tốc độ cao." },
    { x: 50, y: 50, side: "right", label: "Hai chế độ bay", note: "Biến đổi hình dạng cánh giúp cùng một kết cấu khí động phục vụ nhiều dải tốc độ." }
  ]}
  figNo="07"
...
<DiagramFigure
  ...
  labels={[
    { x: 8, y: 38, side: "right", label: "Rào cản cất cánh cao (Trái Đất)", note: "Không khí loãng và trọng lực 1,0 g đòi hỏi tốc độ bay cao trước khi cánh bám được vào không khí." },
    { x: 61, y: 53, side: "right", label: "Rào cản cất cánh thấp hơn (Pandora)", note: "Trọng lực thấp hơn (0,8 g) và không khí đặc khoảng 1,2 lần Trái Đất cắt giảm tốc độ cần thiết để bay." },
    { x: 65, y: 80, side: "left", label: "Đồng hồ mật độ khí quyển", note: "Mật độ chất lưu cao hơn làm tăng áp suất động, nhân lên lực nâng sinh ra trên mỗi nhịp cánh." }
  ]}
  figNo="04"
