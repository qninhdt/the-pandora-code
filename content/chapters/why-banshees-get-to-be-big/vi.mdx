<DiagramFigure
  ...
  labels={[
    { x: 30, y: 22, side: "left", label: "Màng cánh Toruk", note: "Diện tích cánh khổng lồ tạo lực nâng lớn trong bầu khí quyển đậm đặc" },
    { x: 26, y: 68, side: "left", label: "Luồng nâng sơn văn", note: "Gió thung lũng va đập vào vách đá tạo luồng nâng thẳng đứng" },
    { x: 74, y: 82, side: "left", label: "Banshee đang vỗ cánh", note: "Kỵ sĩ Ikran nhỏ bé minh họa tương quan kích thước vượt trội của Toruk" }
  ]}
  figNo="01"
...
<DiagramFigure
  src="/images/chapters/why-banshees-get-to-be-big/fig-05-wing-loading-ladder.webp"
  alt="Ba màn cất cánh cho thấy tải trọng cánh tăng dần: chim sẻ rời cành cây, thiên nga chạy một quãng dài trên mặt nước, còn dực long khổng lồ phải lao xuống theo triền dốc"
  labels={[
    { x: 17, y: 50, side: "left", label: "Chim sẻ: cất cánh tức thì", note: "Kích thước nhỏ cho phép gia tốc tức thì từ mặt đất phẳng" },
    { x: 42, y: 61, side: "left", label: "Thiên nga: đà chạy mặt nước", note: "Khối lượng lớn cần quãng chạy lấy đà tạo vận tốc cất cánh" },
    { x: 78, y: 48, side: "right", label: "Dực long: phóng dốc nghiêng", note: "Tận dụng độ dốc và lực đẩy chi trước để đạt lực nâng" }
  ]}
  figNo="05"
  caption="Tải trọng cánh lộ rõ nhất vào lúc cất cánh. Chim sẻ gần như muốn rời cành lúc nào cũng được; thiên nga phải mua tốc độ bằng một đường chạy dài tung nước; dực long khổng lồ cần triền dốc, gió ngược hoặc cú phóng mạnh trước khi cánh đủ sức mang cơ thể. Lớn lên không chỉ phóng to cùng một động tác. Nó buộc con vật phải đổi hẳn cách bước vào bầu trời."
  tier="real_science"
/>
...
<DiagramFigure
  src="/images/chapters/why-banshees-get-to-be-big/fig-06-earths-flight-ceiling.webp"
  alt="Một con Quetzalcoatlus cao ngang hươu cao cổ đứng bằng bốn chi và hé mở cánh màng khổng lồ, để lộ thân mình rất gọn nằm giữa những xương cánh dài, nhẹ"
  labels={[
    { x: 28, y: 62, side: "left", label: "Khung cánh siêu nhẹ", note: "Kiến trúc khoang xốp rỗng tối ưu hóa tỉ lệ sức bền trên trọng lượng" },
    { x: 66, y: 52, side: "right", label: "Khối lượng tập trung", note: "Trọng tâm dồn về gần gốc cánh tạo sự ổn định khí động" },
    { x: 89, y: 79, side: "right", label: "Tỉ lệ người so sánh", note: "Hình bóng con người minh họa quy mô sải cánh khổng lồ" }
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 44, y: 32, side: "left", label: "Cú nhảy chi sau của chim", note: "Chim bật nhảy bằng chân sau, mang theo cơ bắp nặng nề như tải trọng chết suốt chuyến bay." },
    { x: 43, y: 76, side: "left", label: "Cú phóng chi trước của Dực long", note: "Dực long phóng thẳng bằng cánh trước, hợp nhất động cơ phóng và động cơ bay thành một." },
    { x: 82, y: 68, side: "right", label: "Động cơ bay tích hợp", note: "Sinh vật bay khổng lồ của Pandora áp dụng chiến lược phóng chi trước để vượt giới hạn kích thước Trái Đất." }
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  labels={[
    { x: 12, y: 18, side: "left", label: "Clawed launch thumb", note: "Free thumb claw provides cliff mobility and grip for vaulting into flight." },
    { x: 46, y: 22, side: "right", label: "Leading-edge spar", note: "The primary hollow arm-bone acts as the main structural beam of the flight engine." },
    { x: 42, y: 52, side: "left", label: "Vascularized membrane", note: "Tensioned leathery sheet provides extensive lifting area at minimal structural mass." },
    { x: 82, y: 76, side: "left", label: "Composite bone core", note: "Internal porous trabeculae create high bending stiffness without solid mass penalty." }
  ]}
  figNo="02"
...
<DiagramFigure
  src="/images/chapters/why-banshees-get-to-be-big/fig-07-two-toruk-wings.webp"
  alt="Cùng một cánh toruk ở hai cấu hình: xòe rộng với các phiến tách thành khe để lượn chậm, rồi quét về sau và khép kín thành lưỡi cánh trơn cho cú bổ nhào"
  labels={[
    { x: 25, y: 48, side: "left", label: "Cánh xẻ rãnh mở rộng", note: "Rãnh lông đầu cánh triệt tiêu xoáy đầu cánh ở tốc độ thấp" },
    { x: 75, y: 48, side: "right", label: "Lưỡi cánh vuốt nhọn", note: "Cánh vuốt ngược giảm lực cản sóng ở tốc độ hành trình cao" },
    { x: 50, y: 50, side: "right", label: "Hai chế độ bay", note: "Khả năng chuyển đổi hình dạng cánh linh hoạt theo yêu cầu lực nâng" }
  ]}
  figNo="07"
  caption="Một chiếc cánh, hai chế độ tốc độ. Khi xòe rộng và tách các phiến ngoài, toruk có bề mặt đầy khe giúp trì hoãn cú thất tốc ở tốc độ thấp mà một cơ thể khổng lồ không chịu nổi. Khi quét chính các phiến ấy về sau và khép mép lại, cánh trở thành một lưỡi gọn hơn cho cú bổ nhào. Tư liệu mô tả giải phẫu này tự tin hơn mức nguyên tác cho phép, nhưng bài toán khí động học mà nó cố giải là có thật."
  tier="inference"
/>
...
<DiagramFigure
  src="/images/chapters/why-banshees-get-to-be-big/fig-08-vortex-over-a-wing.webp"
  alt="Phấn hoa phát sáng làm lộ một ống xoáy sít trên mép trước cánh ong, trong khi cánh ép một lớp không khí rộng hơn xuống dưới"
  labels={[
    { x: 53, y: 28, side: "right", label: "Xoáy mép trước (LEV)", note: "Xoáy khí bám trên mép trước tạo áp suất hút nâng cánh bổ sung" },
    { x: 68, y: 62, side: "right", label: "Dải xoáy hạ lưu", note: "Dòng khí thổi xuống dưới truyền động lượng nâng cơ thể" },
    { x: 30, y: 52, side: "left", label: "Khớp bản lề gốc cánh", note: "Khớp cánh chịu tải trọng xoắn cao khi vỗ cánh tạo xoáy" }
  ]}
  figNo="08"
  caption="Con ong chưa từng phá luật khí động học; nó chỉ dùng phần khí động học mà phép tính cánh cố định đã bỏ sót. Trong mỗi nhịp vỗ, một xoáy nhỏ bám ngay trên mép trước, giữ vùng áp suất thấp ổn định khi cánh hất không khí xuống. Ở quy mô côn trùng, túi khí quay ấy không phải nhiễu loạn cần tránh. Nó là một phần của bề mặt tạo lực nâng."
  tier="real_science"
/>
...
<DiagramFigure
  ...
  labels={[
    { x: 8, y: 38, side: "right", label: "Giới hạn cất cánh Trái Đất", note: "Tốc độ cất cánh tối thiểu cao đòi hỏi sải chạy dài hoặc vách dốc" },
    { x: 61, y: 53, side: "right", label: "Lực nâng tăng cường Pandora", note: "Khí quyển đặc hơn 20% và trọng lực 0.8g giảm tốc độ cất cánh cần thiết" },
    { x: 65, y: 80, side: "left", label: "Mật độ khí quyển", note: "Khí quyển chứa xenon tạo đệm khí dày đặc giúp sinh vật lớn bay lượn" }
  ]}
  figNo="04"
