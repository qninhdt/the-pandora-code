...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 61, y: 53, side: "right", label: "Lực nâng tăng cường Pandora", note: "Khí quyển đặc hơn 20% và trọng lực 0,8 g giảm tốc độ cất cánh cần thiết" },
