...
<DiagramFigure
  ...
  labels={[
    { x: 8, y: 38, side: "right", label: "High takeoff barrier (Earth)", note: "Thin air and 1.0 g gravity demand high airspeed before wings can bite and lift." },
    { x: 61, y: 53, side: "right", label: "Lower takeoff barrier (Pandora)", note: "Lower gravity (0.8 g) and air ~1.2x Earth's density slash the velocity needed to fly." },
