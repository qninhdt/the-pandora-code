...
The reason is the square-cube law, which <ChapterRef slug="direhorse-and-banshee-up-close" /> works through on the ground: weight comes from a volume and climbs with the cube of size, while a wing is a surface and climbs only with the square. Eight against four. On land that law dictates what a leg bone must be made of. In the air it dictates something harsher, because the wing cannot simply be thickened the way a femur can — and the quantity where that harshness shows up has a name worth carrying through the rest of this chapter.
