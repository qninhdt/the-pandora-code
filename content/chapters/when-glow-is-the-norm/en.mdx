<DiagramFigure
  ...
  labels={[
    { x: 58, y: 66, side: "right", label: "Mechanoluminescent shockwave", note: "Step pressure deforms cell membranes, flooding luciferase with calcium to ignite instant cold light." },
    { x: 42, y: 42, side: "left", label: "Na'vi plantar contact", note: "Broad elastic soles distribute impact force across a wide perimeter of reactive understory." },
    { x: 88, y: 36, side: "left", label: "Quiescent fungal flora", note: "Bioluminescent flora remain dark at rest, conserving metabolic energy until mechanically stimulated." }
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    { x: 57, y: 10, side: "right", label: "Downwelling moonlight", note: "Predators hunting in the mesopelagic zone scan upward for dark silhouettes against downwelling light." },
    { x: 28, y: 41, side: "left", label: "Counterilluminating squid", note: "Ventral photophores match downwelling radiance in intensity and color, cloaking the body from below." },
    { x: 73, y: 41, side: "right", label: "Uncloaked silhouette", note: "An unlit body casts a stark black shadow against the surface glow, exposing it immediately to predators." }
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 16, y: 44, side: "right", label: "Terrestrial firefly organ", note: "Enzymatic oxidation of luciferin with ATP produces cold light at near 100% thermal efficiency for courtship." },
    { x: 73, y: 58, side: "left", label: "Marine dinoflagellate surf", note: "Mechanical shear stress from crashing waves triggers cellular bioluminescent flashes in plankton blooms." }
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  labels={[
    { x: 19, y: 34, side: "right", label: "Abyssal pelagic light", note: "In Earth's deep ocean, over 75% of taxa utilize bioluminescent lures, photophores, and alarms." },
    { x: 74, y: 36, side: "left", label: "Terrestrial firefly flyer", note: "On Earth's land, glow is restricted to isolated evolutionary niches like fireflies and click beetles." },
    { x: 84, y: 85, side: "left", label: "Saprophytic foxfire", note: "Fungal mycelia glowing on decaying logs represent one of the few stationary terrestrial emitters." }
  ]}
  figNo="04"
...
<DiagramFigure
  ...
  labels={[
    { x: 16, y: 28, side: "right", label: "Luminous forest understory", note: "When the jungle floor glows, pure darkness becomes conspicuous, reversing traditional camouflage rules." },
    { x: 32, y: 56, side: "right", label: "Bioluminescent camouflage", note: "Cyan stripes disrupt body margins, blending the predator seamlessly into the dappled light of the moss." },
    { x: 75, y: 42, side: "left", label: "Conspicuous dark silhouette", note: "A non-luminous body is instantly silhouetted against glowing fungi, exposing it to alert prey." }
  ]}
  figNo="07"
...
<DiagramFigure
  ...
  labels={[
    { x: 19, y: 34, side: "right", label: "Two-tone fern fronds", note: "Dichromatic crimson and cyan emission patterns guide specialized nocturnal pollinators." },
    { x: 77, y: 60, side: "left", label: "Lantern blossom", note: "High-concentration luciferase chambers act as brilliant nocturnal landing beacons." },
    { x: 41, y: 69, side: "left", label: "Vascular conduction vein", note: "Fluorescent nutrient channels pulse along ground runners to signal metabolic activity." }
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  labels={[
    { x: 53, y: 21, side: "right", label: "Cranial photophore constellation", note: "Unique geometric dot patterns across the brow provide individual and clan identification in darkness." },
    { x: 43, y: 37, side: "left", label: "Facial signaling tracks", note: "Photophores align along trigeminal nerve pathways for silent emotional and tactical signaling." },
    { x: 48, y: 78, side: "left", label: "Cervical array", note: "Branching light tracks down the neck maintain pack cohesion and line-of-sight during night hunts." }
  ]}
  figNo="02"
