<DiagramFigure
  ...
  labels={[
    { x: 58, y: 66, side: "right", label: "Sóng xung kích phát quang cơ học", note: "Lực ép từ bước chân làm biến dạng màng tế bào, giải phóng canxi vào luciferase để thắp sáng tức thì ánh sáng lạnh." },
    { x: 42, y: 42, side: "left", label: "Điểm tiếp xúc gan bàn chân Na'vi", note: "Lòng bàn chân rộng và đàn hồi phân tán lực tác động ra một chu vi rộng của thảm thực vật phản ứng bên dưới." },
    { x: 88, y: 36, side: "left", label: "Quần thể nấm ở trạng thái tĩnh", note: "Hệ thực vật phát quang giữ trạng thái tối khi nghỉ ngơi, bảo tồn năng lượng trao đổi chất cho đến khi bị kích thích cơ học." }
  ]}
  figNo="01"
...
<DiagramFigure
  src="/images/chapters/when-glow-is-the-norm/fig-06-counterillumination.webp"
  ...
  labels={[
    { x: 57, y: 10, side: "right", label: "Ánh trăng chiếu rọi từ trên xuống", note: "Các loài săn mồi ở tầng trung hải quét mắt nhìn lên để săn tìm bóng đen in hằn trên nền ánh sáng từ mặt nước rọi xuống." },
    { x: 28, y: 41, side: "left", label: "Mực chiếu sáng ngược", note: "Các photophore dưới bụng điều chỉnh cường độ và màu sắc khớp với ánh sáng từ trên dội xuống, che giấu cơ thể khỏi tầm nhìn từ bên dưới." },
    { x: 73, y: 41, side: "right", label: "Bóng đen không ngụy trang", note: "Một cơ thể không phát sáng sẽ tạo thành một bóng đen sắc nét trên nền sáng bề mặt, lập tức phơi bày trước mắt kẻ săn mồi." }
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 16, y: 44, side: "right", label: "Cơ quan phát sáng đom đóm trên cạn", note: "Phản ứng oxy hóa luciferin bằng enzyme cùng với ATP tạo ra ánh sáng lạnh với hiệu suất nhiệt gần 100% để gọi bạn tình." },
    { x: 73, y: 58, side: "left", label: "Sóng vi tảo hai roi biển", note: "Ứng suất cắt cơ học từ sóng vỗ kích hoạt các chớp sáng phát quang tế bào trong các đợt bùng phát sinh vật phù du." }
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  labels={[
    { x: 19, y: 34, side: "right", label: "Ánh sáng tầng biển sâu thẳm", note: "Dưới đại dương sâu thẳm của Trái Đất, hơn 75% loài sử dụng mồi nhử, photophore và chuông báo động phát quang sinh học." },
    { x: 74, y: 36, side: "left", label: "Đom đóm bay trên cạn", note: "Trên đất liền Trái Đất, sự phát sáng bị giới hạn trong các hốc sinh thái cô lập như đom đóm và bọ bổ củi." },
    { x: 84, y: 85, side: "left", label: "Nấm lân tinh hoại sinh", note: "Hệ sợi nấm phát sáng trên thân gỗ mục đại diện cho một trong số ít các nguồn phát quang tĩnh tại trên cạn." }
  ]}
  figNo="04"
...
<DiagramFigure
  src="/images/chapters/when-glow-is-the-norm/fig-07-luminous-background-pressure.webp"
  ...
  labels={[
    { x: 16, y: 28, side: "right", label: "Tầng dưới tán rừng phát quang", note: "Khi mặt thảm rừng phát sáng, bóng tối thuần túy trở nên lộ liễu, đảo ngược hoàn toàn các quy luật ngụy trang truyền thống." },
    { x: 32, y: 56, side: "right", label: "Ngụy trang phát quang sinh học", note: "Các sọc vằn lục lam phá vỡ đường nét cơ thể, giúp thú săn mồi hòa mình liền mạch vào những mảng sáng lốm đốm của rêu." },
    { x: 75, y: 42, side: "left", label: "Bóng tối lộ liễu", note: "Một cơ thể không phát sáng lập tức in bóng đen rõ rệt trên nền nấm rực sáng, tự phơi bày trước con mồi đang cảnh giác." }
  ]}
  figNo="07"
...
<DiagramFigure
  ...
  labels={[
    { x: 19, y: 34, side: "right", label: "Lá dương xỉ phát xạ nhị sắc", note: "Hoa văn phát xạ hai màu đỏ thẫm và lục lam dẫn đường cho các loài thụ phấn đêm chuyên biệt." },
    { x: 77, y: 60, side: "left", label: "Hoa lồng đèn", note: "Các buồng chứa luciferase nồng độ cao đóng vai trò như ngọn hải đăng hạ cánh rực rỡ trong đêm." },
    { x: 41, y: 69, side: "left", label: "Gân dẫn truyền mạch thực vật", note: "Các kênh dinh dưỡng huỳnh quang phát xung dọc theo thân bò sát đất để báo hiệu hoạt động trao đổi chất." }
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  labels={[
    { x: 53, y: 21, side: "right", label: "Chòm photophore vùng sọ trán", note: "Các hoa văn chấm sáng hình học độc bản trên trán giúp nhận diện cá nhân và thị tộc trong bóng tối." },
    { x: 43, y: 37, side: "left", label: "Đường tín hiệu biểu cảm khuôn mặt", note: "Các photophore xếp dọc đường đi của dây thần kinh sinh ba để phát tín hiệu cảm xúc và chiến thuật trong im lặng." },
    { x: 48, y: 78, side: "left", label: "Dải phát sáng vùng cổ", note: "Các vệt sáng phân nhánh dọc theo cổ giúp duy trì sự gắn kết bầy đàn và tầm nhìn thẳng trong các cuộc săn đêm." }
  ]}
  figNo="02"
