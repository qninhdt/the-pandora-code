<DiagramFigure
  ...
  labels={[
    { x: 38, y: 19, side: "right", label: "Cursorial runner skeleton", note: "Two pectoral limb pairs and one pelvic pair adapted for high-speed sprinting." },
    { x: 48, y: 44, side: "right", label: "Aerial flyer skeleton (Ikran)", note: "Four wing-spar struts and rear stabilizers built upon the same six-limb framework." },
    { x: 42, y: 78, side: "left", label: "Aquatic swimmer flippers (Ilu)", note: "Three distinct pairs of hydrofoil flippers modified from ancestral limb girdles." },
    { x: 19, y: 72, side: "left", label: "Carbon-lattice fenestrated bone", note: "Lightweight skeletal architecture reinforced by biological carbon-fiber weave." }
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    { x: 37, y: 28, side: "left", label: "Paired neural queues", note: "Dual temple braids for synaptic connection, conserved across all Pandoran clades." },
    { x: 67, y: 82, side: "right", label: "Six-limb hexapod bauplan", note: "Quadrupedal walking forelimbs plus hind legs maintain the ancestral body plan." },
    { x: 38, y: 25, side: "right", label: "Four eyes in two pairs", note: "Primary visual and secondary multispectral optical organs present across clades." },
    { x: 78, y: 28, side: "left", label: "Wing-integrated hexapod", note: "Aerial predators modify forelimb pairs into wing spars without losing the six-limb count." }
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 26, side: "left", label: "Colinear Hox cluster", note: "Spatial order of genes along the chromosome mirrors the anterior-posterior body axis." },
    { x: 13, y: 66, side: "left", label: "Anterior / head identity", note: "3' Hox genes specify head and thoracic structures early in development." },
    { x: 88, y: 64, side: "right", label: "Posterior / caudal identity", note: "5' Hox genes pattern abdominal and tail segments at the opposite extreme." }
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  alt="A fruit fly bearing complete red compound eyes not only on its head but also on one leg, one wing, and the base of an antenna, beside a small translucent mouse embryo"
  labels={[
    { x: 27, y: 38, side: "left", label: "Fly compound eye toolkit", note: "Drosophila genome provides structural genes that build a multi-faceted compound eye." },
    { x: 51, y: 68, side: "right", label: "Ectopic leg eye", note: "Expressing mouse Pax6 on the leg triggers complete compound eye morphogenesis." },
    { x: 58, y: 22, side: "right", label: "Ectopic wing eye", note: "Master selector genes act as binary ON-switches, directing local tissue to build native eyes." },
    { x: 84, y: 62, side: "left", label: "Mouse Pax6 regulator", note: "Translucent mouse embryo represents the conserved upstream genetic switch." }
  ]}
  figNo="06"
  caption="A mouse switch, a fly result. When the mouse version of Pax6 is activated on a fly's leg, wing, or antenna, the fly builds a complete compound eye at each site — not a mouse eye. The borrowed switch says where to build; the host's ancient local toolkit decides what an eye will be. Few experiments make deep homology more literal."
  tier="real_science"
/>
...
<DiagramFigure
  ...
  alt="A python with tiny paired pelvic spurs and vestigial pelvic bones compared with a smooth-bodied advanced snake, with an early snake embryo carrying small temporary limb buds below"
  labels={[
    { x: 26, y: 48, side: "left", label: "Python pelvic spurs & bones", note: "Basal snakes retain vestigial hind-limb bones and external cloacal claws." },
    { x: 75, y: 35, side: "right", label: "Derived limbless snake body", note: "Advanced colubroids and vipers possess complete limb suppression without skeletal remnants." },
    { x: 48, y: 80, side: "left", label: "Transient embryonic limb buds", note: "Limb buds form briefly during embryogenesis before regulatory enhancers (ZRS) halt outgrowth." }
  ]}
  figNo="07"
  caption="The limb toolkit is still there; the start command is not. A python preserves tiny pelvic spurs and internal hind-limb remnants where its programme was only partly suppressed, while more derived snakes leave no external trace. The embryo briefly reveals what the adult hides: evolution removed the activation of a limb, not every gene that knows how to make one."
  tier="real_science"
/>
...
<DiagramFigure
  ...
  labels={[
    { x: 20, y: 74, side: "left", label: "Single humerus base", note: "One upper arm articulates with the shoulder girdle from a single developmental limb bud." },
    { x: 37, y: 59, side: "left", label: "Bifurcating elbow junction", note: "Distal growth zone divides during morphogenesis into two distinct radial-ulnar branches." },
    { x: 76, y: 28, side: "right", label: "Dual independent hands", note: "Two fully articulated, clawed grasping forearms emerge from the bifurcated limb." }
  ]}
  figNo="04"
...
<DiagramFigure
  ...
  labels={[
    { x: 30, y: 48, side: "left", label: "Full ancestral hexapod lattice", note: "Six limbs, four eyes, paired neural queues, and flank breathing opercula." },
    { x: 74, y: 35, side: "right", label: "Na'vi derived tetrapod build", note: "Reduction to four limbs, two eyes, a single queue, and facial respiration." },
    { x: 65, y: 42, side: "right", label: "Vestigial ghost-limb positions", note: "Phantom limb loci illustrate where ancestral pectoral appendages were developmentally suppressed." }
  ]}
  figNo="05"
