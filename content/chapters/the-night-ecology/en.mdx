<DiagramFigure
  ...
  labels={[
    { x: 24, y: 25, side: "left", label: "Day shift roosting", note: "Diurnal flier returns to canopy perch as solar illumination begins to drop." },
    { x: 62, y: 51, side: "right", label: "Anticipatory retreat", note: "Herbivore seeks deep forest cover prior to total darkness, driven by circadian anticipation." },
    { x: 67, y: 72, side: "left", label: "Night shift predators", note: "Viperwolf pack mobilizes across the clearing as the ground comes alight." },
    { x: 26, y: 80, side: "left", label: "Bioluminescent floor", note: "Mycelial and moss glow carpets the ground but produces insufficient flux for visual entrainment." }
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  alt="Inside the same sealed dark cupboard, a mimosa opens its leaves, folds them hours later, then opens them again even though no sunlight has entered"
  labels={[
    { x: 23, y: 44, side: "left", label: "Open leaf posture", note: "Mimosa leaflets spread wide during subjective day in total constant darkness." },
    { x: 49, y: 46, side: "right", label: "Folded leaf posture", note: "Leaves collapse rhythmically hours later without any external light or temperature cue." },
    { x: 76, y: 44, side: "right", label: "Endogenous reopening", note: "Rhythm returns spontaneously, proving timing is generated from within." }
  ]}
  figNo="05"
  caption="De Mairan removed the day and the plant kept one. In a cupboard that supplied neither dawn nor dusk, the mimosa still opened, closed and opened again. A reflex cannot continue after its trigger has vanished. The persistence of the rhythm is the first clean evidence that the schedule is being generated inside the organism."
  tier="real_science"
/>
...
<DiagramFigure
  ...
  alt="Four states around one cell show a clock gene producing protein, the protein accumulating and returning to suppress the gene, then breaking down so production can begin again"
  labels={[
    { x: 28, y: 23, side: "left", label: "Gene transcription begins", note: "Clock gene produces messenger RNA and initiates protein synthesis." },
    { x: 72, y: 24, side: "right", label: "Cytoplasmic protein accumulation", note: "Target proteins build up in concentration within the cell over hours." },
    { x: 72, y: 72, side: "right", label: "Negative feedback inhibition", note: "Accumulated protein complex translocates into nucleus to shut down transcription." },
    { x: 28, y: 72, side: "left", label: "Protein degradation & reset", note: "Gradual clearance of repressor protein frees the promoter, restarting the cycle." }
  ]}
  figNo="06"
  caption="The clock is a delayed argument a gene has with its own product. The gene makes protein; the protein accumulates, returns to the nucleus and closes the gene; with production stopped, the protein is gradually cleared; the uncovered gene begins again. Nothing in the loop knows the hour. Its chemistry simply takes about a day to come home."
  tier="real_science"
/>
...
<DiagramFigure
  ...
  alt="The same blue light pulse reaches the same sleeper early and late in biological night, shifting an internal molecular cycle later in the first case and earlier in the second"
  labels={[
    { x: 18, y: 28, side: "left", label: "Early-night light pulse", note: "Short-wavelength light pulse given in early subjective night delays circadian phase." },
    { x: 50, y: 32, side: "right", label: "Subjective day dead zone", note: "Light stimulus delivered during subjective midday causes minimal phase shift." },
    { x: 82, y: 28, side: "right", label: "Late-night light pulse", note: "Light stimulus given in late subjective night advances the circadian phase." }
  ]}
  figNo="07"
  caption="A photon has no fixed instruction. Early in subjective night, the same blue pulse pushes the clock later; close to subjective dawn, it pulls the clock earlier; in the middle of biological day, it says almost nothing. Entrainment works because the correction changes sign with phase, nudging a wandering oscillator back toward the world from whichever side it has strayed."
  tier="real_science"
/>
...
<DiagramFigure
  ...
  alt="A cutaway from eye to brain separates the ordinary visual pathway to the rear cortex from sparse melanopsin retinal cells whose fibres end at the tiny paired master clock above the optic chiasm"
  labels={[
    { x: 30, y: 38, side: "left", label: "Photoreceptor layer", note: "Rods and cones capture spatial and chromatic data for high-resolution visual imaging." },
    { x: 54, y: 58, side: "left", label: "Retinohypothalamic tract", note: "Intrinsically photosensitive ganglion cells project blue-light signals directly to the clock." },
    { x: 56, y: 76, side: "right", label: "Suprachiasmatic nucleus (SCN)", note: "Paired master clock nuclei above the optic chiasm synchronize organism-wide circadian rhythms." },
    { x: 82, y: 36, side: "right", label: "Visual cortex pathway", note: "Main optic radiation carries image data to the primary visual cortex for conscious sight." }
  ]}
  figNo="08"
  caption="The retina houses two installations. Rods and cones send enough information rearward to build an image; sparse melanopsin cells send a far simpler report to the tiny master clock above the optic chiasm: how much blue-weighted light is arriving now. A body can lose image-forming vision and keep that second wire, remaining blind yet still able to set its day."
  tier="real_science"
/>
...
<DiagramFigure
  ...
  labels={[
    { x: 21, y: 13, side: "right", label: "Companion star", note: "Secondary stellar illumination creates an intense local point source for part of the year." },
    { x: 62, y: 22, side: "left", label: "Gas giant planetshine", note: "Broad, diffuse blue planetshine reflected from Polyphemus illuminates the night sky." },
    { x: 26, y: 87, side: "right", label: "Floor bioluminescence", note: "Localized ground glow is visually striking but provides minimal radiant energy to drive clocks." }
  ]}
  figNo="03"
...
The most visually spectacular part of the Pandoran night — the self-lit ground, the thing that makes the forest look like a nervous system after dark — is chronobiologically almost silent. It is far too dim to set a clock by. Meanwhile the two sources a visitor would barely register as "<GlossaryTerm slug="artificial-light-at-night">light at night</GlossaryTerm>," a reflecting gas giant and a distant orange companion star, are the ones bright enough to matter. What looks like the story isn't; what looks like background is.
</Callout>
...
<DiagramFigure
  ...
  labels={[
    { x: 72, y: 14, side: "left", label: "Day shift aerialist", note: "Diurnal fliers and grazers exploit open-sight daylight resources." },
    { x: 24, y: 27, side: "right", label: "Shared spatial substrate", note: "Same structural perches and forest floor are partitioned across time rather than space." },
    { x: 44, y: 85, side: "left", label: "Night shift pack", note: "Viperwolf pack stalks the identical clearing twelve hours later." },
    { x: 76, y: 78, side: "right", label: "Nocturnal ambush predator", note: "Quilled predator relies on tactile, acoustic, and olfactory sensory organs in darkness." }
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  alt="An early mammal under dinosaur shadows and a modern fox share large ears, whiskers and scenting snouts, while a daylight lizard between them carries a richer set of colour receptors"
  labels={[
    { x: 18, y: 52, side: "left", label: "Ancestral nocturnal mammal", note: "Tactile vibrissae and acoustic specialization compensated for Mesozoic night-living." },
    { x: 50, y: 50, side: "right", label: "Diurnal reptile vision", note: "Tetrachromatic cone mosaic retained full daylight spectral acuity." },
    { x: 82, y: 50, side: "right", label: "Modern mammal face", note: "Whiskers and blue-shifted dichromacy persist as legacy of the nocturnal bottleneck." },
    { x: 50, y: 87, side: "right", label: "Photoreceptor mosaic comparison", note: "Mammal retinas remain rod-dominated, while reptiles retain complex cone palettes." }
  ]}
  figNo="09"
  caption="If mammals spent their long apprenticeship under the night shift, they still wear the uniform. Whiskers, acute hearing and elaborate smell became generous investments; much of the ancestral colour system was allowed to go. The nocturnal-bottleneck hypothesis remains debated in its strictest form, but the sensory inheritance it is trying to explain is written plainly across modern mammal faces."
  tier="real_science"
/>
...
Mars has a day of 24.65 hours. The mismatch against a human clock is **thirty-nine minutes** — trivial, surely, less than the difference between a weekday and a weekend lie-in. And when NASA put mission-control teams on Mars time to operate the rovers, shifting their whole schedule forty minutes later each day, the teams were measurably damaged by it. Sleep loss accumulated. Vigilance degraded. More than half the personnel on Mars-time schedules suffered chronic fatigue and <GlossaryTerm slug="forced-desynchrony">demonstrable desynchrony</GlossaryTerm>. Getting people to function on a 24.65-hour day required deliberate clinical intervention: high-intensity blue-enriched light delivered at precisely calculated times, and melatonin administered before scheduled sleep. It worked, but only as managed medicine, not as adaptation.

<DiagramFigure
  src="/images/chapters/the-night-ecology/fig-10-living-on-mars-time.webp"
  alt="An exhausted rover operator works in a dark Earth control room beside a bright blue therapy panel while ordinary daylight outside and a prepared melatonin dose reveal the managed Mars-time protocol"
  labels={[
    { x: 14, y: 45, side: "left", label: "Blue-enriched light fixture", note: "High-intensity short-wavelength light entrains the suprachiasmatic nucleus." },
    { x: 35, y: 48, side: "left", label: "Desynchronized operator", note: "Chronic circadian drift erodes cognitive vigilance and metabolic stability." },
    { x: 80, y: 25, side: "right", label: "Exterior Earth daylight", note: "Natural 24.0-hour solar cycle conflicts with the artificial 24.65-hour operational schedule." },
    { x: 70, y: 85, side: "right", label: "Melatonin administration", note: "Exogenous melatonin phase-shifts sleep onset to stabilize the non-terrestrial workday." }
  ]}
  figNo="10"
  caption="Mars time was not a thought experiment. A day only thirty-nine minutes longer forced rover teams to walk their work around the Earth clock, losing sleep and vigilance as the schedule drifted. Precisely timed blue-enriched light and melatonin could hold them together, but as treatment. Pandora's extra one hundred and eight minutes asks almost three times as much from the same clock."
  tier="real_science"
/>
...
<DiagramFigure
  ...
  labels={[
    { x: 36, y: 4, side: "right", label: "Fixed habitat lighting", note: "Internal lighting held on strict 24-hour cycle across all five observation frames." },
    { x: 76, y: 11, side: "left", label: "Day one: in phase", note: "Subject's circadian sleep window coincides with exterior local night." },
    { x: 74, y: 50, side: "left", label: "Day three: phase drift", note: "Circadian mismatch drifts by nearly four hours relative to exterior sunrise." },
    { x: 78, y: 91, side: "left", label: "Day five: complete inversion", note: "Free-running biological clock forces deep sleep during exterior midday." }
  ]}
  figNo="04"
