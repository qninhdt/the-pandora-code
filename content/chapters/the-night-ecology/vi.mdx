<DiagramFigure
  ...
  figNo="01"
  caption="Nhật thực ban chiều buông xuống, và khu rừng được sang tay. Bầu trời tối đi đúng theo lịch trình; mặt đất đáp lại bằng thứ ánh sáng của riêng nó; một lớp sinh vật tĩnh lặng nhường chỗ cho một lớp khác bắt đầu thức giấc. Khung cảnh này trông như một phản xạ với bóng tối. Toàn bộ chương này là một nỗ lực nhằm làm rõ xem liệu có bất cứ thứ gì ở đây thực sự đang đếm nhịp thời gian hay không."
  tier="canon"
/>
...
Khi nhật thực buông xuống và bầy sói rắn ló dạng, có hai kịch bản hoàn toàn khác biệt có thể đang diễn ra, và nhìn từ bên ngoài, chúng giống hệt nhau.
...
<DiagramFigure
  ...
  alt="Một mặt cắt dọc cao của sườn rừng Pandora vào ban đêm cho thấy ba nguồn sáng không đồng đều xếp từ trời xuống đất: trên cùng là ngôi sao đồng hành nhỏ màu cam đỏ treo thấp trên đường chân trời, phủ một lớp ánh sáng ấm mỏng lên tầng tán trên; bên dưới nó là khối cong khổng lồ có vằn của một hành tinh khí được chiếu sáng dọc một rìa, trút xuống một tấm ánh sáng phản chiếu rộng màu trắng xanh lạnh phủ khắp các ngọn cây; và dưới cùng là thảm rừng tự phát ra thứ ánh sáng lục lam yếu ớt từ các sợi rễ, rêu và thảm nấm, rõ ràng là mờ nhạt nhất trong ba nguồn và chỉ vươn lên được vài xentimét trên thân cây."
  labels={[
    { x: 21, y: 13, side: "right", label: "Ngôi sao đồng hành", note: "Ánh sáng sao thứ cấp tạo ra một nguồn điểm mạnh tại chỗ trong một phần của năm." },
    { x: 62, y: 22, side: "left", label: "Ánh phản chiếu hành tinh khí", note: "Ánh sáng hành tinh màu xanh, rộng và tán xạ, phản chiếu từ Polyphemus thắp sáng bầu trời đêm." },
    { x: 26, y: 87, side: "right", label: "Phát quang thảm rừng", note: "Ánh sáng mặt đất tại chỗ gây ấn tượng thị giác mạnh nhưng cấp rất ít năng lượng bức xạ để chạy đồng hồ." }
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  labels={[
    { x: 72, y: 14, side: "left", label: "Kẻ bay ca ngày", note: "Sinh vật bay và ăn cỏ ban ngày khai thác nguồn tài nguyên cần tầm nhìn rộng" },
    ...
    { x: 44, y: 85, side: "left", label: "Đàn thú săn ban đêm", note: "Bầy sói rắn rình rập cùng khoảng rừng sau mười hai giờ" },
    { x: 76, y: 78, side: "right", label: "Thú săn phục kích đêm", note: "Kẻ săn mồi có các cơ quan cảm giác xúc giác, thính giác và khứu giác trong bóng tối" }
  ]}
  figNo="02"
...
Danh sách ca làm việc ban đêm chính là canon: bầy sói rắn, thanator và thằn lằn quạt cày đêm, con banshee, lục túc và prolemuris thì vào ca ngày, nhật thực ập tới lúc ban chiều và khu rừng tự thắp sáng khi điều đó xảy ra, người Na'vi thực hành các nghi lễ sau khi mặt trời lặn và đong đếm giờ giấc bằng vốn từ vựng của riêng họ — *trr* cho ngày, *txon* cho đêm, *trr-txon* cho cả một chu trình, *txon'ong* cho hoàng hôn. Chuyện một ngày dài hai mươi sáu giờ là canon. Và chuyện RDA giam giữ thứ ánh sáng Trái Đất ở trong nhà cũng thế.
...
Và có một vài chi tiết lượn lờ đâu đó xung quanh Pandora về độ sáng ban đêm — như các bội số chuẩn xác của sao đồng hành so với trăng rằm, thời lượng chính xác của nhật thực — lại lần theo các bộ sưu tập của cộng đồng thay vì nằm trên bất kỳ trang sách nào mà độc giả có thể lật kiểm. Hợp tình, hữu dụng để định hướng, nhưng không phải canon.
...
<OpenQuestions
  ...
  items={[
    ...
    {
      question: "Điều gì xảy ra với một chiếc đồng hồ khi mùa nhật thực chấm dứt?",
