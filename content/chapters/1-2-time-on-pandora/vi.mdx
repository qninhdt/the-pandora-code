...
<EclipseMechanics
  videoSrc="/videos/chapters/time-on-pandora/eclipse-tilt.mp4"
  caption="Bóng đen do độ nghiêng chi phối. Nếu quỹ đạo của Pandora nằm phẳng (trái), hành tinh mẹ sẽ chặn đứng mặt trời ở mỗi cuối ngày. Nhưng với quỹ đạo nghiêng (phải), mặt trời thường lướt qua dưới hoặc trên, và nhật thực chỉ xảy ra theo chu kỳ — hai lần một năm — khi mọi thứ thẳng hàng. Kéo thanh trượt để ngắm hai cơ chế."
  fallbackImg="/images/chapters/time-on-pandora/fig-04-eclipse-tilt-fallback.webp"
/>
...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 20, side: "right", label: "Những thập kỷ của hệ sao sáng", note: "Điểm sáng đồng hành thêm ánh ấm có hướng ngay cả khi mặt trời chính nằm dưới đường chân trời." },
    { x: 39, y: 58, side: "right", label: "Cùng một khoảng rừng", note: "Cây, con vật và mặt đất giữ nguyên để chỉ chiếc đồng hồ bầu trời thay đổi." },
    { x: 75, y: 20, side: "left", label: "Những thập kỷ của hệ sao tối", note: "Khi sao đồng hành rời xa, cùng một đêm chỉ còn ánh sao và phát quang sinh học." },
    { x: 81, y: 77, side: "left", label: "Biến đổi theo thang ký ức", note: "Khác biệt thị giác được đo bằng nhiều thập kỷ, không phải một mùa." },
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 58, y: 25, side: "right", label: "Lò nung thủy triều", note: "Quỹ đạo gần kéo giãn mặt trăng và biến năng lượng quỹ đạo thành nhiệt cùng biến dạng." },
    { x: 46, y: 53, side: "right", label: "Cùng hành tinh, khác đồng hồ", note: "Hai khung giữ hành tinh khí khổng lồ như nhau, chỉ thay đổi khoảng cách quỹ đạo." },
    { x: 78, y: 75, side: "left", label: "Khoảng cách có thể ở được", note: "Quỹ đạo rộng hơn để mặt trăng tròn, ướt và ít bị nung nóng dữ dội." },
  ]}
  figNo="07"
