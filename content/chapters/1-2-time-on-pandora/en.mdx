...
<OrbitClock
  ...
  caption="Day equals orbit. The moon keeps one face locked toward the planet at the centre, yet any point on its surface still wheels through sunlight and shadow as the moon rides once around — so the sun rises, sets, and rises again over a single orbit. Drag, or let it run."
/>
