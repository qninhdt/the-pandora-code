<DiagramFigure
  ...
  labels={[
    { x: 58, y: 18, side: "left", label: "Polyphemus, fixed all day", note: "the biggest thing in the sky never moves" },
    { x: 80, y: 40, side: "left", label: "The sun slides past behind it", note: "tell the time by the light, not the planet" },
    { x: 50, y: 82, side: "left", label: "Long amber shadows", note: "late afternoon — near enough to eclipse" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 52, y: 18, side: "left", label: "One orbit's slow loop", note: "Polyphemus drifts against the stars" },
    { x: 30, y: 45, side: "right", label: "East and west", note: "the moon speeds and slows on its oval path" },
    { x: 72, y: 42, side: "left", label: "North and south", note: "the moon's tilt nods its poles toward and away" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 52, y: 55, side: "left", label: "The planet's shadow cone", note: "a long cone of dark trailing away from the sun" },
    { x: 78, y: 42, side: "left", label: "Riding above the shadow", note: "eclipse-free season — the sun is never blocked" },
    { x: 80, y: 72, side: "left", label: "Threading the shadow", note: "the daily-eclipse season" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 30, y: 38, side: "right", label: "One turn against the stars", note: "the sidereal day, complete" },
    { x: 62, y: 62, side: "left", label: "The little extra", note: "spin a touch further to bring the sun back overhead" },
    { x: 88, y: 15, side: "left", label: "The system has crept along its orbit" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 20, side: "right", label: "Bright-binary decades", note: "The companion point adds warm directional light even while the primary sun is below the horizon." },
    { x: 39, y: 58, side: "right", label: "The same clearing", note: "The tree, animal, and ground are held constant so only the sky clock changes." },
    { x: 75, y: 20, side: "left", label: "Dark-binary decades", note: "When the companion moves away, the same night is left to starlight and bioluminescence." },
    { x: 81, y: 77, side: "left", label: "Memory-scale change", note: "The visual difference is measured in decades, not in a seasonal cycle." },
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 58, y: 25, side: "right", label: "Tidal furnace", note: "A close orbit stretches the moon and turns orbital energy into heat and deformation." },
    { x: 46, y: 53, side: "right", label: "Same giant, different clock", note: "The paired panels hold the gas giant constant while orbital distance changes the day length." },
    { x: 78, y: 75, side: "left", label: "Habitable distance", note: "A wider orbit leaves the moon round, wet, and less violently heated." },
  ]}
  figNo="07"
