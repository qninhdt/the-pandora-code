<DiagramFigure
  ...
  labels={[
    { x: 62, y: 42, side: "right", label: "Cây Mẹ gãy đổ", note: "thân cây khổng lồ cháy đen và đổ sụp nơi từng là khu rừng bạt ngàn" },
    { x: 33, y: 76, side: "left", label: "Tộc Mangkwan", note: "những người sống sót băng qua đồng bằng tro bụi nơi từng là quê hương" },
    { x: 20, y: 48, side: "left", label: "Miệng phun từ xa", note: "ánh than hồng âm ỉ nơi chân trời — lò luyện kim vẫn không ngừng hoạt động" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 28, y: 42, side: "left", label: "Số phận được định trước", note: "nhiệt lượng của một thiên thể nhỏ rò rỉ hết — hóa thành hòn đá đông cứng đầy hố va chạm" },
    { x: 72, y: 45, side: "right", label: "Pandora, kẻ thách thức", note: "vẫn đan dệt những khe nứt nóng chảy dù đã quá hạn từ lâu" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 28, y: 52, side: "left", label: "Pandora, bị kéo giãn", note: "bị kéo thành hình quả trứng, các rãnh nóng chảy sáng rực nhất ở mặt hướng về hành tinh mẹ" },
    { x: 72, y: 40, side: "right", label: "Polyphemus", note: "hành tinh khổng lồ dùng lực hấp dẫn để nhào nặn mặt trăng" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 20, y: 22, side: "left", label: "Hành tinh mẹ khổng lồ", note: "kẻ tạo thủy triều, mờ ảo phía sau mặt trăng bị uốn nắn" },
    { x: 58, y: 52, side: "right", label: "Ống dẫn magma", note: "các ống dẫn hẹp đưa đá nóng chảy xuyên qua lớp vỏ lạnh cứng" },
    { x: 50, y: 82, side: "left", label: "Lòng sâu nóng chảy", note: "đá bị uốn nắn, duy trì trạng thái bán lỏng nhờ thủy triều" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 40, side: "left", label: "Polyphemus", note: "hành tinh khổng lồ chung mà tất cả các mặt trăng cùng quay quanh" },
    { x: 57, y: 48, side: "right", label: "Mặt trăng trong cùng", note: "nóng chảy, chịu uốn nắn mạnh nhất — vị trí của Pandora trong gia đình" },
    { x: 80, y: 38, side: "right", label: "Nhịp điệu 4:2:1", note: "các mặt trăng xếp thẳng hàng lặp đi lặp lại, lực giật tích tụ thay vì triệt tiêu" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 28, side: "right", label: "Khối đá lơ lửng lạnh ngắt", note: "được nâng đỡ bởi từ thông nhưng tối tăm và lạnh lẽo — từ trường sinh công bằng không" },
    { x: 42, y: 64, side: "left", label: "Xoáy từ thông màu lục lam", note: "các đường sức từ nâng đỡ khối lượng; từ trường biến thiên chỉ cảm ứng vài miliwatt" },
    { x: 56, y: 90, side: "right", label: "Nhiệt manti bên dưới", note: "các khe nứt nóng chảy âm ỉ được nuôi dưỡng bởi ma sát thủy triều, tách biệt hoàn toàn với từ trường" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 68, y: 35, side: "right", label: "Cột phun trào kiểu Pliny", note: "cuồn cuộn bốc cao hàng chục kilomet, được tiếp năng lượng bởi magma thủy triều quá áp" },
    { x: 50, y: 72, side: "right", label: "Dòng sóng thần mảnh vụn núi lửa", note: "trận tuyết lở tro bụi và khí siêu nóng tràn xuống sườn núi" },
    { x: 22, y: 66, side: "left", label: "Cây Mẹ xấu số", note: "khoảnh khắc trước khi bị thiêu rụi — bình nguyên Tro tàn tương lai" }
  ]}
