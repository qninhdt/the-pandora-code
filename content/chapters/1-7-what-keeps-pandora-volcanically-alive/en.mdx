<DiagramFigure
  ...
  labels={[
    { x: 68, y: 45, side: "right", label: "Shattered Hometree stump", note: "Colossal trunk destroyed and entombed by catastrophic volcanic ash fall." },
    { x: 35, y: 72, side: "left", label: "Mangkwan survivors", note: "Ash Clan nomads crossing the desolate basalt plain of their former homeland." },
    { x: 25, y: 46, side: "left", label: "Active volcanic fissures", note: "Distant glowing vents releasing persistent geothermal gases from the tidal furnace." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 48, side: "left", label: "Standard small world", note: "Rapidly radiates initial accretion heat, cooling into a dormant, cratered stone." },
    { x: 74, y: 50, side: "right", label: "Pandora: tidally active", note: "Continuous internal tidal flexing keeps mantle rock fractured and volcanically alive." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 28, y: 50, side: "left", label: "Tidally deformed crust", note: "Differential gravitational pull stretches Pandora into an elongated egg shape." },
    { x: 35, y: 50, side: "left", label: "Sub-planetary molten face", note: "Maximum tidal friction concentrated on the Polyphemus-facing bulge." },
    { x: 72, y: 40, side: "right", label: "Polyphemus tidal driver", note: "Gas giant whose gravitational gradient churns Pandora's interior." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 23, y: 22, side: "left", label: "Parent gas giant", note: "Gravitational driver maintaining orbital eccentricity and tidal kneading." },
    { x: 59, y: 52, side: "right", label: "Magma heat pipes", note: "Narrow vertical conduits channeling superheated melt through the cold rigid crust." },
    { x: 50, y: 82, side: "left", label: "Tidally melted interior", note: "Internal magma ocean continually liquified by viscoelastic dissipation." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 25, y: 46, side: "left", label: "Polyphemus anchor", note: "Central gravitational anchor coordinating the orbits of the satellite family." },
    { x: 57.5, y: 48, side: "right", label: "Innermost moon (Pandora)", note: "Experiencing maximum tidal flexing, sustained by periodic outer moon conjunctions." },
    { x: 71.5, y: 48, side: "right", label: "4:2:1 Laplace resonance", note: "Resonant orbital lockstep pumps eccentricity, preventing circularization and cooling." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 28, side: "right", label: "Cold levitated mountain", note: "Superconducting unobtanium pins magnetic flux; static magnetic fields do zero work and generate no heat." },
    { x: 50, y: 64, side: "left", label: "Cyan magnetic vortex", note: "Magnetic flux cradles the mass, but induced currents provide negligible thermal energy." },
    { x: 55, y: 92, side: "right", label: "Deep tidal magma below", note: "Volcanic warmth on the ground is powered entirely by deep tidal churning miles beneath." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 68, y: 32, side: "right", label: "Plinian eruption column", note: "Superheated ash and gas column billowing tens of kilometers into the stratosphere." },
    { x: 48, y: 74, side: "right", label: "Pyroclastic density surge", note: "Avalanche of incandescent ash and toxic gas rushing down the volcanic slopes." },
    { x: 23, y: 66, side: "left", label: "Doomed ancestral Hometree", note: "Colossal arboreal habitat moments before incineration by the advancing flow." }
  ]}
