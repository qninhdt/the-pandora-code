<DiagramFigure
  ...
  labels={[
    ...
    { x: 74, y: 30, side: "right", label: "Unmasked respiration", note: "Direct exposure to ambient atmosphere; canon shows the outcome, not the chemistry." },
    { x: 74, y: 65, side: "right", label: "Endosymbiotic mycelial plexus", note: "Pandoran mycelial endosymbiont associated with respiratory tissues." }
  ]}
...
<DiagramFigure
  ...
  labels={[
    { x: 88, y: 14, side: "left", label: "Kiri-mediated mycelial influx", note: "Kiri channels the planetary mycelial network into Spider's body; canon does not map the route." },
    { x: 44, y: 39, side: "left", label: "Respiratory-tissue colonization", note: "Rapid horizontal acquisition associated with respiratory mucosa, alveolar interfaces, and peripheral tissues." },
    { x: 22, y: 76, side: "right", label: "Discarded exopack", note: "Mechanical life support cast aside as biological integration begins" }
  ]}
  alt="A human figure collapsed in the forest while glowing cyan mycelial tendrils, channelled through Kiri's intervention, surround the body and converge on the airway; no specific entry route is shown"
  figNo="02"
  caption="The moment of horizontal acquisition. With the exopack gone and Spider hypoxic, Kiri channels the planet's mycelial network into his body, and colonization begins at the airway."
  tier="canon"
/>

## The oldest trick

Look closely enough at any cell in your body and you will find something that does not quite belong. Tucked inside it, by the hundreds, are small bean-shaped bodies called <GlossaryTerm slug="mitochondrion">mitochondria</GlossaryTerm> — the parts that take in oxygen and burn your food to power everything you do. They have their own loop of DNA, separate from the DNA in the cell's nucleus. They divide on their own schedule. They are wrapped in a double membrane, the outer one yours and the inner one unmistakably not. They look, on close inspection, exactly like what they are: the descendants of a free-living bacterium that, something like two billion years ago, moved inside another cell and never left.
...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 75, y: 51, side: "right", label: "Tolerated symbiotic niche", note: "Chemical signals quiet host immune defences while preserving local protection" },
...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 50, y: 55, side: "left", label: "Mycelial catalytic filter", note: "Proposed enzymatic processing converting toxic gases into bio-assimilated compounds" },
  ...
  figNo="06"
  caption="A proposed living catalytic scrubber. The mycelial film lining the alveolar surfaces could intercept incoming carbon dioxide and hydrogen sulfide, enzymatically neutralizing and assimilating the toxic compounds before they cross the capillary barrier and collapse blood pH."
  tier="inference"
/>
