...
<DiagramFigure
  ...
  labels={[
    { x: 24, y: 47, side: "left", label: "Lô đối chứng đa dạng", note: "Sao biển, hải quỳ, hàu đá và tảo cùng chia sẻ mặt đá" },
    { x: 77, y: 52, side: "right", label: "Trai chiếm lĩnh", note: "Gỡ kẻ săn mồi hiếm hoi khiến một đối thủ phủ gần kín mọi chỗ bám" },
    { x: 86, y: 20, side: "right", label: "Kẻ săn mồi then chốt bị gỡ", note: "Chiếc xà beng tượng trưng cho tác động lớn của một can thiệp nhỏ" }
  ]}
  figNo="06"
...
<DiagramFigure
  ...
  labels={[
    { x: 13, y: 50, side: "left", label: "Thân non nguyên vẹn", note: "Gỗ đặc có cấu trúc nhưng chưa có hốc làm nơi ở" },
    { x: 38, y: 50, side: "left", label: "Vết thương cành gãy", note: "Vết gãy mở đường cho ẩm, nấm và côn trùng" },
    { x: 63, y: 50, side: "right", label: "Gỗ lõi mục", note: "Phân hủy khoét rỗng lõi trong khi dác gỗ sống vẫn bao quanh" },
    { x: 87, y: 50, side: "right", label: "Hốc cây thành nơi ở", note: "Sau nhiều thế kỷ, khoang sâu nuôi chim và thú có túi" }
  ]}
  figNo="07"
...
<DiagramFigure
  ...
  labels={[
    { x: 22, y: 48, side: "left", label: "Tán thiết sam khép kín", note: "Bóng sâu giữ nền rừng, đất và suối mát" },
    { x: 52, y: 48, side: "right", label: "Vi khí hậu mở ra", note: "Khoanh vỏ làm mất tán, để nhiệt và ánh sáng chiếu xuống đất" },
    { x: 80, y: 47, side: "right", label: "Quần xã vùng rìa mới", note: "Cây ưa sáng và chim khác thế chỗ trong một hệ thống mới" }
  ]}
  figNo="08"
...
<DiagramFigure
  ...
  labels={[
    { x: 18, y: 50, side: "left", label: "Mất mát tức thời", note: "Khu rừng cháy không còn cấu trúc làm tổ cũ" },
    { x: 51, y: 52, side: "right", label: "Cá thể trưởng thành còn lại", note: "Những con sống sót khiến loài chuyên biệt vẫn có vẻ hiện diện" },
    { x: 82, y: 50, side: "right", label: "Nợ tuyệt chủng", note: "Không còn nơi sinh sản, dòng dõi dần biến mất khỏi cành trống" }
  ]}
  figNo="09"
...
<DiagramFigure
  ...
  labels={[
    { x: 24, y: 37, side: "left", label: "Lứa cây non", note: "Cây non bén rễ thành hàng dọc theo thân cây đổ" },
    { x: 31, y: 62, side: "left", label: "Khúc gỗ ươm", note: "Gã khổng lồ mục giữ nước và nâng cây non khỏi lớp lá" },
    { x: 51, y: 61, side: "right", label: "Cầu nấm và rễ", note: "Rễ sống và sinh vật phân hủy mang di sản của khúc gỗ vào đất" },
    { x: 82, y: 49, side: "right", label: "Liên tục rừng già", note: "Cây trưởng thành vẫn đứng sau khi khúc gỗ biến mất" }
  ]}
  figNo="10"
...
<DiagramFigure
  ...
  labels={[
    { x: 12, y: 64, side: "right", label: "Năm số 0", note: "Tro tàn, một cái gốc vỡ nát, và không có tán cây nào để che chắn bất cứ thứ gì. Vi khí hậu hoàn toàn biến mất." },
    { x: 34, y: 58, side: "right", label: "Sinh khối trở lại nhanh", note: "Các loài tiên phong trong một mùa; gần bằng khối lượng xanh đứng đầy đủ trong vòng 30-80 năm." },
    { x: 60, y: 52, side: "left", label: "Trông có vẻ đã phục hồi, nhưng không phải", note: "Một tán lá khép kín không có hốc, không có vỏ sâu và không có đất trên cành của nó là một công trường xây dựng." },
    { x: 88, y: 38, side: "left", label: "Khoảng trống không gì có thể rút ngắn", note: "Chiều cao và cấu trúc cỡ này cần nhiều thế kỷ trên Trái đất — và hàng thiên niên kỷ ở quy mô Hometree." },
  ]}
  figNo="04"
