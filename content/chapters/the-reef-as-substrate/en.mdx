<DiagramFigure
  ...
  labels={[
    ...
    { x: 50, y: 45, side: "left", label: "Living root matrix", note: "living pilings the village is woven into, flexing with tide and storm surge" },
    { x: 78, y: 65, side: "left", label: "Terraced seawall", note: "cascading biogenic rampart that breaks open-ocean swell" },
    { x: 32, y: 85, side: "right", label: "Accreted skeletal floor", note: "thousands of years of accumulated skeleton standing in for bedrock" }
  ]}
...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 75, y: 35, side: "left", label: "Metabolic exchange", note: "algae provide 90–95% of photosynthetic sugars to fuel rock-building" }
  ]}
