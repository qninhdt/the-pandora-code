<DiagramFigure
  ...
  labels={[
    { x: 35, y: 55, side: "left", label: "Coordinated Terrestrial Surge", note: "Hammerheads, Thanators, and Viperwolves advancing in unified formation without intra-species predation." },
    { x: 60, y: 20, side: "left", label: "Synchronized Aerial Wave", note: "Banshee swarms descending simultaneously to overwhelm RDA anti-air defensive perimeters." },
    { x: 85, y: 56, side: "right", label: "Targeted RDA Frontline Breach", note: "Mechanized armor column routed by a mass behavioural break canon shows and never explains." }
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    { x: 34, y: 46, side: "left", label: "Tsaheylu Biological Interface", note: "Individual organism connects to the network, injecting local intent and sensory memory." },
    { x: 48, y: 30, side: "left", label: "Sacred Tree Computing Hub", note: "High-density trunk core, the one point where the mesh is dense rather than diffuse." },
    { x: 68, y: 72, side: "right", label: "Subterranean Synaptic Grid", note: "Massive interconnected mycorrhizal root network forming a distributed planetary neural mesh." },
    { x: 78, y: 32, side: "right", label: "Bonding Tendrils", note: "The hanging filaments a Na'vi links into; canon shows these at the tree, not as a network of their own." }
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 44, y: 76, side: "left", label: "Quorum Bivouac Cluster", note: "Aggregated swarm integrates local tactile and chemical feedback to measure decision consensus." },
    { x: 65, y: 44, side: "left", label: "Recruitment Signal Stream", note: "Positive feedback cascades as scouts amplify trajectories toward the superior candidate site." },
    { x: 88, y: 22, side: "right", label: "Consensus Nest Site", note: "When the recruitment threshold is exceeded, the whole swarm commits to migration." }
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  labels={[
    { x: 26, y: 48, side: "left", label: "Exploratory Foraging Sheet", note: "Acellular plasmodium expands indiscriminately across substrate to locate distributed nutrient sources." },
    { x: 38, y: 26, side: "left", label: "Food Source Node Array", note: "Oat flake markers representing population centers / metabolic demand points." },
    { x: 72, y: 48, side: "right", label: "Hydrodynamic Tube Optimization", note: "Protoplasmic shuttling widens high-throughput veins while pruning redundant branches." },
    { x: 82, y: 32, side: "right", label: "Fault-Tolerant Steiner Network", note: "Final topology balances minimal path length, transport efficiency, and disconnection redundancy." }
  ]}
  figNo="04"
...
<DiagramFigure
  ...
  labels={[
    { x: 35, y: 64, side: "left", label: "Weak Emergence (Bottom-Up Vortex)", note: "Complex macro-scale dynamics arise entirely from local interactions of simple agents without supernatural addition." },
    { x: 52, y: 44, side: "left", label: "The Explanatory Chasm", note: "The fundamental philosophical threshold separating reducible self-organization from novel ontologies." },
    { x: 75, y: 16, side: "right", label: "Strong Emergence (Irreducible Entity)", note: "Hypothetical holistic mind possessing downward causal powers that cannot be derived from substrate physics." },
    { x: 78, y: 48, side: "right", label: "Downward Causation Tendrils", note: "Macro-level entity actively constraining and driving lower-level microstates." }
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  labels={[
    { x: 28, y: 48, side: "left", label: "Cerebellar Feedforward Architecture (69B Neurons)", note: "Massive parallel compute organized in non-recurrent arrays; performs motor calculation with zero conscious experience." },
    { x: 75, y: 48, side: "right", label: "Cerebral Recurrent Network (16B Neurons)", note: "Rich recurrent loops, dense feedback, and high integrated information (Phi) generating conscious awareness." },
    { x: 50, y: 50, side: "right", label: "Network Topology vs Node Count", note: "Raw synapse count is irrelevant; emergent mind requires re-entrant loops rather than feedforward pipelines." }
  ]}
  figNo="06"
...
<NetworkOrMindDiagnostic
  caption="The instrument, before the verdict. Four checks in series — competence, irreducible integration, a global broadcast that ignites, and evidence of experience — with a signal that stalls at the first one a specimen fails. Calibrate it first: the slime mould and the bee swarm clear competence and stall at integration; the cerebellum, four-fifths of your neurons, stalls immediately, which is what proves the bench is not merely counting connections; the cortex runs the whole chain. Then Eywa: competence outright, integration only in local pockets, no planet-wide ignition — and a last check that is not a low score but genuinely unanswerable from outside, exactly as it is for the person beside you."
/>
...
<DiagramFigure
  ...
  labels={[
    { x: 22, y: 28, side: "left", label: "Neural Access Port", note: "Sacred tree tendrils serve as a high-fidelity biological read/write interface into subterranean storage." },
    { x: 46, y: 55, side: "left", label: "Electrochemical Address Bus", note: "Active signal pulse routing the query across root channels to retrieve specific ancestral records." },
    { x: 82, y: 72, side: "right", label: "Activated Ancestral Engram", note: "Specific retrieved memory vault glowing magenta as synaptic patterns are reconstructed into the visitor's mind." },
    { x: 16, y: 73, side: "left", label: "Distributed Memory Vaults", note: "Localized biological clusters holding clan memory in persistent mycelial engrams." }
  ]}
  figNo="07"
...
<DiagramFigure
  ...
  labels={[
    { x: 28, y: 60, side: "left", label: "Communing Descendant", note: "Living Na'vi forms a direct synaptic query to converse with an archived persona." },
    { x: 52, y: 44, side: "right", label: "Uploaded Consciousness (Grace)", note: "Dr. Grace Augustine's memories and personality, held in biological storage." },
    { x: 75, y: 56, side: "right", label: "Ancestral Lineage Pods", note: "Individual holographic engrams holding the distinct personalities and songs of deceased ancestors." },
    { x: 89, y: 16, side: "right", label: "The Planetary Archive", note: "Accumulated cultural and ecological experience, held through the sacred grove." }
  ]}
  figNo="08"
