<DiagramFigure
  ...
  labels={[
    ...
    { x: 85, y: 56, side: "right", label: "Targeted RDA Frontline Breach", note: "Mechanized armor column routed by emergent planetary immune mobilization rather than local instinct." }
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 48, y: 30, side: "left", label: "Sacred Tree Computing Hub", note: "High-density trunk core routing signals between aerial canopy and subterranean strata." },
    ...
    { x: 78, y: 32, side: "right", label: "Aerial Canopy Filaments", note: "Luminous tendrils spanning the canopy, providing redundant above-ground signal pathways." }
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 16, y: 73, side: "left", label: "Distributed Memory Vaults", note: "Localized biological data clusters preserving centuries of clan memories in persistent mycelial engrams." }
  ]}
  figNo="07"
...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 52, y: 44, side: "right", label: "Uploaded Consciousness (Grace)", note: "Intact neural connectome and episodic memories of Dr. Grace Augustine preserved in biological storage." },
    ...
    { x: 89, y: 16, side: "right", label: "Millennial Planetary Archive", note: "Centuries of accumulated cultural and ecological experiences indexed throughout the sacred grove." }
  ]}
  figNo="08"
