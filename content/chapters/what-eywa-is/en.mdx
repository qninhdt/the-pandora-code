...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 48, y: 30, side: "left", label: "Sacred Tree Access Hub", note: "High-density tree interface routing signals into the subterranean network." },
    { x: 68, y: 72, side: "right", label: "Subterranean Biological Mesh", note: "Interconnected root network forming a distributed biological mesh; canon does not specify its full substrate." },
...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 16, y: 73, side: "left", label: "Distributed Memory Vaults", note: "Localized biological clusters holding ancestral memory." }
  ]}
  figNo="07"
