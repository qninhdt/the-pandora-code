<DiagramFigure
  ...
  labels={[
    { x: 50, y: 16, side: "left", label: "Light in shafts", note: "Daylight breaks through the vaulted crown the way it does through a cathedral's high windows — the canopy takes it first." },
    { x: 40, y: 50, side: "left", label: "Braided columnar trunk", note: "Dozens of woody columns rise together — the cathedral's central pillar, climbing toward a height Earth's physics forbids." },
    { x: 58, y: 86, side: "right", label: "The dim, glowing floor", note: "A different world from the bright vault overhead: as little as 1–2% of the crown's light reaches here." },
  ]}
  figNo="01"
...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 9, side: "right", label: "Emergent crowns", note: "Full sun and wind — the realm of fliers" },
    { x: 30, y: 40, side: "right", label: "The canopy roof", note: "Dense interlocking crowns take the light first" },
    { x: 40, y: 64, side: "left", label: "Shaded understory", note: "Living on the light the canopy lets through" },
    { x: 72, y: 90, side: "left", label: "1–2% light at the floor", note: "The strip down the edge tracks the fall-off" },
  ]}
  figNo="02"
...
<DiagramFigure
  ...
  labels={[
    { x: 40, y: 28, side: "right", label: "Epiphytes", note: "Plants rooted on the branch, not the ground" },
    { x: 35, y: 50, side: "left", label: "Aerial soil mat", note: "Built from trapped debris, metres up" },
    { x: 55, y: 72, side: "left", label: "Canopy roots", note: "The tree drinks from the garden on its own limb" },
  ]}
  figNo="03"
...
<DiagramFigure
  ...
  labels={[
    { x: 50, y: 12, side: "right", label: "Top tips", note: "Cape May — works the bright, exposed crown" },
    { x: 60, y: 38, side: "right", label: "Upper interior", note: "Blackburnian — high, near the trunk" },
    { x: 40, y: 56, side: "left", label: "Mid-foliage", note: "Black-throated green — the middle zone" },
    { x: 58, y: 74, side: "right", label: "Low branches", note: "Yellow-rumped — base and trunk, hawking insects" },
  ]}
  figNo="04"
...
<DiagramFigure
  ...
  labels={[
    { x: 22, y: 47, side: "left", label: "Intact water column", note: "A continuous cyan column carries water upward" },
    { x: 52, y: 48, side: "right", label: "Gas embolism", note: "One expanding bubble breaks the water column" },
    { x: 52, y: 18, side: "right", label: "Separated dry segment", note: "The air-filled section above the bubble cannot conduct" },
    { x: 76, y: 47, side: "right", label: "Neighbouring intact vessel", note: "A parallel xylem tube still remains wet and conductive" }
  ]}
  figNo="07"
...
<DiagramFigure
  ...
  labels={[
    { x: 56, y: 78, side: "right", label: "Relaxed at the base", note: "Water rises easily under low tension" },
    { x: 44, y: 34, side: "left", label: "Strained near the top", note: "The column thins, close to snapping" },
    { x: 56, y: 16, side: "right", label: "Stunted crown leaves", note: "Too little turgor to expand — small and dense" },
    { x: 40, y: 24, side: "left", label: "The ~130 m ceiling", note: "Where a new leaf no longer pays its way" },
  ]}
  figNo="05"
...
<DiagramFigure
  ...
  labels={[
    { x: 24, y: 47, side: "left", label: "Wide Earth stoma", note: "A broad pore admits gas but loses more water vapour" },
    { x: 76, y: 47, side: "right", label: "Narrow Pandoran stoma", note: "A smaller opening still admits a dense carbon stream" },
    { x: 24, y: 20, side: "left", label: "Water-vapour loss", note: "The broad pale plume makes transpiration visible" },
    { x: 76, y: 64, side: "right", label: "Dense carbon dioxide stream", note: "Amber molecules crowd the air entering the guarded pore" }
  ]}
  figNo="08"
...
<DiagramFigure
  ...
  labels={[
    { x: 22, y: 58, side: "left", label: "Coast redwood", note: "~116 m — at Earth's physical ceiling" },
    { x: 64, y: 30, side: "right", label: "Hometree", note: "Over 300 m, on a braided multi-columnar trunk" },
    { x: 70, y: 82, side: "left", label: "Buttressed root mass", note: "Sprawling surface roots anchor the giant" },
  ]}
  figNo="06"
