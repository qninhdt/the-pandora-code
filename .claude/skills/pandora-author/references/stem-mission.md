...
If either answer is no, the chapter is incomplete.

## Subtlety is the whole game

The STEM must arrive *through* Pandora, not beside it:
- Open on a Pandoran image or scene the reader can see.
- Let the science emerge as the natural explanation of what they're looking at.
- Land the concept in plain language first; name it second (or not at all if the
...
Better to teach one concept well than drag through three. A chapter that fully
earns superconductivity through the floating mountains beats one that name-checks
superconductivity, flux pinning, the Meissner effect, and type-II materials
without the reader feeling any of them. Cut concepts that don't get room to land.
