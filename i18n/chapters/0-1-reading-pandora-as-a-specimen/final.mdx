...
<Quote cite="Jon Landau, nhà sản xuất, nói về thiết lập nguyên tác của Avatar">
...
<Timeline
  events={[
    ...
    { id: "games-2023", date: "2023 →", title: "Các bản mở rộng được ủy quyền", description: "Một tựa game hợp tác với xưởng phim và các bộ truyện tranh chính thức được công nhận là thuộc nguyên tác — độ ưu tiên chỉ xếp sau phim, nhưng mang tính ràng buộc trừ khi phim phủ nhận chúng.", kind: "canon" },
...
<DiagramFigure
  ...
  labels={[
    { x: 10, y: 42, side: "right", label: "Nguyên tác khả kiến", note: "Điểm tựa vững chắc: các chi tiết thực nghiệm được mô tả trực tiếp trong tác phẩm gốc." },
...
<DiagramFigure
  ...
  labels={[
    { x: 14, y: 45, side: "left", label: "Khay 1: Nguyên tác", note: "Bằng chứng phim ảnh trực tiếp: chỉ trích dẫn những gì được thể hiện tường minh trong các tác phẩm gốc." },
...
Đừng để suy luận tự khoác lên mình chiếc huy hiệu của nguyên tác. Đừng để một phép màu duy nhất được ban ơn biến thành tờ giấy phép cho vô số phép màu khác thỏa sức hoành hành. Gần như mọi lập luận tồi tệ về Pandora — và cả một con số đáng ngạc nhiên ở thế giới thực — đều là một trong hai loại cạm bẫy này đang khoác lớp ngụy trang.
</Callout>
...
<OpenQuestions
  ...
  items={[
    ...
    {
      question: "Chúng ta nên tin tưởng bao nhiêu phần trăm vào nguyên tác, khi mà chính xưởng phim cũng vừa giáng cấp các cuốn sách tham khảo của họ?",
