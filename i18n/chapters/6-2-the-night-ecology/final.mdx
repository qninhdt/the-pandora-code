...
<DiagramFigure
  ...
  labels={[
    { x: 28, y: 23, side: "left", label: "Bắt đầu phiên mã gene", note: "Gene đồng hồ kích hoạt phiên mã mRNA tạo protein" },
    { x: 72, y: 24, side: "right", label: "Tích lũy protein tế bào chất", note: "Protein đồng hồ tích tụ dần trong tế bào chất" },
    { x: 72, y: 72, side: "right", label: "Ức chế phản hồi âm", note: "Protein đi vào nhân ức chế chính gene phiên mã ra nó" },
...
<DiagramFigure
  ...
  labels={[
    ...
    { x: 44, y: 85, side: "left", label: "Đàn thú săn ban đêm", note: "Bầy sói Viperwolf rình rập cùng khoảng rừng sau mười hai giờ" },
