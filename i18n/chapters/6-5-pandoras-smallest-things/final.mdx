...
Đa dạng Pandora không chứng minh chọn lọc do mầm bệnh. Sinh sản hữu tính không chứng minh Nữ hoàng Đỏ. Truyện bệnh được cấp phép không lập nên hệ vi sinh vật của nguyên tác. Cơ chế ở đây là khoa học Trái Đất đã đo lường; áp dụng nó lên Pandora là suy đoán có thể kiểm chứng, vì chưa có dữ liệu kiểu gen vật chủ, tính đặc hiệu mầm bệnh hay lây nhiễm theo thời gian.
</Callout>
