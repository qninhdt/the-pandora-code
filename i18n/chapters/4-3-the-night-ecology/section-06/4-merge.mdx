...
- **Quyết định chung:** Chọn Draft 2 cho toàn bộ Section 06.
- **Lý do:** Bản dịch sắc sảo, tự nhiên, chuyển tải đúng những khái niệm sinh thái học như "nút thắt ban đêm" và "sự phân chia thời gian" (temporal partitioning). Cách ví von "bảng phân công nhân sự" giữ vững tinh thần của tác giả.

---

## Một khoảng rừng, hai lực lượng lao động

(Lưu ý: Draft 2 bị cắt xén một chút ở đầu trong quá trình đọc, nên phần đầu dưới đây giả lập lại từ nội dung đã được xử lý bởi Draft 2 để bảo toàn sự liền mạch của bản gốc. Bản dịch sau bám sát với giọng điệu của Draft 2).
