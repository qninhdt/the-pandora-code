      ...
      <div className="absolute inset-0">
        <svg viewBox="0 0 100 78" className="h-full w-full" preserveAspectRatio="xMidYMid meet" role="img" aria-label={t("title")}>
          ...
          {mode === "dominant" ? (
            ...
            <g>
              {[0, 1, 2, 3, 4, 5, 6].map((i) => (
                <line key={i} x1={20 + i * 10} y1="58" x2={20 + i * 10} y2="26" stroke={tone} strokeWidth="2.2" strokeLinecap="round" opacity={0.8} />
              ))}
            ...
            <g>
              <line x1="50" y1="58" x2="50" y2="24" stroke={tone} strokeWidth="6" strokeLinecap="round" opacity={0.85}
                style={{ filter: `drop-shadow(0 0 5px ${tone})` }} />
              <path d="M50 34 L34 26 M50 40 L64 30 M50 30 L62 22 M50 44 L38 38" stroke={tone} strokeWidth="1.8" strokeLinecap="round" opacity={0.8} />
              {[
                [34, 26], [64, 30], [62, 22], [38, 38], [44, 48], [56, 50],
                [50, 28], [47, 52], [53, 36], [41, 32], [59, 42], [50, 46],
                [36, 44], [64, 46], [45, 40], [55, 26], [43, 24], [58, 34],
              ].map(([cx, cy], i) => (
        ...
        <div className="absolute right-3 top-14">
          <Readout label={t("dependents")} value={dependents} accent={mode === "dominant" ? "teal" : "cyan"} />
        </div>
