    ...
    <GlossaryFrame
      ...
      caption={
        <span style={{ color: tone }}>
          {years > 90 ? t("verdictColonnade") : years > 25 ? t("verdictRooting") : t("verdictLog")}
        </span>
      }
    >
      <div className="absolute inset-0">
        ...
        >
          ...
          <rect
            ...
            y={46 - (1 - rotted) * 1.5}
            width="60"
            height={4.5 * (1 - rotted * 0.85)}
            rx="2"
            fill="var(--muted)"
            opacity={0.55 * (1 - rotted * 0.6)}
          />
        ...
        <div className="absolute right-3 top-14 flex flex-col gap-1.5">
          <Readout
            label={t("logRemaining")}
            value={`${Math.round((1 - rotted) * 100)}%`}
            accent="teal"
          />
