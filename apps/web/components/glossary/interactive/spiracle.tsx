...
export default function Spiracle() {
  ...
  return (
    <GlossaryFrame
      ...
      caption={
        <span className={open ? "text-cyan" : "text-muted"}>{open ? t("open") : t("closed")}</span>
      }
    >
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-x-3 bottom-12 flex justify-center gap-1.5">
          <button
            ...
            style={{
              borderColor: open ? "var(--cyan)" : "var(--border-strong)",
          ...
          <button
            ...
            className="rounded-lg border px-3 py-1 font-mono text-[10px] uppercase"
            style={{
              borderColor: !open ? "var(--muted)" : "var(--border-strong)",
              color: !open ? "var(--muted)" : "var(--muted)",
              background: "var(--void)",
            }}
          >
            {t("closed")}
