...
export default function AlternativeStableState() {
  ...
  return (
    <GlossaryFrame
      ...
      caption={
        <span style={{ color: tone }}>{isFlipped ? t("verdictFlipped") : t("verdictHolding")}</span>
      }
    >
      <div className="absolute inset-0">
        ...
        >
          ...
          <path
            d="M12 34 Q22 50 30 44 Q40 34 50 32 Q60 34 70 48 Q78 54 88 44"
            fill="none"
          ...
          />
          <path
            d="M12 34 Q22 50 30 44 Q40 34 50 32 Q60 34 70 48 Q78 54 88 44 L88 60 L12 60 Z"
            fill="var(--void)"
            opacity={0.35}
          />
          ...
          <line
            x1={ballX - 10 - pressure * 4}
            y1={ballY}
            x2={ballX - 5}
            y2={ballY}
            stroke="var(--amber)"
            strokeWidth={0.4 + pressure * 1.4}
            opacity={0.7}
          />
        ...
        <div className="absolute right-3 top-14">
          <Readout
            label={t("state")}
            value={isFlipped ? t("degraded") : t("intact")}
            accent={isFlipped ? "magenta" : "cyan"}
          />
        </div>
