    ...
    >
      <div className="absolute inset-0">
        ...
        >
          ...
          {/* energy bar */}
          <rect x="12" y="88" width="76" height="4" rx="1" fill="var(--void)" stroke="var(--border-strong)" strokeWidth="0.4" />
          <rect x="12" y="88" width={(76 * energy) / 100} height="4" rx="1" fill="var(--teal)" opacity="0.85" />
        </svg>
        ...
        <div className="absolute inset-x-3 bottom-12 flex justify-center gap-1.5">
          {(["soar", "flap"] as const).map((m) => (
            <button
              ...
              style={{
                borderColor: mode === m ? (m === "soar" ? "var(--teal)" : "var(--amber)") : "var(--border-strong)",
                color: mode === m ? (m === "soar" ? "var(--teal)" : "var(--amber)") : "var(--muted)",
                background: "var(--void)",
              }}
            >
              {t(m)}
