...
export default function Chemiluminescence() {
  ...
  return (
    <GlossaryFrame
      ...
      caption={
        <span className={mode === "bio" ? "text-teal" : "text-amber"}>
          {mode === "bio" ? t("bio") : t("chem")}
        </span>
      }
    >
      <div className="absolute inset-0">
        ...
        >
          <circle
            ...
            r="16"
            fill="var(--teal)"
            opacity={mode === "bio" ? 0.55 : 0.2}
            style={mode === "bio" ? { filter: "drop-shadow(0 0 8px var(--teal))" } : undefined}
          />
          <circle
            cx="65"
            cy="45"
                ...
                borderColor:
                  mode === m
                    ? m === "bio"
                      ...
                      : "var(--amber)"
                    : "var(--border-strong)",
                color: mode === m ? (m === "bio" ? "var(--teal)" : "var(--amber)") : "var(--muted)",
                background: "var(--void)",
              }}
            >
              {t(m)}
