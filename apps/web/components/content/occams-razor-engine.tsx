...
export function OccamsRazorEngine({
  caption,
  className,
    ...
    >
      <div className="flex flex-col gap-6 lg:flex-row lg:items-stretch">
        <svg viewBox={`0 0 ${W} ${H}`} className="w-full lg:w-[60%]" role="img">
          ...
          {/* Base */}
          <path
            d={`M ${CX - 15} ${H - 20} L ${CX + 15} ${H - 20} L ${CX} ${CY} Z`}
            fill="var(--surface)"
          ...
          >
            ...
            <g transform={`translate(${CX - BEAM_W / 2}, ${CY})`}>
              ...
              >
                ...
                />
                <path
                  d="M -25 40 Q 0 50 25 40 Z"
                  fill={
                    a < b ? "color-mix(in oklab, var(--cyan) 20%, transparent)" : "var(--surface)"
                  }
                  stroke={a < b ? "var(--cyan)" : "var(--border-strong)"}
                  filter={a < b ? glowUrl(uid, "bloom") : undefined}
                />
                <VizText
                  x={0}
                  y={60}
            ...
            <g transform={`translate(${CX + BEAM_W / 2}, ${CY})`}>
              ...
              >
                ...
                <path
                  ...
                  fill={
                    b < a
                      ? "color-mix(in oklab, var(--magenta) 20%, transparent)"
                      : "var(--surface)"
                  }
                  stroke={b < a ? "var(--magenta)" : "var(--border-strong)"}
                  filter={b < a ? glowUrl(uid, "bloom") : undefined}
                />
                <VizText
                  x={0}
                  y={60}
        ...
        <div className="flex flex-col justify-center gap-4 lg:w-[40%]">
          ...
          <div className="mt-4">
            <VizReadout
              label={t("verdict")}
              value={
                winner === "A" ? t("verdictA") : winner === "B" ? t("verdictB") : t("verdictTie")
              }
              note={winner === "A" ? t("noteA") : winner === "B" ? t("noteB") : t("noteTie")}
              tone={
                winner === "A" ? "var(--cyan)" : winner === "B" ? "var(--magenta)" : "var(--subtle)"
              }
              tinted
            />
          </div>
