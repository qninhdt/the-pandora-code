...
import { listAuthorIds } from "@/lib/content/loader/author-loader";
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  for (const locale of locales) {
    ...
    entries.push({ url: `${BASE}/${locale}/authors` });
    ...
    for (const id of authors) entries.push({ url: `${BASE}/${locale}/authors/${id}` });
